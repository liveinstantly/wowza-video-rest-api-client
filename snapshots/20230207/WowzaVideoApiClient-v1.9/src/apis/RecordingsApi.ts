...
import {
    ...
    RecordingStateResponseFromJSON,
    RecordingStateResponseToJSON,
    RecordingsFromJSON,
    RecordingsToJSON,
} from '../models';
...
export interface ShowRecordingRequest {
    id: string;
}

export interface ShowRecordingStateRequest {
    id: string;
}
...
export class RecordingsApi extends runtime.BaseAPI {
     ...
     */
    async listRecordingsRaw(requestParameters: ListRecordingsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Recordings>> {
        const queryParameters: any = {};
     ...
     * Fetch all recordings
     */
    async listRecordings(requestParameters: ListRecordingsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Recordings> {
     ...
     * Fetch a recording
     */
    async showRecordingRaw(requestParameters: ShowRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecordingResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showRecording.');
        }
     ...
     * Fetch a recording
     */
    async showRecording(requestParameters: ShowRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecordingResponse> {
        const response = await this.showRecordingRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async showRecordingStateRaw(requestParameters: ShowRecordingStateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecordingStateResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showRecordingState.');
        }
        ...
        const response = await this.request({
            path: `/recordings/{id}/state`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => RecordingStateResponseFromJSON(jsonValue));
    }
     ...
     * Fetch the state of a recording
     */
    async showRecordingState(requestParameters: ShowRecordingStateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecordingStateResponse> {
        const response = await this.showRecordingStateRaw(requestParameters, initOverrides);
        return await response.value();
    }
