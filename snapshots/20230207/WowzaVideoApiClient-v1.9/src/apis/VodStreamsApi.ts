...
import {
    ...
    Error422FromJSON,
    Error422ToJSON,
    VodStreamResponseFromJSON,
    VodStreamResponseToJSON,
    VodStreamUpdateInputFromJSON,
    VodStreamUpdateInputToJSON,
    VodStreamsFromJSON,
    VodStreamsToJSON,
} from '../models';

export interface DeleteVODStreamRequest {
    id: string;
}

export interface ListVODStreamsRequest {
    filter?: string;
    page?: number;
    perPage?: number;
}

export interface ShowVODStreamRequest {
    id: string;
}

export interface UpdateVODStreamRequest {
    id: string;
    vodStreamUpdateInput: VodStreamUpdateInput;
}

/**
 * 
 */
export class VodStreamsApi extends runtime.BaseAPI {
     ...
     * Delete a VOD stream
     */
    async deleteVODStreamRaw(requestParameters: DeleteVODStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling deleteVODStream.');
        }
        ...
        const response = await this.request({
            path: `/vod_streams/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'DELETE',
     ...
     * Delete a VOD stream
     */
    async deleteVODStream(requestParameters: DeleteVODStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteVODStreamRaw(requestParameters, initOverrides);
    }
     ...
     */
    async listVODStreamsRaw(requestParameters: ListVODStreamsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VodStreams>> {
        const queryParameters: any = {};
     ...
     * Fetch all VOD streams
     */
    async listVODStreams(requestParameters: ListVODStreamsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VodStreams> {
        const response = await this.listVODStreamsRaw(requestParameters, initOverrides);
     ...
     * Fetch a VOD stream
     */
    async showVODStreamRaw(requestParameters: ShowVODStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VodStreamResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showVODStream.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => VodStreamResponseFromJSON(jsonValue));
    }
     ...
     * Fetch a VOD stream
     */
    async showVODStream(requestParameters: ShowVODStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VodStreamResponse> {
        const response = await this.showVODStreamRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Update a VOD stream
     */
    async updateVODStreamRaw(requestParameters: UpdateVODStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VodStreamResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling updateVODStream.');
        }

        if (requestParameters.vodStreamUpdateInput === null || requestParameters.vodStreamUpdateInput === undefined) {
            throw new runtime.RequiredError('vodStreamUpdateInput','Required parameter requestParameters.vodStreamUpdateInput was null or undefined when calling updateVODStream.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: VodStreamUpdateInputToJSON(requestParameters.vodStreamUpdateInput),
        }, initOverrides);
     ...
     * Update a VOD stream
     */
    async updateVODStream(requestParameters: UpdateVODStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VodStreamResponse> {
        const response = await this.updateVODStreamRaw(requestParameters, initOverrides);
        return await response.value();
    }
