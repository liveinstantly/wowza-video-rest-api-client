...
import {
    ...
    Error422FromJSON,
    Error422ToJSON,
    ScheduleCreateInputFromJSON,
    ScheduleCreateInputToJSON,
    ScheduleResponseFromJSON,
    ScheduleResponseToJSON,
    ScheduleStateResponseFromJSON,
    ScheduleStateResponseToJSON,
    ScheduleUpdateInputFromJSON,
    ScheduleUpdateInputToJSON,
    SchedulesFromJSON,
    SchedulesToJSON,
} from '../models';
...
export interface ShowScheduleStateRequest {
    id: string;
}
...
export class SchedulesApi extends runtime.BaseAPI {
    ...
    async createScheduleRaw(requestParameters: CreateScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScheduleResponse>> {
        if (requestParameters.scheduleCreateInput === null || requestParameters.scheduleCreateInput === undefined) {
            throw new runtime.RequiredError('scheduleCreateInput','Required parameter requestParameters.scheduleCreateInput was null or undefined when calling createSchedule.');
        }
        ...
        const response = await this.request({
            ...
            body: ScheduleCreateInputToJSON(requestParameters.scheduleCreateInput),
        }, initOverrides);
     ...
     * Disable a schedule
     */
    async disableScheduleRaw(requestParameters: DisableScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScheduleStateResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling disableSchedule.');
        }
        ...
        const response = await this.request({
            path: `/schedules/{id}/disable`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ScheduleStateResponseFromJSON(jsonValue));
    }
     ...
     * Disable a schedule
     */
    async disableSchedule(requestParameters: DisableScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScheduleStateResponse> {
        const response = await this.disableScheduleRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Enable a schedule
     */
    async enableScheduleRaw(requestParameters: EnableScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScheduleStateResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling enableSchedule.');
        }
        ...
        const response = await this.request({
            path: `/schedules/{id}/enable`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Enable a schedule
     */
    async enableSchedule(requestParameters: EnableScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScheduleStateResponse> {
        const response = await this.enableScheduleRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Fetch all schedules
     */
    async listSchedulesRaw(requestParameters: ListSchedulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Schedules>> {
        const queryParameters: any = {};
     ...
     * Fetch all schedules
     */
    async listSchedules(requestParameters: ListSchedulesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Schedules> {
     ...
     * Fetch a schedule
     */
    async showScheduleRaw(requestParameters: ShowScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScheduleResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showSchedule.');
        }
     ...
     * Fetch a schedule
     */
    async showSchedule(requestParameters: ShowScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScheduleResponse> {
     ...
     */
    async showScheduleStateRaw(requestParameters: ShowScheduleStateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScheduleStateResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showScheduleState.');
        }
        ...
        const response = await this.request({
            path: `/schedules/{id}/state`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Fetch the state of a schedule
     */
    async showScheduleState(requestParameters: ShowScheduleStateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScheduleStateResponse> {
        const response = await this.showScheduleStateRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async updateScheduleRaw(requestParameters: UpdateScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScheduleResponse>> {
        ...
        if (requestParameters.scheduleUpdateInput === null || requestParameters.scheduleUpdateInput === undefined) {
            throw new runtime.RequiredError('scheduleUpdateInput','Required parameter requestParameters.scheduleUpdateInput was null or undefined when calling updateSchedule.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ScheduleUpdateInputToJSON(requestParameters.scheduleUpdateInput),
        }, initOverrides);
