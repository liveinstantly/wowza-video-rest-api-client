...
import {
    Error401FromJSON,
    Error401ToJSON,
    UsageStoragePeakFromJSON,
    UsageStoragePeakToJSON,
} from '../models';

export interface ShowUsageStoragePeakRecordingIndexRequest {
    from?: Date;
    to?: Date;
}
...
export class StorageApi extends runtime.BaseAPI {
     ...
     * Fetch peak storage
     */
    async showUsageStoragePeakRecordingIndexRaw(requestParameters: ShowUsageStoragePeakRecordingIndexRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UsageStoragePeak>> {
        ...
        const response = await this.request({
            path: `/usage/storage/peak`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UsageStoragePeakFromJSON(jsonValue));
    }
     ...
     * Fetch peak storage
     */
    async showUsageStoragePeakRecordingIndex(requestParameters: ShowUsageStoragePeakRecordingIndexRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UsageStoragePeak> {
        const response = await this.showUsageStoragePeakRecordingIndexRaw(requestParameters, initOverrides);
