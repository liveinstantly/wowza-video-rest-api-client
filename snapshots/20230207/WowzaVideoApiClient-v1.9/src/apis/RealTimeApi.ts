...
import type {
  ...
  Error410,
  Error422,
  RealTimeStreamCreateInput,
  RealTimeStreamResponse,
  RealTimeStreamUpdateInput,
  RealTimeStreams,
} from '../models';
import {
    Error401FromJSON,
    ...
    Error422FromJSON,
    Error422ToJSON,
    RealTimeStreamCreateInputFromJSON,
    RealTimeStreamCreateInputToJSON,
    RealTimeStreamResponseFromJSON,
    RealTimeStreamResponseToJSON,
    RealTimeStreamUpdateInputFromJSON,
    RealTimeStreamUpdateInputToJSON,
    RealTimeStreamsFromJSON,
    RealTimeStreamsToJSON,
} from '../models';

export interface CreateRealTimeStreamRequest {
    realTimeStreamCreateInput: RealTimeStreamCreateInput;
}
...
export interface ListRealTimeStreamsRequest {
    filter?: string;
    page?: number;
    perPage?: number;
}

export interface ShowRealTimeStreamRequest {
    id: string;
}

export interface UpdateRealTimeStreamRequest {
    id: string;
    realTimeStreamUpdateInput: RealTimeStreamUpdateInput;
}
...
export class RealTimeApi extends runtime.BaseAPI {
     ...
     */
    async createRealTimeStreamRaw(requestParameters: CreateRealTimeStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RealTimeStreamResponse>> {
        if (requestParameters.realTimeStreamCreateInput === null || requestParameters.realTimeStreamCreateInput === undefined) {
            throw new runtime.RequiredError('realTimeStreamCreateInput','Required parameter requestParameters.realTimeStreamCreateInput was null or undefined when calling createRealTimeStream.');
        }
        ...
        const response = await this.request({
            ...
            body: RealTimeStreamCreateInputToJSON(requestParameters.realTimeStreamCreateInput),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => RealTimeStreamResponseFromJSON(jsonValue));
    }
     ...
     * Create a real-time stream
     */
    async createRealTimeStream(requestParameters: CreateRealTimeStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RealTimeStreamResponse> {
        const response = await this.createRealTimeStreamRaw(requestParameters, initOverrides);
     ...
     */
    async deleteRealTimeStreamRaw(requestParameters: DeleteRealTimeStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling deleteRealTimeStream.');
        }
        ...
        const response = await this.request({
            path: `/real_time/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete a real-time stream
     */
    async deleteRealTimeStream(requestParameters: DeleteRealTimeStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteRealTimeStreamRaw(requestParameters, initOverrides);
    }
     ...
     */
    async listRealTimeStreamsRaw(requestParameters: ListRealTimeStreamsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RealTimeStreams>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RealTimeStreamsFromJSON(jsonValue));
    }
     ...
     * Fetch all real-time streams
     */
    async listRealTimeStreams(requestParameters: ListRealTimeStreamsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RealTimeStreams> {
        const response = await this.listRealTimeStreamsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async showRealTimeStreamRaw(requestParameters: ShowRealTimeStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RealTimeStreamResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showRealTimeStream.');
        }
     ...
     * Fetch a real-time stream
     */
    async showRealTimeStream(requestParameters: ShowRealTimeStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RealTimeStreamResponse> {
        const response = await this.showRealTimeStreamRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateRealTimeStreamRaw(requestParameters: UpdateRealTimeStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RealTimeStreamResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling updateRealTimeStream.');
        }

        if (requestParameters.realTimeStreamUpdateInput === null || requestParameters.realTimeStreamUpdateInput === undefined) {
            throw new runtime.RequiredError('realTimeStreamUpdateInput','Required parameter requestParameters.realTimeStreamUpdateInput was null or undefined when calling updateRealTimeStream.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: RealTimeStreamUpdateInputToJSON(requestParameters.realTimeStreamUpdateInput),
        }, initOverrides);
     ...
     * Update a real-time stream
     */
    async updateRealTimeStream(requestParameters: UpdateRealTimeStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RealTimeStreamResponse> {
        const response = await this.updateRealTimeStreamRaw(requestParameters, initOverrides);
        return await response.value();
    }
