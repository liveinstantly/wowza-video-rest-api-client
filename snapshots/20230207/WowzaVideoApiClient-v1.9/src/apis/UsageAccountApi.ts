...
import type {
  ...
  Error422,
  UsageAccounts,
  UsageAccountsCountries,
  UsageAccountsTrend,
  UsageAccountsViewerData,
} from '../models';
import {
    Error401FromJSON,
    Error401ToJSON,
    ...
    Error422FromJSON,
    Error422ToJSON,
    UsageAccountsFromJSON,
    UsageAccountsToJSON,
    UsageAccountsCountriesFromJSON,
    UsageAccountsCountriesToJSON,
    UsageAccountsTrendFromJSON,
    UsageAccountsTrendToJSON,
    UsageAccountsViewerDataFromJSON,
    UsageAccountsViewerDataToJSON,
} from '../models';

export interface ShowUsageAccountByCountryRequest {
    filter?: string;
    from?: Date;
    to?: Date;
}

export interface ShowUsageAccountIndexRequest {
    filter?: string;
    from?: Date;
    to?: Date;
}

export interface ShowUsageAccountTrendRequest {
    filter?: string;
    from?: Date;
    to?: Date;
}
 ...
 * 
 */
export class UsageAccountApi extends runtime.BaseAPI {
     ...
     */
    async showUsageAccountByCountryRaw(requestParameters: ShowUsageAccountByCountryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UsageAccountsCountries>> {
        ...
        const response = await this.request({
            path: `/usage/accounts/countries`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UsageAccountsCountriesFromJSON(jsonValue));
    }
     ...
     * Fetch stream usage by country for an account
     */
    async showUsageAccountByCountry(requestParameters: ShowUsageAccountByCountryRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UsageAccountsCountries> {
        const response = await this.showUsageAccountByCountryRaw(requestParameters, initOverrides);
     ...
     */
    async showUsageAccountIndexRaw(requestParameters: ShowUsageAccountIndexRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UsageAccounts>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => UsageAccountsFromJSON(jsonValue));
    }
     ...
     * Fetch usage for an account
     */
    async showUsageAccountIndex(requestParameters: ShowUsageAccountIndexRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UsageAccounts> {
        const response = await this.showUsageAccountIndexRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async showUsageAccountLiveRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UsageAccountsViewerData>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};

        const response = await this.request({
            path: `/usage/accounts/live`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UsageAccountsViewerDataFromJSON(jsonValue));
    }
     ...
     * Fetch live viewer data for an account
     */
    async showUsageAccountLive(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UsageAccountsViewerData> {
        const response = await this.showUsageAccountLiveRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async showUsageAccountTrendRaw(requestParameters: ShowUsageAccountTrendRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UsageAccountsTrend>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/usage/accounts/trend`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UsageAccountsTrendFromJSON(jsonValue));
    }
     ...
     * Fetch trend data for an account
     */
    async showUsageAccountTrend(requestParameters: ShowUsageAccountTrendRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UsageAccountsTrend> {
        const response = await this.showUsageAccountTrendRaw(requestParameters, initOverrides);
        return await response.value();
    }
