 ...
 * 
 * @export
 * @interface UsageEgressDataPerTranscoder
 */
export interface UsageEgressDataPerTranscoder {
    /**
     * The unique alphanumeric string that identifies the transcoder.
     * @type {number}
     * @memberof UsageEgressDataPerTranscoder
     */
    id?: number;
    /**
     ...
     * @memberof UsageEgressDataPerTranscoder
     */
    billingMode?: UsageEgressDataPerTranscoderBillingModeEnum;
    /**
     * The type of transcoder. The default is **transcoded**.
     * @type {string}
     * @memberof UsageEgressDataPerTranscoder
     */
    transcoderType?: UsageEgressDataPerTranscoderTranscoderTypeEnum;
    /**
 ...
 * @export
 */
export const UsageEgressDataPerTranscoderBillingModeEnum = {
    PayAsYouGo: 'pay_as_you_go',
    TwentyfourSeven: 'twentyfour_seven'
} as const;
export type UsageEgressDataPerTranscoderBillingModeEnum = typeof UsageEgressDataPerTranscoderBillingModeEnum[keyof typeof UsageEgressDataPerTranscoderBillingModeEnum];

/**
 * @export
 */
export const UsageEgressDataPerTranscoderTranscoderTypeEnum = {
    Transcoded: 'transcoded',
    Passthrough: 'passthrough'
} as const;
export type UsageEgressDataPerTranscoderTranscoderTypeEnum = typeof UsageEgressDataPerTranscoderTranscoderTypeEnum[keyof typeof UsageEgressDataPerTranscoderTranscoderTypeEnum];


/**
 * Check if a given object implements the UsageEgressDataPerTranscoder interface.
 */
export function instanceOfUsageEgressDataPerTranscoder(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageEgressDataPerTranscoderFromJSON(json: any): UsageEgressDataPerTranscoder {
    return UsageEgressDataPerTranscoderFromJSONTyped(json, false);
}

export function UsageEgressDataPerTranscoderFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageEgressDataPerTranscoder {
...
export function UsageEgressDataPerTranscoderToJSON(value?: UsageEgressDataPerTranscoder | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
