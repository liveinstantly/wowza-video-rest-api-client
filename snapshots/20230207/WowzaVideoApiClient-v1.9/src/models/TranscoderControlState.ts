 ...
 * 
 * @export
 * @interface TranscoderControlState
 */
export interface TranscoderControlState {
    /**
     * The state of the transcoder.
     * @type {string}
     * @memberof TranscoderControlState
     */
    state?: TranscoderControlStateStateEnum;
}
 ...
 * @export
 */
export const TranscoderControlStateStateEnum = {
    Starting: 'starting',
    Stopping: 'stopping',
    Started: 'started',
    Stopped: 'stopped',
...
export type TranscoderControlStateStateEnum = typeof TranscoderControlStateStateEnum[keyof typeof TranscoderControlStateStateEnum];


/**
 * Check if a given object implements the TranscoderControlState interface.
 */
export function instanceOfTranscoderControlState(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranscoderControlStateFromJSON(json: any): TranscoderControlState {
    return TranscoderControlStateFromJSONTyped(json, false);
}

export function TranscoderControlStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderControlState {
...
export function TranscoderControlStateToJSON(value?: TranscoderControlState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
