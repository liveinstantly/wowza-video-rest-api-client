 ...
 * 
 * @export
 * @interface IndexStreamTargetCustom
 */
export interface IndexStreamTargetCustom {
    /**
     * The date and time that the custom stream target was created.
     * @type {Date}
     * @memberof IndexStreamTargetCustom
     */
    createdAt?: Date;
    /**
...
/**
 * Check if a given object implements the IndexStreamTargetCustom interface.
 */
export function instanceOfIndexStreamTargetCustom(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexStreamTargetCustomFromJSON(json: any): IndexStreamTargetCustom {
    return IndexStreamTargetCustomFromJSONTyped(json, false);
}

export function IndexStreamTargetCustomFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexStreamTargetCustom {
...
export function IndexStreamTargetCustomToJSON(value?: IndexStreamTargetCustom | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
