 ...
 * 
 * @export
 * @interface StreamTargetPropertyCreateInputRepsonse
 */
export interface StreamTargetPropertyCreateInputRepsonse {
    /**
     * 
     * @type {StreamTargetProperty}
     * @memberof StreamTargetPropertyCreateInputRepsonse
     */
    property: StreamTargetProperty;
}

/**
 * Check if a given object implements the StreamTargetPropertyCreateInputRepsonse interface.
 */
export function instanceOfStreamTargetPropertyCreateInputRepsonse(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetPropertyCreateInputRepsonseFromJSON(json: any): StreamTargetPropertyCreateInputRepsonse {
    return StreamTargetPropertyCreateInputRepsonseFromJSONTyped(json, false);
}

export function StreamTargetPropertyCreateInputRepsonseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetPropertyCreateInputRepsonse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'property': StreamTargetPropertyFromJSON(json['property']),
    };
}

export function StreamTargetPropertyCreateInputRepsonseToJSON(value?: StreamTargetPropertyCreateInputRepsonse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'property': StreamTargetPropertyToJSON(value.property),
    };
}
