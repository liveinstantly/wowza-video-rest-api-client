 ...
 * 
 * @export
 * @interface UsageViewersDataByRenditionWithZones
 */
export interface UsageViewersDataByRenditionWithZones {
    /**
     * The name of the stream target's output rendition.
     * @type {string}
     * @memberof UsageViewersDataByRenditionWithZones
     */
    name?: string;
    /**
...
/**
 * Check if a given object implements the UsageViewersDataByRenditionWithZones interface.
 */
export function instanceOfUsageViewersDataByRenditionWithZones(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataByRenditionWithZonesFromJSON(json: any): UsageViewersDataByRenditionWithZones {
    return UsageViewersDataByRenditionWithZonesFromJSONTyped(json, false);
}

export function UsageViewersDataByRenditionWithZonesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataByRenditionWithZones {
...
export function UsageViewersDataByRenditionWithZonesToJSON(value?: UsageViewersDataByRenditionWithZones | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
