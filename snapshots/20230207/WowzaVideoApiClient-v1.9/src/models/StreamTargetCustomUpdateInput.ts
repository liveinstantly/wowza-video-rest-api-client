...
import type { StreamTargetCustomUpdateInputInner } from './StreamTargetCustomUpdateInputInner';
import {
    StreamTargetCustomUpdateInputInnerFromJSON,
    StreamTargetCustomUpdateInputInnerFromJSONTyped,
    StreamTargetCustomUpdateInputInnerToJSON,
} from './StreamTargetCustomUpdateInputInner';

/**
 * 
 * @export
 * @interface StreamTargetCustomUpdateInput
 */
export interface StreamTargetCustomUpdateInput {
    /**
     * 
     * @type {StreamTargetCustomUpdateInputInner}
     * @memberof StreamTargetCustomUpdateInput
     */
    streamTargetCustom: StreamTargetCustomUpdateInputInner;
}

/**
 * Check if a given object implements the StreamTargetCustomUpdateInput interface.
 */
export function instanceOfStreamTargetCustomUpdateInput(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamTargetCustom" in value;

    return isInstance;
}

export function StreamTargetCustomUpdateInputFromJSON(json: any): StreamTargetCustomUpdateInput {
    return StreamTargetCustomUpdateInputFromJSONTyped(json, false);
}

export function StreamTargetCustomUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetCustomUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetCustom': StreamTargetCustomUpdateInputInnerFromJSON(json['stream_target_custom']),
    };
}

export function StreamTargetCustomUpdateInputToJSON(value?: StreamTargetCustomUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target_custom': StreamTargetCustomUpdateInputInnerToJSON(value.streamTargetCustom),
    };
}
