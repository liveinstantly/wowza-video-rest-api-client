 ...
 * @export
 */
export const RecordingStateStateEnum = {
    Uploading: 'uploading',
...
export type RecordingStateStateEnum = typeof RecordingStateStateEnum[keyof typeof RecordingStateStateEnum];


/**
 * Check if a given object implements the RecordingState interface.
 */
export function instanceOfRecordingState(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RecordingStateFromJSON(json: any): RecordingState {
    return RecordingStateFromJSONTyped(json, false);
}

export function RecordingStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecordingState {
...
export function RecordingStateToJSON(value?: RecordingState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
