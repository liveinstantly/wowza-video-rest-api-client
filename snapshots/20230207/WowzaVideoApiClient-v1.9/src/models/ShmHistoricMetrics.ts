 ...
 * 
 * @export
 * @interface ShmHistoricMetrics
 */
export interface ShmHistoricMetrics {
    /**
     * 
     * @type {AudioCodecMetric}
     * @memberof ShmHistoricMetrics
     */
...
/**
 * Check if a given object implements the ShmHistoricMetrics interface.
 */
export function instanceOfShmHistoricMetrics(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ShmHistoricMetricsFromJSON(json: any): ShmHistoricMetrics {
    return ShmHistoricMetricsFromJSONTyped(json, false);
}

export function ShmHistoricMetricsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShmHistoricMetrics {
...
export function ShmHistoricMetricsToJSON(value?: ShmHistoricMetrics | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
