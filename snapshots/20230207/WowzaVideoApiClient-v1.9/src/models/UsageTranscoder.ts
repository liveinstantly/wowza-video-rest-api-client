...
import type { UsageViewersDataPerTranscoder } from './UsageViewersDataPerTranscoder';
import {
    UsageViewersDataPerTranscoderFromJSON,
    UsageViewersDataPerTranscoderFromJSONTyped,
    UsageViewersDataPerTranscoderToJSON,
} from './UsageViewersDataPerTranscoder';

/**
 * 
 * @export
 * @interface UsageTranscoder
 */
export interface UsageTranscoder {
    /**
     * 
     * @type {UsageViewersDataPerTranscoder}
     * @memberof UsageTranscoder
     */
    transcoder?: UsageViewersDataPerTranscoder;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageTranscoder
...
/**
 * Check if a given object implements the UsageTranscoder interface.
 */
export function instanceOfUsageTranscoder(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageTranscoderFromJSON(json: any): UsageTranscoder {
    return UsageTranscoderFromJSONTyped(json, false);
}

export function UsageTranscoderFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageTranscoder {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': !exists(json, 'transcoder') ? undefined : UsageViewersDataPerTranscoderFromJSON(json['transcoder']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageTranscoderToJSON(value?: UsageTranscoder | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': UsageViewersDataPerTranscoderToJSON(value.transcoder),
