...
/**
 * Check if a given object implements the Hds interface.
 */
export function instanceOfHds(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HdsFromJSON(json: any): Hds {
    return HdsFromJSONTyped(json, false);
}

export function HdsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Hds {
...
export function HdsToJSON(value?: Hds | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
