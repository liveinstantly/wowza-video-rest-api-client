 ...
 * 
 * @export
 * @interface StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric
 */
export interface StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric {
    /**
     * The status of the current key. Possible values are **normal** (everything is fine), **warning** (something may be misconfigured), and **no_data** (no data was returned, perhaps because the instance isn't running).
     * @type {string}
     * @memberof StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric
     */
    status?: string;
    /**
    ...
    text?: string;
    /**
     * The unit of the returned value, such as **Kbps**, **bps**, **%**, **FPS**, or **GOP**.
     * @type {string}
     * @memberof StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric
     */
    units?: string;
...
/**
 * Check if a given object implements the StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric interface.
 */
export function instanceOfStreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetricFromJSON(json: any): StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric {
    return StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetricFromJSONTyped(json, false);
}

export function StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric {
...
export function StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetricToJSON(value?: StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
