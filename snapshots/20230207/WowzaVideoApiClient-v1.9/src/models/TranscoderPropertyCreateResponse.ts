...
import {
    ...
    instanceOfTranscoderConfigurePropertiesPostResponse,
    TranscoderConfigurePropertiesPostResponseFromJSON,
    TranscoderConfigurePropertiesPostResponseFromJSONTyped,
    TranscoderConfigurePropertiesPostResponseToJSON,
} from './TranscoderConfigurePropertiesPostResponse';
import {
    TranscoderConfigurePropertyPostResponse,
    instanceOfTranscoderConfigurePropertyPostResponse,
    TranscoderConfigurePropertyPostResponseFromJSON,
    TranscoderConfigurePropertyPostResponseFromJSONTyped,
    TranscoderConfigurePropertyPostResponseToJSON,
} from './TranscoderConfigurePropertyPostResponse';

/**
 * @type TranscoderPropertyCreateResponse
 * 
 * @export
 */
export type TranscoderPropertyCreateResponse = TranscoderConfigurePropertiesPostResponse | TranscoderConfigurePropertyPostResponse;

export function TranscoderPropertyCreateResponseFromJSON(json: any): TranscoderPropertyCreateResponse {
    return TranscoderPropertyCreateResponseFromJSONTyped(json, false);
}

export function TranscoderPropertyCreateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderPropertyCreateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...TranscoderConfigurePropertiesPostResponseFromJSONTyped(json, true), ...TranscoderConfigurePropertyPostResponseFromJSONTyped(json, true) };
}

export function TranscoderPropertyCreateResponseToJSON(value?: TranscoderPropertyCreateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfTranscoderConfigurePropertiesPostResponse(value)) {
        return TranscoderConfigurePropertiesPostResponseToJSON(value as TranscoderConfigurePropertiesPostResponse);
    }
    if (instanceOfTranscoderConfigurePropertyPostResponse(value)) {
        return TranscoderConfigurePropertyPostResponseToJSON(value as TranscoderConfigurePropertyPostResponse);
    }
