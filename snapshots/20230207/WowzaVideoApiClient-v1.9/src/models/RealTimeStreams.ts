...
import type { IndexRealTimeStream } from './IndexRealTimeStream';
import {
    IndexRealTimeStreamFromJSON,
    IndexRealTimeStreamFromJSONTyped,
    IndexRealTimeStreamToJSON,
} from './IndexRealTimeStream';
...
export interface RealTimeStreams {
    /**
     * 
     * @type {Array<IndexRealTimeStream>}
     * @memberof RealTimeStreams
     */
    realTimeStreams: Array<IndexRealTimeStream>;
}

/**
 * Check if a given object implements the RealTimeStreams interface.
 */
export function instanceOfRealTimeStreams(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "realTimeStreams" in value;

    return isInstance;
}

export function RealTimeStreamsFromJSON(json: any): RealTimeStreams {
    return RealTimeStreamsFromJSONTyped(json, false);
}

export function RealTimeStreamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RealTimeStreams {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'realTimeStreams': ((json['real_time_streams'] as Array<any>).map(IndexRealTimeStreamFromJSON)),
    };
}

export function RealTimeStreamsToJSON(value?: RealTimeStreams | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'real_time_streams': ((value.realTimeStreams as Array<any>).map(IndexRealTimeStreamToJSON)),
    };
}
