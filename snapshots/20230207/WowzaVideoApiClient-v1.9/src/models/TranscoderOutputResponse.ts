 ...
 * 
 * @export
 * @interface TranscoderOutputResponse
 */
export interface TranscoderOutputResponse {
    /**
     * 
     * @type {Output}
     * @memberof TranscoderOutputResponse
     */
    output: Output;
}

/**
 * Check if a given object implements the TranscoderOutputResponse interface.
 */
export function instanceOfTranscoderOutputResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderOutputResponseFromJSON(json: any): TranscoderOutputResponse {
    return TranscoderOutputResponseFromJSONTyped(json, false);
}

export function TranscoderOutputResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderOutputResponse {
...
export function TranscoderOutputResponseToJSON(value?: TranscoderOutputResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
