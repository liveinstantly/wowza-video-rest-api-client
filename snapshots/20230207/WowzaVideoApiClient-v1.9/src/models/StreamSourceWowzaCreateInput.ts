...
import type { StreamSourceWowzaCreateInputInner } from './StreamSourceWowzaCreateInputInner';
import {
    StreamSourceWowzaCreateInputInnerFromJSON,
    StreamSourceWowzaCreateInputInnerFromJSONTyped,
    StreamSourceWowzaCreateInputInnerToJSON,
} from './StreamSourceWowzaCreateInputInner';

/**
 * 
 * @export
 * @interface StreamSourceWowzaCreateInput
 */
export interface StreamSourceWowzaCreateInput {
    /**
     * 
     * @type {StreamSourceWowzaCreateInputInner}
     * @memberof StreamSourceWowzaCreateInput
     */
    streamSourceWowza: StreamSourceWowzaCreateInputInner;
}

/**
 * Check if a given object implements the StreamSourceWowzaCreateInput interface.
 */
export function instanceOfStreamSourceWowzaCreateInput(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamSourceWowza" in value;

    return isInstance;
}

export function StreamSourceWowzaCreateInputFromJSON(json: any): StreamSourceWowzaCreateInput {
    return StreamSourceWowzaCreateInputFromJSONTyped(json, false);
}

export function StreamSourceWowzaCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamSourceWowzaCreateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamSourceWowza': StreamSourceWowzaCreateInputInnerFromJSON(json['stream_source_wowza']),
    };
}

export function StreamSourceWowzaCreateInputToJSON(value?: StreamSourceWowzaCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_source_wowza': StreamSourceWowzaCreateInputInnerToJSON(value.streamSourceWowza),
    };
}
