...
export interface UsagePagination {
    ...
    totalRecords?: number;
    /**
     * The key ID of the next page of results.
     * @type {string}
     * @memberof UsagePagination
     */
    nextPageKey?: string;
...
/**
 * Check if a given object implements the UsagePagination interface.
 */
export function instanceOfUsagePagination(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsagePaginationFromJSON(json: any): UsagePagination {
    return UsagePaginationFromJSONTyped(json, false);
}

export function UsagePaginationFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsagePagination {
    ...
    return {
        ...
        'nextPageKey': !exists(json, 'next_page_key') ? undefined : json['next_page_key'],
        'perPage': !exists(json, 'per_page') ? undefined : json['per_page'],
        'totalPages': !exists(json, 'total_pages') ? undefined : json['total_pages'],
    };
}

export function UsagePaginationToJSON(value?: UsagePagination | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'next_page_key': value.nextPageKey,
