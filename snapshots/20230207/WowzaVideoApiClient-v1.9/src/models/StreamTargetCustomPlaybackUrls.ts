 ...
 * @export
 * @interface StreamTargetCustomPlaybackUrls
 */
export interface StreamTargetCustomPlaybackUrls {
    /**
     * Web address that the target uses to play HLS streams.
     * @type {Array<Hls>}
     * @memberof StreamTargetCustomPlaybackUrls
     */
    hls?: Array<Hls>;
    /**
     * Web address that the target uses to play HDS streams. Not for use with the akamai_cupertino custom *provider*.
     * @type {Array<Hds>}
     * @memberof StreamTargetCustomPlaybackUrls
     */
    hds?: Array<Hds>;
    /**
     * Web address that the target uses to play RTMP streams.
     * @type {Array<Rtmp>}
     * @memberof StreamTargetCustomPlaybackUrls
     */
    rtmp?: Array<Rtmp>;
...
/**
 * Check if a given object implements the StreamTargetCustomPlaybackUrls interface.
 */
export function instanceOfStreamTargetCustomPlaybackUrls(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetCustomPlaybackUrlsFromJSON(json: any): StreamTargetCustomPlaybackUrls {
    return StreamTargetCustomPlaybackUrlsFromJSONTyped(json, false);
}

export function StreamTargetCustomPlaybackUrlsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetCustomPlaybackUrls {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'hls': !exists(json, 'hls') ? undefined : ((json['hls'] as Array<any>).map(HlsFromJSON)),
        'hds': !exists(json, 'hds') ? undefined : ((json['hds'] as Array<any>).map(HdsFromJSON)),
        'rtmp': !exists(json, 'rtmp') ? undefined : ((json['rtmp'] as Array<any>).map(RtmpFromJSON)),
    };
}

export function StreamTargetCustomPlaybackUrlsToJSON(value?: StreamTargetCustomPlaybackUrls | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'hls': value.hls === undefined ? undefined : ((value.hls as Array<any>).map(HlsToJSON)),
        'hds': value.hds === undefined ? undefined : ((value.hds as Array<any>).map(HdsToJSON)),
        'rtmp': value.rtmp === undefined ? undefined : ((value.rtmp as Array<any>).map(RtmpToJSON)),
    };
}
