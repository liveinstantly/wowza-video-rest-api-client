...
import type { IndexStreamTargetCustom } from './IndexStreamTargetCustom';
import {
    IndexStreamTargetCustomFromJSON,
    IndexStreamTargetCustomFromJSONTyped,
    IndexStreamTargetCustomToJSON,
} from './IndexStreamTargetCustom';

/**
 * 
 * @export
 * @interface StreamTargetsCustom
 */
export interface StreamTargetsCustom {
    /**
     * 
     * @type {Array<IndexStreamTargetCustom>}
     * @memberof StreamTargetsCustom
     */
    streamTargetsCustom: Array<IndexStreamTargetCustom>;
}

/**
 * Check if a given object implements the StreamTargetsCustom interface.
 */
export function instanceOfStreamTargetsCustom(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamTargetsCustom" in value;

    return isInstance;
}

export function StreamTargetsCustomFromJSON(json: any): StreamTargetsCustom {
    return StreamTargetsCustomFromJSONTyped(json, false);
}

export function StreamTargetsCustomFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetsCustom {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetsCustom': ((json['stream_targets_custom'] as Array<any>).map(IndexStreamTargetCustomFromJSON)),
    };
}

export function StreamTargetsCustomToJSON(value?: StreamTargetsCustom | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_targets_custom': ((value.streamTargetsCustom as Array<any>).map(IndexStreamTargetCustomToJSON)),
    };
}
