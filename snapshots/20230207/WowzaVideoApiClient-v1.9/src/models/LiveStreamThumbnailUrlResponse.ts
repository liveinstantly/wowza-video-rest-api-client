...
import type { LiveStreamThumbnailUrl } from './LiveStreamThumbnailUrl';
import {
    LiveStreamThumbnailUrlFromJSON,
    LiveStreamThumbnailUrlFromJSONTyped,
    LiveStreamThumbnailUrlToJSON,
} from './LiveStreamThumbnailUrl';

/**
 * 
 * @export
 * @interface LiveStreamThumbnailUrlResponse
 */
export interface LiveStreamThumbnailUrlResponse {
    /**
     * 
     * @type {LiveStreamThumbnailUrl}
     * @memberof LiveStreamThumbnailUrlResponse
     */
    liveStream: LiveStreamThumbnailUrl;
}

/**
 * Check if a given object implements the LiveStreamThumbnailUrlResponse interface.
 */
export function instanceOfLiveStreamThumbnailUrlResponse(value: object): boolean {
    let isInstance = true;
...
export function LiveStreamThumbnailUrlResponseFromJSON(json: any): LiveStreamThumbnailUrlResponse {
    return LiveStreamThumbnailUrlResponseFromJSONTyped(json, false);
}

export function LiveStreamThumbnailUrlResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamThumbnailUrlResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'liveStream': LiveStreamThumbnailUrlFromJSON(json['live_stream']),
    };
}

export function LiveStreamThumbnailUrlResponseToJSON(value?: LiveStreamThumbnailUrlResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'live_stream': LiveStreamThumbnailUrlToJSON(value.liveStream),
    };
}
