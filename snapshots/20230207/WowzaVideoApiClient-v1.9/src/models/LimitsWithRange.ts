 ...
 * 
 * @export
 * @interface LimitsWithRange
 */
export interface LimitsWithRange {
    /**
     * A comma-separated list of fields that were returned in the request.
     * @type {string}
     * @memberof LimitsWithRange
     */
    fields: string;
    /**
...
/**
 * Check if a given object implements the LimitsWithRange interface.
 */
export function instanceOfLimitsWithRange(value: object): boolean {
    let isInstance = true;
...
export function LimitsWithRangeFromJSON(json: any): LimitsWithRange {
    return LimitsWithRangeFromJSONTyped(json, false);
}

export function LimitsWithRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LimitsWithRange {
...
export function LimitsWithRangeToJSON(value?: LimitsWithRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
