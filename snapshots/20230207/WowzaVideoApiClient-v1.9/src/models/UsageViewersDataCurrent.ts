...
import type { UsageViewersCountry } from './UsageViewersCountry';
import {
    UsageViewersCountryFromJSON,
    UsageViewersCountryFromJSONTyped,
    UsageViewersCountryToJSON,
} from './UsageViewersCountry';
import type { UsageViewersTrends } from './UsageViewersTrends';
import {
    UsageViewersTrendsFromJSON,
    UsageViewersTrendsFromJSONTyped,
    UsageViewersTrendsToJSON,
} from './UsageViewersTrends';

/**
 * 
 * @export
 * @interface UsageViewersDataCurrent
 */
export interface UsageViewersDataCurrent {
    /**
     * The unique alphanumeric string that identifies the transcoder, stream target, or VOD stream.
     * @type {string}
     * @memberof UsageViewersDataCurrent
     */
    id?: string;
    /**
    ...
    /**
     * (Available since 1.8) An array of viewer countries.
     * @type {Array<UsageViewersCountry>}
     * @memberof UsageViewersDataCurrent
     */
    countries?: Array<UsageViewersCountry>;
    /**
     * (Available since 1.8) An array of viewer trend data. Returns one data point per minute for the past hour.
     * @type {Array<UsageViewersTrends>}
     * @memberof UsageViewersDataCurrent
     */
    viewerTrend?: Array<UsageViewersTrends>;
}

/**
 * Check if a given object implements the UsageViewersDataCurrent interface.
 */
export function instanceOfUsageViewersDataCurrent(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataCurrentFromJSON(json: any): UsageViewersDataCurrent {
    return UsageViewersDataCurrentFromJSONTyped(json, false);
}

export function UsageViewersDataCurrentFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataCurrent {
    ...
    return {
        ...
        'countries': !exists(json, 'countries') ? undefined : ((json['countries'] as Array<any>).map(UsageViewersCountryFromJSON)),
        'viewerTrend': !exists(json, 'viewer_trend') ? undefined : ((json['viewer_trend'] as Array<any>).map(UsageViewersTrendsFromJSON)),
    };
}

export function UsageViewersDataCurrentToJSON(value?: UsageViewersDataCurrent | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'countries': value.countries === undefined ? undefined : ((value.countries as Array<any>).map(UsageViewersCountryToJSON)),
        'viewer_trend': value.viewerTrend === undefined ? undefined : ((value.viewerTrend as Array<any>).map(UsageViewersTrendsToJSON)),
    };
}
