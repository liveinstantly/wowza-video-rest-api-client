...
import type { UsageLimitsWithResources } from './UsageLimitsWithResources';
import {
    UsageLimitsWithResourcesFromJSON,
    UsageLimitsWithResourcesFromJSONTyped,
    UsageLimitsWithResourcesToJSON,
} from './UsageLimitsWithResources';
import type { UsageViewersDataByCountry } from './UsageViewersDataByCountry';
import {
    UsageViewersDataByCountryFromJSON,
    UsageViewersDataByCountryFromJSONTyped,
    UsageViewersDataByCountryToJSON,
} from './UsageViewersDataByCountry';

/**
 * 
 * @export
 * @interface UsageAccountsCountries
 */
export interface UsageAccountsCountries {
    /**
     * An array of viewer countries.
     * @type {Array<UsageViewersDataByCountry>}
     * @memberof UsageAccountsCountries
     */
    countries?: Array<UsageViewersDataByCountry>;
    /**
     * 
     * @type {UsageLimitsWithResources}
     * @memberof UsageAccountsCountries
     */
    limits?: UsageLimitsWithResources;
}

/**
 * Check if a given object implements the UsageAccountsCountries interface.
 */
export function instanceOfUsageAccountsCountries(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageAccountsCountriesFromJSON(json: any): UsageAccountsCountries {
    return UsageAccountsCountriesFromJSONTyped(json, false);
}

export function UsageAccountsCountriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageAccountsCountries {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'countries': !exists(json, 'countries') ? undefined : ((json['countries'] as Array<any>).map(UsageViewersDataByCountryFromJSON)),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsWithResourcesFromJSON(json['limits']),
    };
}

export function UsageAccountsCountriesToJSON(value?: UsageAccountsCountries | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'countries': value.countries === undefined ? undefined : ((value.countries as Array<any>).map(UsageViewersDataByCountryToJSON)),
        'limits': UsageLimitsWithResourcesToJSON(value.limits),
    };
}
