...
import type { StreamSourceWowzaPatchResponse } from './StreamSourceWowzaPatchResponse';
import {
    StreamSourceWowzaPatchResponseFromJSON,
    StreamSourceWowzaPatchResponseFromJSONTyped,
    StreamSourceWowzaPatchResponseToJSON,
} from './StreamSourceWowzaPatchResponse';

/**
 * 
 * @export
 * @interface StreamSourceWowzaResponse
 */
export interface StreamSourceWowzaResponse {
    /**
     * 
     * @type {StreamSourceWowzaPatchResponse}
     * @memberof StreamSourceWowzaResponse
     */
    streamSourceWowza: StreamSourceWowzaPatchResponse;
}

/**
 * Check if a given object implements the StreamSourceWowzaResponse interface.
 */
export function instanceOfStreamSourceWowzaResponse(value: object): boolean {
    let isInstance = true;
...
export function StreamSourceWowzaResponseFromJSON(json: any): StreamSourceWowzaResponse {
    return StreamSourceWowzaResponseFromJSONTyped(json, false);
}

export function StreamSourceWowzaResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamSourceWowzaResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamSourceWowza': StreamSourceWowzaPatchResponseFromJSON(json['stream_source_wowza']),
    };
}

export function StreamSourceWowzaResponseToJSON(value?: StreamSourceWowzaResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_source_wowza': StreamSourceWowzaPatchResponseToJSON(value.streamSourceWowza),
    };
}
