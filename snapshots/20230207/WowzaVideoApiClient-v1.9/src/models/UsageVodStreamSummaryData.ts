 ...
 * 
 * @export
 * @interface UsageVodStreamSummaryData
 */
export interface UsageVodStreamSummaryData {
    /**
     ...
     * @type {number}
     * @memberof UsageVodStreamSummaryData
     */
...
/**
 * Check if a given object implements the UsageVodStreamSummaryData interface.
 */
export function instanceOfUsageVodStreamSummaryData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamSummaryDataFromJSON(json: any): UsageVodStreamSummaryData {
    return UsageVodStreamSummaryDataFromJSONTyped(json, false);
}

export function UsageVodStreamSummaryDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamSummaryData {
...
export function UsageVodStreamSummaryDataToJSON(value?: UsageVodStreamSummaryData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
