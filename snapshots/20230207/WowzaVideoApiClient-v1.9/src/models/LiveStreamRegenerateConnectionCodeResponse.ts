...
import type { LiveStreamConnectionCode } from './LiveStreamConnectionCode';
import {
    LiveStreamConnectionCodeFromJSON,
    LiveStreamConnectionCodeFromJSONTyped,
    LiveStreamConnectionCodeToJSON,
} from './LiveStreamConnectionCode';

/**
 * 
 * @export
 * @interface LiveStreamRegenerateConnectionCodeResponse
 */
export interface LiveStreamRegenerateConnectionCodeResponse {
    /**
     * 
     * @type {LiveStreamConnectionCode}
     * @memberof LiveStreamRegenerateConnectionCodeResponse
     */
    liveStream: LiveStreamConnectionCode;
}

/**
 * Check if a given object implements the LiveStreamRegenerateConnectionCodeResponse interface.
 */
export function instanceOfLiveStreamRegenerateConnectionCodeResponse(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "liveStream" in value;

    return isInstance;
}

export function LiveStreamRegenerateConnectionCodeResponseFromJSON(json: any): LiveStreamRegenerateConnectionCodeResponse {
    return LiveStreamRegenerateConnectionCodeResponseFromJSONTyped(json, false);
}

export function LiveStreamRegenerateConnectionCodeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamRegenerateConnectionCodeResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'liveStream': LiveStreamConnectionCodeFromJSON(json['live_stream']),
    };
}

export function LiveStreamRegenerateConnectionCodeResponseToJSON(value?: LiveStreamRegenerateConnectionCodeResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'live_stream': LiveStreamConnectionCodeToJSON(value.liveStream),
    };
}
