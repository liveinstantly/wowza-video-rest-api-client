 ...
 * 
 * @export
 * @interface PlayerUrlInputInner
 */
export interface PlayerUrlInputInner {
    /**
...
/**
 * Check if a given object implements the PlayerUrlInputInner interface.
 */
export function instanceOfPlayerUrlInputInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PlayerUrlInputInnerFromJSON(json: any): PlayerUrlInputInner {
    return PlayerUrlInputInnerFromJSONTyped(json, false);
}

export function PlayerUrlInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerUrlInputInner {
...
export function PlayerUrlInputInnerToJSON(value?: PlayerUrlInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
