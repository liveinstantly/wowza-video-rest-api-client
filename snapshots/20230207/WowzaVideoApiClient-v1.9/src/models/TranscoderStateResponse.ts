 ...
 * 
 * @export
 * @interface TranscoderStateResponse
 */
export interface TranscoderStateResponse {
    /**
     * 
     * @type {TranscoderState}
     * @memberof TranscoderStateResponse
     */
    transcoder: TranscoderState;
}

/**
 * Check if a given object implements the TranscoderStateResponse interface.
 */
export function instanceOfTranscoderStateResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderStateResponseFromJSON(json: any): TranscoderStateResponse {
    return TranscoderStateResponseFromJSONTyped(json, false);
}

export function TranscoderStateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderStateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': TranscoderStateFromJSON(json['transcoder']),
    };
}

export function TranscoderStateResponseToJSON(value?: TranscoderStateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': TranscoderStateToJSON(value.transcoder),
    };
}
