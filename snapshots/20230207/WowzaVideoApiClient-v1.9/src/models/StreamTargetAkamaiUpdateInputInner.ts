...
import type { StreamTargetPropertyAkamai } from './StreamTargetPropertyAkamai';
import {
    StreamTargetPropertyAkamaiFromJSON,
    StreamTargetPropertyAkamaiFromJSONTyped,
    StreamTargetPropertyAkamaiToJSON,
} from './StreamTargetPropertyAkamai';

/**
 * 
 * @export
 * @interface StreamTargetAkamaiUpdateInputInner
 */
export interface StreamTargetAkamaiUpdateInputInner {
    /**
     * A descriptive name for the stream target. Maximum 255 characters.
     * @type {string}
     * @memberof StreamTargetAkamaiUpdateInputInner
     */
    name?: string;
    /**
     * Configures one or more stream target properties for a Wowza stream target whose provider is **akamai_cupertino**. The property configuration consists of a key/value pair and the section of the stream target configuration table the key/value pair is stored in. Available from version 1.7.
     * @type {Array<StreamTargetPropertyAkamai>}
     * @memberof StreamTargetAkamaiUpdateInputInner
     */
    properties?: Array<StreamTargetPropertyAkamai>;
    /**
     * The CDN for the target.
     * @type {string}
     * @memberof StreamTargetAkamaiUpdateInputInner
     */
    provider?: StreamTargetAkamaiUpdateInputInnerProviderEnum;
}
 ...
 * @export
 */
export const StreamTargetAkamaiUpdateInputInnerProviderEnum = {
    Akamai: 'akamai',
    AkamaiCupertino: 'akamai_cupertino',
    AkamaiLegacyRtmp: 'akamai_legacy_rtmp'
} as const;
export type StreamTargetAkamaiUpdateInputInnerProviderEnum = typeof StreamTargetAkamaiUpdateInputInnerProviderEnum[keyof typeof StreamTargetAkamaiUpdateInputInnerProviderEnum];


/**
 * Check if a given object implements the StreamTargetAkamaiUpdateInputInner interface.
 */
export function instanceOfStreamTargetAkamaiUpdateInputInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetAkamaiUpdateInputInnerFromJSON(json: any): StreamTargetAkamaiUpdateInputInner {
    return StreamTargetAkamaiUpdateInputInnerFromJSONTyped(json, false);
}

export function StreamTargetAkamaiUpdateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetAkamaiUpdateInputInner {
    ...
    return {
        ...
        'properties': !exists(json, 'properties') ? undefined : ((json['properties'] as Array<any>).map(StreamTargetPropertyAkamaiFromJSON)),
        'provider': !exists(json, 'provider') ? undefined : json['provider'],
    };
}

export function StreamTargetAkamaiUpdateInputInnerToJSON(value?: StreamTargetAkamaiUpdateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'name': value.name,
        'properties': value.properties === undefined ? undefined : ((value.properties as Array<any>).map(StreamTargetPropertyAkamaiToJSON)),
