...
import type { IndexStreamSource } from './IndexStreamSource';
import {
    IndexStreamSourceFromJSON,
    IndexStreamSourceFromJSONTyped,
    IndexStreamSourceToJSON,
} from './IndexStreamSource';
...
export interface StreamSources {
    /**
     * 
     * @type {Array<IndexStreamSource>}
     * @memberof StreamSources
     */
    streamSources: Array<IndexStreamSource>;
}

/**
 * Check if a given object implements the StreamSources interface.
 */
export function instanceOfStreamSources(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamSources" in value;

    return isInstance;
}

export function StreamSourcesFromJSON(json: any): StreamSources {
    return StreamSourcesFromJSONTyped(json, false);
}

export function StreamSourcesFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamSources {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamSources': ((json['stream_sources'] as Array<any>).map(IndexStreamSourceFromJSON)),
    };
}

export function StreamSourcesToJSON(value?: StreamSources | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_sources': ((value.streamSources as Array<any>).map(IndexStreamSourceToJSON)),
    };
}
