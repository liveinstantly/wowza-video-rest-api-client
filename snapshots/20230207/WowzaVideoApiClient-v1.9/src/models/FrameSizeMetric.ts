 ...
 * 
 * @export
 * @interface FrameSizeMetric
 */
export interface FrameSizeMetric {
    /**
...
/**
 * Check if a given object implements the FrameSizeMetric interface.
 */
export function instanceOfFrameSizeMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function FrameSizeMetricFromJSON(json: any): FrameSizeMetric {
    return FrameSizeMetricFromJSONTyped(json, false);
}

export function FrameSizeMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): FrameSizeMetric {
...
export function FrameSizeMetricToJSON(value?: FrameSizeMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
