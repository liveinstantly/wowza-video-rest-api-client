 ...
 * 
 * @export
 * @interface StreamTargetAkamaiPatchResponse
 */
export interface StreamTargetAkamaiPatchResponse {
    /**
...
**Note:** When both the primary and backup URLs are used, Wowza Video sends the stream to both URLs, allowing a provider or 3rd party CDN to improve reliability and prevent playback disruption. If you want to use both URLs, make sure you add the stream target to the output rendition twice, once with *use_stream_target_backup_url* as **false** (the default) and once with *use_stream_target_backup_url* as **true**. See <a href="https://api.docs.video.wowza.com/index/current/tag/transcoders/#tag/transcoders/operation/createTranscoderOutputOutputStreamTarget">POST /transcoders/[ID]/outputs/[ID]/output_stream_targets</a> for more information.
     * @type {string}
     * @memberof StreamTargetAkamaiPatchResponse
     */
    backupUrl?: string;
    /**
     ...
     * @memberof StreamTargetAkamaiPatchResponse
     */
    location?: StreamTargetAkamaiPatchResponseLocationEnum;
    /**
 ...
 * @export
 */
export const StreamTargetAkamaiPatchResponseLocationEnum = {
...
export type StreamTargetAkamaiPatchResponseLocationEnum = typeof StreamTargetAkamaiPatchResponseLocationEnum[keyof typeof StreamTargetAkamaiPatchResponseLocationEnum];


/**
 * Check if a given object implements the StreamTargetAkamaiPatchResponse interface.
 */
export function instanceOfStreamTargetAkamaiPatchResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetAkamaiPatchResponseFromJSON(json: any): StreamTargetAkamaiPatchResponse {
    return StreamTargetAkamaiPatchResponseFromJSONTyped(json, false);
}

export function StreamTargetAkamaiPatchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetAkamaiPatchResponse {
...
export function StreamTargetAkamaiPatchResponseToJSON(value?: StreamTargetAkamaiPatchResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
