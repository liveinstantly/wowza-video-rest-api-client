...
/**
 * Check if a given object implements the AssetRestream interface.
 */
export function instanceOfAssetRestream(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AssetRestreamFromJSON(json: any): AssetRestream {
    return AssetRestreamFromJSONTyped(json, false);
}

export function AssetRestreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetRestream {
...
export function AssetRestreamToJSON(value?: AssetRestream | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
