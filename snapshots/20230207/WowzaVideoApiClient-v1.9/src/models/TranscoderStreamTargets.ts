...
import type { StreamTargetsState } from './StreamTargetsState';
import {
    StreamTargetsStateFromJSON,
    StreamTargetsStateFromJSONTyped,
    StreamTargetsStateToJSON,
} from './StreamTargetsState';

/**
 * 
 * @export
 * @interface TranscoderStreamTargets
 */
export interface TranscoderStreamTargets {
    /**
     * 
     * @type {StreamTargetsState}
     * @memberof TranscoderStreamTargets
     */
    streamTargets: StreamTargetsState;
}

/**
 * Check if a given object implements the TranscoderStreamTargets interface.
 */
export function instanceOfTranscoderStreamTargets(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamTargets" in value;

    return isInstance;
}

export function TranscoderStreamTargetsFromJSON(json: any): TranscoderStreamTargets {
    return TranscoderStreamTargetsFromJSONTyped(json, false);
}

export function TranscoderStreamTargetsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderStreamTargets {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargets': StreamTargetsStateFromJSON(json['stream_targets']),
    };
}

export function TranscoderStreamTargetsToJSON(value?: TranscoderStreamTargets | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_targets': StreamTargetsStateToJSON(value.streamTargets),
    };
}
