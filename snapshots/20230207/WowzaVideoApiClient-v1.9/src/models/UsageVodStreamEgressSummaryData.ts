 ...
 * 
 * @export
 * @interface UsageVodStreamEgressSummaryData
 */
export interface UsageVodStreamEgressSummaryData {
    /**
     * The amount of content, in bytes, that Wowza CDN on Fastly pulled from storage during the selected time frame.
     * @type {number}
     * @memberof UsageVodStreamEgressSummaryData
     */
    egressBytes?: number;
}

/**
 * Check if a given object implements the UsageVodStreamEgressSummaryData interface.
 */
export function instanceOfUsageVodStreamEgressSummaryData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamEgressSummaryDataFromJSON(json: any): UsageVodStreamEgressSummaryData {
    return UsageVodStreamEgressSummaryDataFromJSONTyped(json, false);
}

export function UsageVodStreamEgressSummaryDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamEgressSummaryData {
...
export function UsageVodStreamEgressSummaryDataToJSON(value?: UsageVodStreamEgressSummaryData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
