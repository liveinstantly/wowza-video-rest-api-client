...
import type { UsageViewersDataByCountryWithZones } from './UsageViewersDataByCountryWithZones';
import {
    UsageViewersDataByCountryWithZonesFromJSON,
    UsageViewersDataByCountryWithZonesFromJSONTyped,
    UsageViewersDataByCountryWithZonesToJSON,
} from './UsageViewersDataByCountryWithZones';

/**
 * 
 * @export
 * @interface UsageStreamTargetCountries
 */
export interface UsageStreamTargetCountries {
    /**
     * An array of viewer countries.
     * @type {Array<UsageViewersDataByCountryWithZones>}
     * @memberof UsageStreamTargetCountries
     */
    countries?: Array<UsageViewersDataByCountryWithZones>;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageStreamTargetCountries
...
/**
 * Check if a given object implements the UsageStreamTargetCountries interface.
 */
export function instanceOfUsageStreamTargetCountries(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageStreamTargetCountriesFromJSON(json: any): UsageStreamTargetCountries {
    return UsageStreamTargetCountriesFromJSONTyped(json, false);
}

export function UsageStreamTargetCountriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageStreamTargetCountries {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'countries': !exists(json, 'countries') ? undefined : ((json['countries'] as Array<any>).map(UsageViewersDataByCountryWithZonesFromJSON)),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageStreamTargetCountriesToJSON(value?: UsageStreamTargetCountries | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'countries': value.countries === undefined ? undefined : ((value.countries as Array<any>).map(UsageViewersDataByCountryWithZonesToJSON)),
