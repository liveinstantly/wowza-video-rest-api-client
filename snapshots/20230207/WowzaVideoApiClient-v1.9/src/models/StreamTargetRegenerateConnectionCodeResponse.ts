...
import type { StreamTargetConnectionCode } from './StreamTargetConnectionCode';
import {
    StreamTargetConnectionCodeFromJSON,
    StreamTargetConnectionCodeFromJSONTyped,
    StreamTargetConnectionCodeToJSON,
} from './StreamTargetConnectionCode';

/**
 * 
 * @export
 * @interface StreamTargetRegenerateConnectionCodeResponse
 */
export interface StreamTargetRegenerateConnectionCodeResponse {
    /**
     * 
     * @type {StreamTargetConnectionCode}
     * @memberof StreamTargetRegenerateConnectionCodeResponse
     */
    streamTarget: StreamTargetConnectionCode;
}

/**
 * Check if a given object implements the StreamTargetRegenerateConnectionCodeResponse interface.
 */
export function instanceOfStreamTargetRegenerateConnectionCodeResponse(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetRegenerateConnectionCodeResponseFromJSON(json: any): StreamTargetRegenerateConnectionCodeResponse {
    return StreamTargetRegenerateConnectionCodeResponseFromJSONTyped(json, false);
}

export function StreamTargetRegenerateConnectionCodeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetRegenerateConnectionCodeResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTarget': StreamTargetConnectionCodeFromJSON(json['stream_target']),
    };
}

export function StreamTargetRegenerateConnectionCodeResponseToJSON(value?: StreamTargetRegenerateConnectionCodeResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target': StreamTargetConnectionCodeToJSON(value.streamTarget),
    };
}
