...
import type { UsageViewersDataPerVodStreamWithEgress } from './UsageViewersDataPerVodStreamWithEgress';
import {
    UsageViewersDataPerVodStreamWithEgressFromJSON,
    UsageViewersDataPerVodStreamWithEgressFromJSONTyped,
    UsageViewersDataPerVodStreamWithEgressToJSON,
} from './UsageViewersDataPerVodStreamWithEgress';

/**
 * 
 * @export
 * @interface UsageVodStream
 */
export interface UsageVodStream {
    /**
     * 
     * @type {UsageViewersDataPerVodStreamWithEgress}
     * @memberof UsageVodStream
     */
    vodStream?: UsageViewersDataPerVodStreamWithEgress;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageVodStream
...
/**
 * Check if a given object implements the UsageVodStream interface.
 */
export function instanceOfUsageVodStream(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamFromJSON(json: any): UsageVodStream {
    return UsageVodStreamFromJSONTyped(json, false);
}

export function UsageVodStreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStream {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'vodStream': !exists(json, 'vod_stream') ? undefined : UsageViewersDataPerVodStreamWithEgressFromJSON(json['vod_stream']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageVodStreamToJSON(value?: UsageVodStream | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'vod_stream': UsageViewersDataPerVodStreamWithEgressToJSON(value.vodStream),
