 ...
 * 
 * @export
 * @interface BitsOutRateMetric
 */
export interface BitsOutRateMetric {
    /**
...
/**
 * Check if a given object implements the BitsOutRateMetric interface.
 */
export function instanceOfBitsOutRateMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BitsOutRateMetricFromJSON(json: any): BitsOutRateMetric {
    return BitsOutRateMetricFromJSONTyped(json, false);
}

export function BitsOutRateMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): BitsOutRateMetric {
...
export function BitsOutRateMetricToJSON(value?: BitsOutRateMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
