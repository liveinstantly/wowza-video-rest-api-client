...
import type { LiveStreamControlState } from './LiveStreamControlState';
import {
    LiveStreamControlStateFromJSON,
    LiveStreamControlStateFromJSONTyped,
    LiveStreamControlStateToJSON,
} from './LiveStreamControlState';

/**
 * 
 * @export
 * @interface LiveStreamControlResponse
 */
export interface LiveStreamControlResponse {
    /**
     * 
     * @type {LiveStreamControlState}
     * @memberof LiveStreamControlResponse
     */
    liveStream: LiveStreamControlState;
}

/**
 * Check if a given object implements the LiveStreamControlResponse interface.
 */
export function instanceOfLiveStreamControlResponse(value: object): boolean {
    let isInstance = true;
...
export function LiveStreamControlResponseFromJSON(json: any): LiveStreamControlResponse {
    return LiveStreamControlResponseFromJSONTyped(json, false);
}

export function LiveStreamControlResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamControlResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'liveStream': LiveStreamControlStateFromJSON(json['live_stream']),
    };
}

export function LiveStreamControlResponseToJSON(value?: LiveStreamControlResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'live_stream': LiveStreamControlStateToJSON(value.liveStream),
    };
}
