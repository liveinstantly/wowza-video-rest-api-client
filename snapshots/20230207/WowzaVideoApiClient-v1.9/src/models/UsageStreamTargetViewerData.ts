...
import type { UsageViewersDataCurrent } from './UsageViewersDataCurrent';
import {
    UsageViewersDataCurrentFromJSON,
    UsageViewersDataCurrentFromJSONTyped,
    UsageViewersDataCurrentToJSON,
} from './UsageViewersDataCurrent';

/**
 * 
 * @export
 * @interface UsageStreamTargetViewerData
 */
export interface UsageStreamTargetViewerData {
    /**
     * 
     * @type {UsageViewersDataCurrent}
     * @memberof UsageStreamTargetViewerData
     */
    streamTarget?: UsageViewersDataCurrent;
}

/**
 * Check if a given object implements the UsageStreamTargetViewerData interface.
 */
export function instanceOfUsageStreamTargetViewerData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageStreamTargetViewerDataFromJSON(json: any): UsageStreamTargetViewerData {
    return UsageStreamTargetViewerDataFromJSONTyped(json, false);
}

export function UsageStreamTargetViewerDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageStreamTargetViewerData {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTarget': !exists(json, 'stream_target') ? undefined : UsageViewersDataCurrentFromJSON(json['stream_target']),
    };
}

export function UsageStreamTargetViewerDataToJSON(value?: UsageStreamTargetViewerData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target': UsageViewersDataCurrentToJSON(value.streamTarget),
    };
}
