 ...
 * 
 * @export
 * @interface UsageViewersTrendsDetails
 */
export interface UsageViewersTrendsDetails {
    /**
     * The date and time the trend data was sampled.
     * @type {Date}
     * @memberof UsageViewersTrendsDetails
     */
    sampledAt?: Date;
    /**
...
/**
 * Check if a given object implements the UsageViewersTrendsDetails interface.
 */
export function instanceOfUsageViewersTrendsDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersTrendsDetailsFromJSON(json: any): UsageViewersTrendsDetails {
    return UsageViewersTrendsDetailsFromJSONTyped(json, false);
}

export function UsageViewersTrendsDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersTrendsDetails {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'sampledAt': !exists(json, 'sampled_at') ? undefined : (new Date(json['sampled_at'])),
...
export function UsageViewersTrendsDetailsToJSON(value?: UsageViewersTrendsDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'sampled_at': value.sampledAt === undefined ? undefined : (value.sampledAt.toISOString()),
