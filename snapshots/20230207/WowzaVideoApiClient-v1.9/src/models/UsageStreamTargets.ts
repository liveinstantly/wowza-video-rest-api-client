...
import type { UsagePagination } from './UsagePagination';
import {
    UsagePaginationFromJSON,
    UsagePaginationFromJSONTyped,
    UsagePaginationToJSON,
} from './UsagePagination';
import type { UsageViewersDataPerStreamTarget } from './UsageViewersDataPerStreamTarget';
import {
    UsageViewersDataPerStreamTargetFromJSON,
    UsageViewersDataPerStreamTargetFromJSONTyped,
    UsageViewersDataPerStreamTargetToJSON,
} from './UsageViewersDataPerStreamTarget';

/**
 * 
 * @export
 * @interface UsageStreamTargets
 */
export interface UsageStreamTargets {
    /**
     * An array of stream targets and the details of their CDN usage.
     * @type {Array<UsageViewersDataPerStreamTarget>}
     * @memberof UsageStreamTargets
     */
    streamTargets?: Array<UsageViewersDataPerStreamTarget>;
    /**
     * 
...
/**
 * Check if a given object implements the UsageStreamTargets interface.
 */
export function instanceOfUsageStreamTargets(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageStreamTargetsFromJSON(json: any): UsageStreamTargets {
    return UsageStreamTargetsFromJSONTyped(json, false);
}

export function UsageStreamTargetsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageStreamTargets {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargets': !exists(json, 'stream_targets') ? undefined : ((json['stream_targets'] as Array<any>).map(UsageViewersDataPerStreamTargetFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : UsagePaginationFromJSON(json['pagination']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageStreamTargetsToJSON(value?: UsageStreamTargets | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_targets': value.streamTargets === undefined ? undefined : ((value.streamTargets as Array<any>).map(UsageViewersDataPerStreamTargetToJSON)),
        'pagination': UsagePaginationToJSON(value.pagination),
