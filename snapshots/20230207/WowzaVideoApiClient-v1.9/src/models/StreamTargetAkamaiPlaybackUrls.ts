 ...
 * @export
 * @interface StreamTargetAkamaiPlaybackUrls
 */
export interface StreamTargetAkamaiPlaybackUrls {
    /**
     * Web address that the target uses to play HLS streams. Only for targets whose *provider* is **akamai_cupertino**.
     * @type {Array<Hls>}
     * @memberof StreamTargetAkamaiPlaybackUrls
     */
    hls?: Array<Hls>;
    /**
     * Web address that the target uses to play HDS streams.
     * @type {Array<Hds>}
     * @memberof StreamTargetAkamaiPlaybackUrls
     */
    hds?: Array<Hds>;
...
/**
 * Check if a given object implements the StreamTargetAkamaiPlaybackUrls interface.
 */
export function instanceOfStreamTargetAkamaiPlaybackUrls(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetAkamaiPlaybackUrlsFromJSON(json: any): StreamTargetAkamaiPlaybackUrls {
    return StreamTargetAkamaiPlaybackUrlsFromJSONTyped(json, false);
}

export function StreamTargetAkamaiPlaybackUrlsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetAkamaiPlaybackUrls {
...
export function StreamTargetAkamaiPlaybackUrlsToJSON(value?: StreamTargetAkamaiPlaybackUrls | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
