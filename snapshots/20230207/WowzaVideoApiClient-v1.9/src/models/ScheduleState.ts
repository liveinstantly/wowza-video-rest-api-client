 ...
 * @export
 */
export const ScheduleStateStateEnum = {
    Enabled: 'enabled',
    Disabled: 'disabled',
    Expired: 'expired'
} as const;
export type ScheduleStateStateEnum = typeof ScheduleStateStateEnum[keyof typeof ScheduleStateStateEnum];


/**
 * Check if a given object implements the ScheduleState interface.
 */
export function instanceOfScheduleState(value: object): boolean {
    let isInstance = true;
...
export function ScheduleStateToJSON(value?: ScheduleState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
