 ...
 * 
 * @export
 * @interface LiveStreamUpdateInputInner
 */
export interface LiveStreamUpdateInputInner {
    /**
...
**Example:** <code>"aspect_ratio_height": 1080</code>
     * @type {number}
     * @memberof LiveStreamUpdateInputInner
     */
...
**Example:** <code>"encoder": "other_rtmp"</code>
     ...
     * @memberof LiveStreamUpdateInputInner
     */
    encoder?: LiveStreamUpdateInputInnerEncoderEnum;
    /**
...
**Example:** <code>"closed_caption_type": "cea"</code>
     ...
     * @memberof LiveStreamUpdateInputInner
     */
    closedCaptionType?: LiveStreamUpdateInputInnerClosedCaptionTypeEnum;
    /**
...
**Example:** <code>"delivery_method": "pull"</code>
     ...
     * @memberof LiveStreamUpdateInputInner
     */
    deliveryMethod?: LiveStreamUpdateInputInnerDeliveryMethodEnum;
    /**
...
**Example:** <code>"player_logo_position": "top-right"</code>ß
     * @type {string}
     * @memberof LiveStreamUpdateInputInner
     */
    playerLogoPosition?: LiveStreamUpdateInputInnerPlayerLogoPositionEnum;
    /**
...
**Example:** <code>"target_delivery_protocol": "hls-https"</code>
     ...
     * @memberof LiveStreamUpdateInputInner
     */
    targetDeliveryProtocol?: LiveStreamUpdateInputInnerTargetDeliveryProtocolEnum;
    /**
 ...
 * @export
 */
export const LiveStreamUpdateInputInnerEncoderEnum = {
...
export type LiveStreamUpdateInputInnerEncoderEnum = typeof LiveStreamUpdateInputInnerEncoderEnum[keyof typeof LiveStreamUpdateInputInnerEncoderEnum];

/**
 * @export
 */
export const LiveStreamUpdateInputInnerClosedCaptionTypeEnum = {
    None: 'none',
    Cea: 'cea',
    OnText: 'on_text',
    Both: 'both'
} as const;
export type LiveStreamUpdateInputInnerClosedCaptionTypeEnum = typeof LiveStreamUpdateInputInnerClosedCaptionTypeEnum[keyof typeof LiveStreamUpdateInputInnerClosedCaptionTypeEnum];

/**
 * @export
 */
export const LiveStreamUpdateInputInnerDeliveryMethodEnum = {
    Pull: 'pull',
    Cdn: 'cdn',
    Push: 'push'
} as const;
export type LiveStreamUpdateInputInnerDeliveryMethodEnum = typeof LiveStreamUpdateInputInnerDeliveryMethodEnum[keyof typeof LiveStreamUpdateInputInnerDeliveryMethodEnum];

/**
 * @export
 */
export const LiveStreamUpdateInputInnerPlayerLogoPositionEnum = {
    TopLeft: 'top-left',
    TopRight: 'top-right',
    BottomLeft: 'bottom-left',
    BottomRight: 'bottom-right'
} as const;
export type LiveStreamUpdateInputInnerPlayerLogoPositionEnum = typeof LiveStreamUpdateInputInnerPlayerLogoPositionEnum[keyof typeof LiveStreamUpdateInputInnerPlayerLogoPositionEnum];

/**
 * @export
 */
export const LiveStreamUpdateInputInnerTargetDeliveryProtocolEnum = {
    HlsHttps: 'hls-https'
} as const;
export type LiveStreamUpdateInputInnerTargetDeliveryProtocolEnum = typeof LiveStreamUpdateInputInnerTargetDeliveryProtocolEnum[keyof typeof LiveStreamUpdateInputInnerTargetDeliveryProtocolEnum];


/**
 * Check if a given object implements the LiveStreamUpdateInputInner interface.
 */
export function instanceOfLiveStreamUpdateInputInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LiveStreamUpdateInputInnerFromJSON(json: any): LiveStreamUpdateInputInner {
    return LiveStreamUpdateInputInnerFromJSONTyped(json, false);
}

export function LiveStreamUpdateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamUpdateInputInner {
...
export function LiveStreamUpdateInputInnerToJSON(value?: LiveStreamUpdateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
