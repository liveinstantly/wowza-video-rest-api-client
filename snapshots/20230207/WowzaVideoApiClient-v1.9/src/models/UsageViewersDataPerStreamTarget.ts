 ...
 * 
 * @export
 * @interface UsageViewersDataPerStreamTarget
 */
export interface UsageViewersDataPerStreamTarget {
    /**
     * The unique alphanumeric string that identifies the stream target.
     * @type {string}
     * @memberof UsageViewersDataPerStreamTarget
     */
    id?: string;
    /**
     ...
     * @memberof UsageViewersDataPerStreamTarget
     */
    type?: UsageViewersDataPerStreamTargetTypeEnum;
    /**
 ...
 * @export
 */
export const UsageViewersDataPerStreamTargetTypeEnum = {
    Fastly: 'fastly'
} as const;
export type UsageViewersDataPerStreamTargetTypeEnum = typeof UsageViewersDataPerStreamTargetTypeEnum[keyof typeof UsageViewersDataPerStreamTargetTypeEnum];


/**
 * Check if a given object implements the UsageViewersDataPerStreamTarget interface.
 */
export function instanceOfUsageViewersDataPerStreamTarget(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataPerStreamTargetFromJSON(json: any): UsageViewersDataPerStreamTarget {
    return UsageViewersDataPerStreamTargetFromJSONTyped(json, false);
}

export function UsageViewersDataPerStreamTargetFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataPerStreamTarget {
...
export function UsageViewersDataPerStreamTargetToJSON(value?: UsageViewersDataPerStreamTarget | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
