...
import type { AssetCreateInputInnner } from './AssetCreateInputInnner';
import {
    AssetCreateInputInnnerFromJSON,
    AssetCreateInputInnnerFromJSONTyped,
    AssetCreateInputInnnerToJSON,
} from './AssetCreateInputInnner';
...
export interface AssetCreateInput {
    /**
     * 
     * @type {AssetCreateInputInnner}
     * @memberof AssetCreateInput
     */
    asset?: AssetCreateInputInnner;
}

/**
 * Check if a given object implements the AssetCreateInput interface.
 */
export function instanceOfAssetCreateInput(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AssetCreateInputFromJSON(json: any): AssetCreateInput {
    return AssetCreateInputFromJSONTyped(json, false);
}

export function AssetCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetCreateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'asset': !exists(json, 'asset') ? undefined : AssetCreateInputInnnerFromJSON(json['asset']),
    };
}

export function AssetCreateInputToJSON(value?: AssetCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'asset': AssetCreateInputInnnerToJSON(value.asset),
    };
}
