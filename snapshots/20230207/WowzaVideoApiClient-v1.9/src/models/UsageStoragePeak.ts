 ...
 * 
 * @export
 * @interface UsageStoragePeak
 */
export interface UsageStoragePeak {
    /**
...
/**
 * Check if a given object implements the UsageStoragePeak interface.
 */
export function instanceOfUsageStoragePeak(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageStoragePeakFromJSON(json: any): UsageStoragePeak {
    return UsageStoragePeakFromJSONTyped(json, false);
}

export function UsageStoragePeakFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageStoragePeak {
...
export function UsageStoragePeakToJSON(value?: UsageStoragePeak | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
