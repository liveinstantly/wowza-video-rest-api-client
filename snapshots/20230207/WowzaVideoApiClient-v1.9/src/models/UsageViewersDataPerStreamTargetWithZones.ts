...
import type { UsageViewersZone } from './UsageViewersZone';
import {
    UsageViewersZoneFromJSON,
    UsageViewersZoneFromJSONTyped,
    UsageViewersZoneToJSON,
} from './UsageViewersZone';

/**
 * 
 * @export
 * @interface UsageViewersDataPerStreamTargetWithZones
 */
export interface UsageViewersDataPerStreamTargetWithZones {
    /**
     * The unique alphanumeric string that identifies the stream target.
     * @type {string}
     * @memberof UsageViewersDataPerStreamTargetWithZones
     */
    id?: string;
    /**
    ...
    name?: string;
    /**
     * A value of **true** indicates that the stream target has been removed from Wowza Video.
     * @type {boolean}
     * @memberof UsageViewersDataPerStreamTargetWithZones
     */
    archived?: boolean;
    /**
     * The type of stream target. <br/> **fastly** is a Wowza CDN on Fastly target.
     * @type {string}
     * @memberof UsageViewersDataPerStreamTargetWithZones
     */
    type?: UsageViewersDataPerStreamTargetWithZonesTypeEnum;
    /**
    ...
    viewingBytes?: number;
    /**
     * A array of zones with CDN usage, keyed by the name of the billing zone where the usage was generated.
     * @type {Array<UsageViewersZone>}
     * @memberof UsageViewersDataPerStreamTargetWithZones
     */
    zones?: Array<UsageViewersZone>;
}
 ...
 * @export
 */
export const UsageViewersDataPerStreamTargetWithZonesTypeEnum = {
    Fastly: 'fastly'
} as const;
export type UsageViewersDataPerStreamTargetWithZonesTypeEnum = typeof UsageViewersDataPerStreamTargetWithZonesTypeEnum[keyof typeof UsageViewersDataPerStreamTargetWithZonesTypeEnum];


/**
 * Check if a given object implements the UsageViewersDataPerStreamTargetWithZones interface.
 */
export function instanceOfUsageViewersDataPerStreamTargetWithZones(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataPerStreamTargetWithZonesFromJSON(json: any): UsageViewersDataPerStreamTargetWithZones {
    return UsageViewersDataPerStreamTargetWithZonesFromJSONTyped(json, false);
}

export function UsageViewersDataPerStreamTargetWithZonesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataPerStreamTargetWithZones {
    ...
    return {
        ...
        'zones': !exists(json, 'zones') ? undefined : ((json['zones'] as Array<any>).map(UsageViewersZoneFromJSON)),
    };
}

export function UsageViewersDataPerStreamTargetWithZonesToJSON(value?: UsageViewersDataPerStreamTargetWithZones | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'zones': value.zones === undefined ? undefined : ((value.zones as Array<any>).map(UsageViewersZoneToJSON)),
    };
}
