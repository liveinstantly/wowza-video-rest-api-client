 ...
 */
export interface TranscoderStatsResponse {
    /**
     * 
     * @type {ShmMetrics}
     * @memberof TranscoderStatsResponse
     */
    transcoder: ShmMetrics;
}

/**
 * Check if a given object implements the TranscoderStatsResponse interface.
 */
export function instanceOfTranscoderStatsResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderStatsResponseFromJSON(json: any): TranscoderStatsResponse {
    return TranscoderStatsResponseFromJSONTyped(json, false);
}

export function TranscoderStatsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderStatsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': ShmMetricsFromJSON(json['transcoder']),
    };
}

export function TranscoderStatsResponseToJSON(value?: TranscoderStatsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': ShmMetricsToJSON(value.transcoder),
    };
}
