...
import type { UsageViewersDataByRenditionWithZones } from './UsageViewersDataByRenditionWithZones';
import {
    UsageViewersDataByRenditionWithZonesFromJSON,
    UsageViewersDataByRenditionWithZonesFromJSONTyped,
    UsageViewersDataByRenditionWithZonesToJSON,
} from './UsageViewersDataByRenditionWithZones';

/**
 * 
 * @export
 * @interface UsageStreamTargetRenditions
 */
export interface UsageStreamTargetRenditions {
    /**
     * An array of viewer renditions.
     * @type {Array<UsageViewersDataByRenditionWithZones>}
     * @memberof UsageStreamTargetRenditions
     */
    renditions?: Array<UsageViewersDataByRenditionWithZones>;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageStreamTargetRenditions
...
/**
 * Check if a given object implements the UsageStreamTargetRenditions interface.
 */
export function instanceOfUsageStreamTargetRenditions(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageStreamTargetRenditionsFromJSON(json: any): UsageStreamTargetRenditions {
    return UsageStreamTargetRenditionsFromJSONTyped(json, false);
}

export function UsageStreamTargetRenditionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageStreamTargetRenditions {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'renditions': !exists(json, 'renditions') ? undefined : ((json['renditions'] as Array<any>).map(UsageViewersDataByRenditionWithZonesFromJSON)),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageStreamTargetRenditionsToJSON(value?: UsageStreamTargetRenditions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'renditions': value.renditions === undefined ? undefined : ((value.renditions as Array<any>).map(UsageViewersDataByRenditionWithZonesToJSON)),
