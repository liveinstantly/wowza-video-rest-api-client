 ...
 * 
 * @export
 * @interface PlayerRebuildState
 */
export interface PlayerRebuildState {
    /**
     * The state of the player.
     * @type {string}
     * @memberof PlayerRebuildState
     */
    state?: PlayerRebuildStateStateEnum;
}
 ...
 * @export
 */
export const PlayerRebuildStateStateEnum = {
    Requested: 'requested',
    AlreadyRequested: 'already_requested',
    Activated: 'activated'
} as const;
export type PlayerRebuildStateStateEnum = typeof PlayerRebuildStateStateEnum[keyof typeof PlayerRebuildStateStateEnum];


/**
 * Check if a given object implements the PlayerRebuildState interface.
 */
export function instanceOfPlayerRebuildState(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PlayerRebuildStateFromJSON(json: any): PlayerRebuildState {
    return PlayerRebuildStateFromJSONTyped(json, false);
}

export function PlayerRebuildStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerRebuildState {
...
export function PlayerRebuildStateToJSON(value?: PlayerRebuildState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
