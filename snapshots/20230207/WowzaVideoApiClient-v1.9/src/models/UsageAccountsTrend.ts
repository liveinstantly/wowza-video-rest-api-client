...
import type { UsageViewersTrendsDetails } from './UsageViewersTrendsDetails';
import {
    UsageViewersTrendsDetailsFromJSON,
    UsageViewersTrendsDetailsFromJSONTyped,
    UsageViewersTrendsDetailsToJSON,
} from './UsageViewersTrendsDetails';

/**
 * 
 * @export
 * @interface UsageAccountsTrend
 */
export interface UsageAccountsTrend {
    /**
     * An array of viewer trend data.
     * @type {Array<UsageViewersTrendsDetails>}
     * @memberof UsageAccountsTrend
     */
    trend?: Array<UsageViewersTrendsDetails>;
    /**
     * 
...
/**
 * Check if a given object implements the UsageAccountsTrend interface.
 */
export function instanceOfUsageAccountsTrend(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageAccountsTrendFromJSON(json: any): UsageAccountsTrend {
    return UsageAccountsTrendFromJSONTyped(json, false);
}

export function UsageAccountsTrendFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageAccountsTrend {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'trend': !exists(json, 'trend') ? undefined : ((json['trend'] as Array<any>).map(UsageViewersTrendsDetailsFromJSON)),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsWithResourcesFromJSON(json['limits']),
    };
}

export function UsageAccountsTrendToJSON(value?: UsageAccountsTrend | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'trend': value.trend === undefined ? undefined : ((value.trend as Array<any>).map(UsageViewersTrendsDetailsToJSON)),
