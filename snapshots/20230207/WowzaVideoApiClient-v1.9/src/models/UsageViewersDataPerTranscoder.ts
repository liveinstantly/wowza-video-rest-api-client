 ...
 * 
 * @export
 * @interface UsageViewersDataPerTranscoder
 */
export interface UsageViewersDataPerTranscoder {
    /**
     * The unique alphanumeric string that identifies the transcoder.
     * @type {number}
     * @memberof UsageViewersDataPerTranscoder
     */
    id?: number;
    /**
     * A descriptive name for the transcoder.
     * @type {string}
     * @memberof UsageViewersDataPerTranscoder
     */
    name?: string;
    /**
     * A value of **true** indicates that the transcoder has been removed from Wowza Video.
     * @type {boolean}
     * @memberof UsageViewersDataPerTranscoder
     */
    archived?: boolean;
     ...
     * @memberof UsageViewersDataPerTranscoder
     */
    billingMode?: UsageViewersDataPerTranscoderBillingModeEnum;
    /**
     * The type of transcoder. The default is **transcoded**.
     * @type {string}
     * @memberof UsageViewersDataPerTranscoder
     */
    transcoderType?: UsageViewersDataPerTranscoderTranscoderTypeEnum;
    /**
     * The amount of content, in bytes, that went through the transcoder during the selected time frame.
     * @type {number}
     * @memberof UsageViewersDataPerTranscoder
     */
    egressBytes?: number;
    /**
     * The amount of time, in seconds, that it took for the stream to be processed.
     * @type {number}
     * @memberof UsageViewersDataPerTranscoder
     */
    egressSeconds?: number;
    /**
     * The length of time, in seconds, that additional stream targets pulled from storage during the selected time frame. Subscriptions prices include egress for one target; additional targets incur additional charges.
     * @type {number}
     * @memberof UsageViewersDataPerTranscoder
     */
    egressSecondsAdditionalTargets?: number;
    /**
 ...
 * @export
 */
export const UsageViewersDataPerTranscoderBillingModeEnum = {
    PayAsYouGo: 'pay_as_you_go',
    TwentyfourSeven: 'twentyfour_seven'
} as const;
export type UsageViewersDataPerTranscoderBillingModeEnum = typeof UsageViewersDataPerTranscoderBillingModeEnum[keyof typeof UsageViewersDataPerTranscoderBillingModeEnum];

/**
 * @export
 */
export const UsageViewersDataPerTranscoderTranscoderTypeEnum = {
    Transcoded: 'transcoded',
    Passthrough: 'passthrough'
} as const;
export type UsageViewersDataPerTranscoderTranscoderTypeEnum = typeof UsageViewersDataPerTranscoderTranscoderTypeEnum[keyof typeof UsageViewersDataPerTranscoderTranscoderTypeEnum];


/**
 * Check if a given object implements the UsageViewersDataPerTranscoder interface.
 */
export function instanceOfUsageViewersDataPerTranscoder(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataPerTranscoderFromJSON(json: any): UsageViewersDataPerTranscoder {
    return UsageViewersDataPerTranscoderFromJSONTyped(json, false);
}

export function UsageViewersDataPerTranscoderFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataPerTranscoder {
    ...
    return {
        ...
        'egressSeconds': !exists(json, 'egress_seconds') ? undefined : json['egress_seconds'],
        'egressSecondsAdditionalTargets': !exists(json, 'egress_seconds_additional_targets') ? undefined : json['egress_seconds_additional_targets'],
        'uniqueViewers': !exists(json, 'unique_viewers') ? undefined : json['unique_viewers'],
        'viewingSeconds': !exists(json, 'viewing_seconds') ? undefined : json['viewing_seconds'],
        'viewingBytes': !exists(json, 'viewing_bytes') ? undefined : json['viewing_bytes'],
        'avgViewingSeconds': !exists(json, 'avg_viewing_seconds') ? undefined : json['avg_viewing_seconds'],
    };
}

export function UsageViewersDataPerTranscoderToJSON(value?: UsageViewersDataPerTranscoder | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'egress_seconds': value.egressSeconds,
        'egress_seconds_additional_targets': value.egressSecondsAdditionalTargets,
        'unique_viewers': value.uniqueViewers,
        'viewing_seconds': value.viewingSeconds,
        'viewing_bytes': value.viewingBytes,
        'avg_viewing_seconds': value.avgViewingSeconds,
    };
}
