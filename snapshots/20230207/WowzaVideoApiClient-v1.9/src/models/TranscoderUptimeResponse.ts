 ...
 * 
 * @export
 * @interface TranscoderUptimeResponse
 */
export interface TranscoderUptimeResponse {
    /**
     * 
     * @type {Uptime}
     * @memberof TranscoderUptimeResponse
     */
    uptime: Uptime;
}

/**
 * Check if a given object implements the TranscoderUptimeResponse interface.
 */
export function instanceOfTranscoderUptimeResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderUptimeResponseFromJSON(json: any): TranscoderUptimeResponse {
    return TranscoderUptimeResponseFromJSONTyped(json, false);
}

export function TranscoderUptimeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderUptimeResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'uptime': UptimeFromJSON(json['uptime']),
    };
}

export function TranscoderUptimeResponseToJSON(value?: TranscoderUptimeResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'uptime': UptimeToJSON(value.uptime),
    };
}
