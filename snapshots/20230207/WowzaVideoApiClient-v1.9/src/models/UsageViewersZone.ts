 ...
 * 
 * @export
 * @interface UsageViewersZone
 */
export interface UsageViewersZone {
    /**
     * The name of the billing zone where the usage was generated.
     * @type {string}
     * @memberof UsageViewersZone
     */
    name?: string;
    /**
 ...
 * @export
 */
export const UsageViewersZoneTypeEnum = {
    Fastly: 'fastly'
} as const;
export type UsageViewersZoneTypeEnum = typeof UsageViewersZoneTypeEnum[keyof typeof UsageViewersZoneTypeEnum];


/**
 * Check if a given object implements the UsageViewersZone interface.
 */
export function instanceOfUsageViewersZone(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersZoneFromJSON(json: any): UsageViewersZone {
    return UsageViewersZoneFromJSONTyped(json, false);
}

export function UsageViewersZoneFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersZone {
...
export function UsageViewersZoneToJSON(value?: UsageViewersZone | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
