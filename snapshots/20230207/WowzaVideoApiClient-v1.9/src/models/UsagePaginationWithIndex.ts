 ...
 * @export
 * @interface UsagePaginationWithIndex
 */
export interface UsagePaginationWithIndex {
    /**
     * The pagination object version.
     * @type {number}
     * @memberof UsagePaginationWithIndex
     */
    ...
    page?: number;
    /**
     * The number of records included on each page of results.
     * @type {number}
     * @memberof UsagePaginationWithIndex
     */
    perPage?: number;
    /**
     * The total number of pages generated by the query.
     * @type {number}
     * @memberof UsagePaginationWithIndex
     */
    totalPages?: number;
    /**
     * The 0-based index of the first record on the page returned.
     * @type {number}
     * @memberof UsagePaginationWithIndex
     */
    pageFirstIndex?: number;
    /**
     * The 0-based index of the last record on the page returned.
     * @type {number}
     * @memberof UsagePaginationWithIndex
     */
...
/**
 * Check if a given object implements the UsagePaginationWithIndex interface.
 */
export function instanceOfUsagePaginationWithIndex(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsagePaginationWithIndexFromJSON(json: any): UsagePaginationWithIndex {
    return UsagePaginationWithIndexFromJSONTyped(json, false);
}

export function UsagePaginationWithIndexFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsagePaginationWithIndex {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'payloadVersion': !exists(json, 'payload_version') ? undefined : json['payload_version'],
        ...
        'pageFirstIndex': !exists(json, 'page_first_index') ? undefined : json['page_first_index'],
        'pageLastIndex': !exists(json, 'page_last_index') ? undefined : json['page_last_index'],
    };
}

export function UsagePaginationWithIndexToJSON(value?: UsagePaginationWithIndex | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'page_first_index': value.pageFirstIndex,
        'page_last_index': value.pageLastIndex,
    };
}
