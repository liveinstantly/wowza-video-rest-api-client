...
import type { IndexStreamTargetAkamai } from './IndexStreamTargetAkamai';
import {
    IndexStreamTargetAkamaiFromJSON,
    IndexStreamTargetAkamaiFromJSONTyped,
    IndexStreamTargetAkamaiToJSON,
} from './IndexStreamTargetAkamai';

/**
 * 
 * @export
 * @interface StreamTargetsAkamai
 */
export interface StreamTargetsAkamai {
    /**
     * 
     * @type {Array<IndexStreamTargetAkamai>}
     * @memberof StreamTargetsAkamai
     */
    streamTargetsAkamai: Array<IndexStreamTargetAkamai>;
}

/**
 * Check if a given object implements the StreamTargetsAkamai interface.
 */
export function instanceOfStreamTargetsAkamai(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamTargetsAkamai" in value;

    return isInstance;
}

export function StreamTargetsAkamaiFromJSON(json: any): StreamTargetsAkamai {
    return StreamTargetsAkamaiFromJSONTyped(json, false);
}

export function StreamTargetsAkamaiFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetsAkamai {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetsAkamai': ((json['stream_targets_akamai'] as Array<any>).map(IndexStreamTargetAkamaiFromJSON)),
    };
}

export function StreamTargetsAkamaiToJSON(value?: StreamTargetsAkamai | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_targets_akamai': ((value.streamTargetsAkamai as Array<any>).map(IndexStreamTargetAkamaiToJSON)),
    };
}
