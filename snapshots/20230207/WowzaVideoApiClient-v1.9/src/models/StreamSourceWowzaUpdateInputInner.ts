 ...
 * 
 * @export
 * @interface StreamSourceWowzaUpdateInputInner
 */
export interface StreamSourceWowzaUpdateInputInner {
    /**
     * A descriptive name for the Wowza stream source. Maximum 255 characters.
     * @type {string}
     * @memberof StreamSourceWowzaUpdateInputInner
     */
    name: string;
}

/**
 * Check if a given object implements the StreamSourceWowzaUpdateInputInner interface.
 */
export function instanceOfStreamSourceWowzaUpdateInputInner(value: object): boolean {
    let isInstance = true;
...
export function StreamSourceWowzaUpdateInputInnerFromJSON(json: any): StreamSourceWowzaUpdateInputInner {
    return StreamSourceWowzaUpdateInputInnerFromJSONTyped(json, false);
}

export function StreamSourceWowzaUpdateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamSourceWowzaUpdateInputInner {
...
export function StreamSourceWowzaUpdateInputInnerToJSON(value?: StreamSourceWowzaUpdateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
