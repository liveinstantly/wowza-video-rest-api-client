 ...
 * 
 * @export
 * @interface UsageVodStreamCountries
 */
export interface UsageVodStreamCountries {
    /**
     * An array of viewer countries.
     * @type {Array<UsageViewersDataByCountry>}
     * @memberof UsageVodStreamCountries
     */
...
/**
 * Check if a given object implements the UsageVodStreamCountries interface.
 */
export function instanceOfUsageVodStreamCountries(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamCountriesFromJSON(json: any): UsageVodStreamCountries {
    return UsageVodStreamCountriesFromJSONTyped(json, false);
}

export function UsageVodStreamCountriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamCountries {
...
export function UsageVodStreamCountriesToJSON(value?: UsageVodStreamCountries | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
