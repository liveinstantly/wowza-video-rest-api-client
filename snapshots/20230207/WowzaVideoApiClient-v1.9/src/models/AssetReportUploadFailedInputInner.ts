 ...
 * 
 * @export
 * @interface AssetReportUploadFailedInputInner
 */
export interface AssetReportUploadFailedInputInner {
    /**
     * A description of why the upload failed.
     * @type {string}
     * @memberof AssetReportUploadFailedInputInner
     */
    reason: string;
    /**
...
/**
 * Check if a given object implements the AssetReportUploadFailedInputInner interface.
 */
export function instanceOfAssetReportUploadFailedInputInner(value: object): boolean {
    let isInstance = true;
...
export function AssetReportUploadFailedInputInnerFromJSON(json: any): AssetReportUploadFailedInputInner {
    return AssetReportUploadFailedInputInnerFromJSONTyped(json, false);
}

export function AssetReportUploadFailedInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetReportUploadFailedInputInner {
...
export function AssetReportUploadFailedInputInnerToJSON(value?: AssetReportUploadFailedInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
