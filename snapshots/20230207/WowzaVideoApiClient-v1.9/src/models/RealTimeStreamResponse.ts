...
import type { RealTimeStream } from './RealTimeStream';
import {
    RealTimeStreamFromJSON,
    RealTimeStreamFromJSONTyped,
    RealTimeStreamToJSON,
} from './RealTimeStream';

/**
 * 
 * @export
 * @interface RealTimeStreamResponse
 */
export interface RealTimeStreamResponse {
    /**
     * 
     * @type {RealTimeStream}
     * @memberof RealTimeStreamResponse
     */
    realTimeStream: RealTimeStream;
}

/**
 * Check if a given object implements the RealTimeStreamResponse interface.
 */
export function instanceOfRealTimeStreamResponse(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "realTimeStream" in value;

    return isInstance;
}

export function RealTimeStreamResponseFromJSON(json: any): RealTimeStreamResponse {
    return RealTimeStreamResponseFromJSONTyped(json, false);
}

export function RealTimeStreamResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RealTimeStreamResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'realTimeStream': RealTimeStreamFromJSON(json['real_time_stream']),
    };
}

export function RealTimeStreamResponseToJSON(value?: RealTimeStreamResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'real_time_stream': RealTimeStreamToJSON(value.realTimeStream),
    };
}
