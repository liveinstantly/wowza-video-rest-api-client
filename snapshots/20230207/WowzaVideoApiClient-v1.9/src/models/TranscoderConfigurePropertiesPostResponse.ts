 ...
 * 
 * @export
 * @interface TranscoderConfigurePropertiesPostResponse
 */
export interface TranscoderConfigurePropertiesPostResponse {
    /**
     * An array of properties.
     * @type {Array<TranscoderProperty>}
     * @memberof TranscoderConfigurePropertiesPostResponse
     */
    properties?: Array<TranscoderProperty>;
}

/**
 * Check if a given object implements the TranscoderConfigurePropertiesPostResponse interface.
 */
export function instanceOfTranscoderConfigurePropertiesPostResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranscoderConfigurePropertiesPostResponseFromJSON(json: any): TranscoderConfigurePropertiesPostResponse {
    return TranscoderConfigurePropertiesPostResponseFromJSONTyped(json, false);
}

export function TranscoderConfigurePropertiesPostResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderConfigurePropertiesPostResponse {
...
export function TranscoderConfigurePropertiesPostResponseToJSON(value?: TranscoderConfigurePropertiesPostResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
