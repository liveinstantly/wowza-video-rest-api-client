 ...
 * @export
 * @interface TranscoderRecordingStateRecording
 */
export interface TranscoderRecordingStateRecording {
    /**
     * The state of video capture for the transcoder.
     * @type {string}
     * @memberof TranscoderRecordingStateRecording
     */
    state?: TranscoderRecordingStateRecordingStateEnum;
}
 ...
 * @export
 */
export const TranscoderRecordingStateRecordingStateEnum = {
    Started: 'started',
    Stopped: 'stopped'
} as const;
export type TranscoderRecordingStateRecordingStateEnum = typeof TranscoderRecordingStateRecordingStateEnum[keyof typeof TranscoderRecordingStateRecordingStateEnum];


/**
 * Check if a given object implements the TranscoderRecordingStateRecording interface.
 */
export function instanceOfTranscoderRecordingStateRecording(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranscoderRecordingStateRecordingFromJSON(json: any): TranscoderRecordingStateRecording {
    return TranscoderRecordingStateRecordingFromJSONTyped(json, false);
}

export function TranscoderRecordingStateRecordingFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderRecordingStateRecording {
...
export function TranscoderRecordingStateRecordingToJSON(value?: TranscoderRecordingStateRecording | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
