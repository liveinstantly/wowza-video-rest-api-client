...
import type { UsageRealTimeStreamData } from './UsageRealTimeStreamData';
import {
    UsageRealTimeStreamDataFromJSON,
    UsageRealTimeStreamDataFromJSONTyped,
    UsageRealTimeStreamDataToJSON,
} from './UsageRealTimeStreamData';

/**
 * 
 * @export
 * @interface UsageRealTimeStreams
 */
export interface UsageRealTimeStreams {
    /**
     * An array of real time streams and the details of their CDN usage.
     * @type {Array<UsageRealTimeStreamData>}
     * @memberof UsageRealTimeStreams
     */
    realTimeStreams?: Array<UsageRealTimeStreamData>;
    /**
     * 
...
/**
 * Check if a given object implements the UsageRealTimeStreams interface.
 */
export function instanceOfUsageRealTimeStreams(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageRealTimeStreamsFromJSON(json: any): UsageRealTimeStreams {
    return UsageRealTimeStreamsFromJSONTyped(json, false);
}

export function UsageRealTimeStreamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageRealTimeStreams {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'realTimeStreams': !exists(json, 'real_time_streams') ? undefined : ((json['real_time_streams'] as Array<any>).map(UsageRealTimeStreamDataFromJSON)),
...
export function UsageRealTimeStreamsToJSON(value?: UsageRealTimeStreams | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'real_time_streams': value.realTimeStreams === undefined ? undefined : ((value.realTimeStreams as Array<any>).map(UsageRealTimeStreamDataToJSON)),
