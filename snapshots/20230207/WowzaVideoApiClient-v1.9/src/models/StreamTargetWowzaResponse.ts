...
import type { StreamTargetAkamai } from './StreamTargetAkamai';
import {
    StreamTargetAkamaiFromJSON,
    StreamTargetAkamaiFromJSONTyped,
    StreamTargetAkamaiToJSON,
} from './StreamTargetAkamai';

/**
 * 
 * @export
 * @interface StreamTargetWowzaResponse
 */
export interface StreamTargetWowzaResponse {
    /**
     * 
     * @type {StreamTargetAkamai}
     * @memberof StreamTargetWowzaResponse
     */
    streamTargetAkamai: StreamTargetAkamai;
}

/**
 * Check if a given object implements the StreamTargetWowzaResponse interface.
 */
export function instanceOfStreamTargetWowzaResponse(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetWowzaResponseFromJSON(json: any): StreamTargetWowzaResponse {
    return StreamTargetWowzaResponseFromJSONTyped(json, false);
}

export function StreamTargetWowzaResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetWowzaResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetAkamai': StreamTargetAkamaiFromJSON(json['stream_target_akamai']),
    };
}

export function StreamTargetWowzaResponseToJSON(value?: StreamTargetWowzaResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target_akamai': StreamTargetAkamaiToJSON(value.streamTargetAkamai),
    };
}
