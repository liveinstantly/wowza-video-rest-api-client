...
import type { ShmMetrics } from './ShmMetrics';
import {
    ShmMetricsFromJSON,
    ShmMetricsFromJSONTyped,
    ShmMetricsToJSON,
} from './ShmMetrics';
 ...
 * 
 * @export
 * @interface TranscoderUptimeMetricsCurrentResponse
 */
export interface TranscoderUptimeMetricsCurrentResponse {
    /**
     * 
     * @type {ShmMetrics}
     * @memberof TranscoderUptimeMetricsCurrentResponse
     */
    current: ShmMetrics;
    /**
     * 
...
/**
 * Check if a given object implements the TranscoderUptimeMetricsCurrentResponse interface.
 */
export function instanceOfTranscoderUptimeMetricsCurrentResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderUptimeMetricsCurrentResponseFromJSON(json: any): TranscoderUptimeMetricsCurrentResponse {
    return TranscoderUptimeMetricsCurrentResponseFromJSONTyped(json, false);
}

export function TranscoderUptimeMetricsCurrentResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderUptimeMetricsCurrentResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'current': ShmMetricsFromJSON(json['current']),
        'limits': LimitsFromJSON(json['limits']),
    };
}

export function TranscoderUptimeMetricsCurrentResponseToJSON(value?: TranscoderUptimeMetricsCurrentResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'current': ShmMetricsToJSON(value.current),
