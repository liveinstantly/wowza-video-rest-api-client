...
import type { TranscoderCreateInputInner } from './TranscoderCreateInputInner';
import {
    TranscoderCreateInputInnerFromJSON,
    TranscoderCreateInputInnerFromJSONTyped,
    TranscoderCreateInputInnerToJSON,
} from './TranscoderCreateInputInner';

/**
 * 
 * @export
 * @interface TranscoderCreateInput
 */
export interface TranscoderCreateInput {
    /**
     * 
     * @type {TranscoderCreateInputInner}
     * @memberof TranscoderCreateInput
     */
    transcoder: TranscoderCreateInputInner;
}

/**
 * Check if a given object implements the TranscoderCreateInput interface.
 */
export function instanceOfTranscoderCreateInput(value: object): boolean {
    let isInstance = true;
...
export function TranscoderCreateInputFromJSON(json: any): TranscoderCreateInput {
    return TranscoderCreateInputFromJSONTyped(json, false);
}

export function TranscoderCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderCreateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': TranscoderCreateInputInnerFromJSON(json['transcoder']),
    };
}

export function TranscoderCreateInputToJSON(value?: TranscoderCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': TranscoderCreateInputInnerToJSON(value.transcoder),
    };
}
