...
import type { AssetUpdateOutput } from './AssetUpdateOutput';
import {
    AssetUpdateOutputFromJSON,
    AssetUpdateOutputFromJSONTyped,
    AssetUpdateOutputToJSON,
} from './AssetUpdateOutput';
...
export interface AssetUpdateResponse {
    /**
     * 
     * @type {AssetUpdateOutput}
     * @memberof AssetUpdateResponse
     */
    asset: AssetUpdateOutput;
}

/**
 * Check if a given object implements the AssetUpdateResponse interface.
 */
export function instanceOfAssetUpdateResponse(value: object): boolean {
    let isInstance = true;
...
export function AssetUpdateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetUpdateResponse {
    ...
    return {
        ...
        'asset': AssetUpdateOutputFromJSON(json['asset']),
    };
}

export function AssetUpdateResponseToJSON(value?: AssetUpdateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'asset': AssetUpdateOutputToJSON(value.asset),
    };
}
