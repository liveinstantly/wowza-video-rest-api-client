 ...
 * 
 * @export
 * @interface BytesOutRateMetric
 */
export interface BytesOutRateMetric {
    /**
...
/**
 * Check if a given object implements the BytesOutRateMetric interface.
 */
export function instanceOfBytesOutRateMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BytesOutRateMetricFromJSON(json: any): BytesOutRateMetric {
    return BytesOutRateMetricFromJSONTyped(json, false);
}

export function BytesOutRateMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): BytesOutRateMetric {
...
export function BytesOutRateMetricToJSON(value?: BytesOutRateMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
