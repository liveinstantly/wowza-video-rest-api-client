 ...
 * 
 * @export
 * @interface WidthMetric
 */
export interface WidthMetric {
    /**
...
/**
 * Check if a given object implements the WidthMetric interface.
 */
export function instanceOfWidthMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function WidthMetricFromJSON(json: any): WidthMetric {
    return WidthMetricFromJSONTyped(json, false);
}

export function WidthMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidthMetric {
...
export function WidthMetricToJSON(value?: WidthMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
