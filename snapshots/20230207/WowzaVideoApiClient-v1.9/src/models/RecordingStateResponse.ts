...
import {
    RecordingStateFromJSON,
    RecordingStateFromJSONTyped,
    RecordingStateToJSON,
} from './RecordingState';
...
export interface RecordingStateResponse {
     ...
     * 
     * @type {RecordingState}
     * @memberof RecordingStateResponse
     */
    recording: RecordingState;
}

/**
 * Check if a given object implements the RecordingStateResponse interface.
 */
export function instanceOfRecordingStateResponse(value: object): boolean {
    let isInstance = true;
...
export function RecordingStateResponseFromJSON(json: any): RecordingStateResponse {
    return RecordingStateResponseFromJSONTyped(json, false);
}

export function RecordingStateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecordingStateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'recording': RecordingStateFromJSON(json['recording']),
    };
}

export function RecordingStateResponseToJSON(value?: RecordingStateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'recording': RecordingStateToJSON(value.recording),
    };
}
