...
export interface LiveStreamState {
     ...
     * @memberof LiveStreamState
     */
    state?: LiveStreamStateStateEnum;
}
 ...
 * @export
 */
export const LiveStreamStateStateEnum = {
    Started: 'started',
    Stopped: 'stopped',
    Starting: 'starting',
    Stopping: 'stopping',
...
export type LiveStreamStateStateEnum = typeof LiveStreamStateStateEnum[keyof typeof LiveStreamStateStateEnum];


/**
 * Check if a given object implements the LiveStreamState interface.
 */
export function instanceOfLiveStreamState(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LiveStreamStateFromJSON(json: any): LiveStreamState {
    return LiveStreamStateFromJSONTyped(json, false);
}

export function LiveStreamStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamState {
...
export function LiveStreamStateToJSON(value?: LiveStreamState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
