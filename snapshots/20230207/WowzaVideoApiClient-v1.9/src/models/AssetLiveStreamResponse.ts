...
import type { AssetRestream } from './AssetRestream';
import {
    AssetRestreamFromJSON,
    AssetRestreamFromJSONTyped,
    AssetRestreamToJSON,
} from './AssetRestream';
 ...
 * 
 * @export
 * @interface AssetLiveStreamResponse
 */
export interface AssetLiveStreamResponse {
    /**
     * 
     * @type {AssetRestream}
     * @memberof AssetLiveStreamResponse
     */
    liveStream: AssetRestream;
}

/**
 * Check if a given object implements the AssetLiveStreamResponse interface.
 */
export function instanceOfAssetLiveStreamResponse(value: object): boolean {
    let isInstance = true;
...
export function AssetLiveStreamResponseFromJSON(json: any): AssetLiveStreamResponse {
    return AssetLiveStreamResponseFromJSONTyped(json, false);
}

export function AssetLiveStreamResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetLiveStreamResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'liveStream': AssetRestreamFromJSON(json['live_stream']),
    };
}

export function AssetLiveStreamResponseToJSON(value?: AssetLiveStreamResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'live_stream': AssetRestreamToJSON(value.liveStream),
    };
}
