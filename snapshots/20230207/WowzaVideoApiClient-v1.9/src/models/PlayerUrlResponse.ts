...
import type { PlayerUrl } from './PlayerUrl';
import {
    PlayerUrlFromJSON,
    PlayerUrlFromJSONTyped,
    PlayerUrlToJSON,
} from './PlayerUrl';
...
export interface PlayerUrlResponse {
     ...
     * 
     * @type {PlayerUrl}
     * @memberof PlayerUrlResponse
     */
    url: PlayerUrl;
}

/**
 * Check if a given object implements the PlayerUrlResponse interface.
 */
export function instanceOfPlayerUrlResponse(value: object): boolean {
    let isInstance = true;
...
export function PlayerUrlResponseFromJSON(json: any): PlayerUrlResponse {
    return PlayerUrlResponseFromJSONTyped(json, false);
}

export function PlayerUrlResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerUrlResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'url': PlayerUrlFromJSON(json['url']),
    };
}

export function PlayerUrlResponseToJSON(value?: PlayerUrlResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
