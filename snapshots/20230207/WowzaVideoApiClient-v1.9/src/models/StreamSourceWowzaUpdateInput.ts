...
import type { StreamSourceWowzaUpdateInputInner } from './StreamSourceWowzaUpdateInputInner';
import {
    StreamSourceWowzaUpdateInputInnerFromJSON,
    StreamSourceWowzaUpdateInputInnerFromJSONTyped,
    StreamSourceWowzaUpdateInputInnerToJSON,
} from './StreamSourceWowzaUpdateInputInner';

/**
 * 
 * @export
 * @interface StreamSourceWowzaUpdateInput
 */
export interface StreamSourceWowzaUpdateInput {
    /**
     * 
     * @type {StreamSourceWowzaUpdateInputInner}
     * @memberof StreamSourceWowzaUpdateInput
     */
    streamSourceWowza: StreamSourceWowzaUpdateInputInner;
}

/**
 * Check if a given object implements the StreamSourceWowzaUpdateInput interface.
 */
export function instanceOfStreamSourceWowzaUpdateInput(value: object): boolean {
    let isInstance = true;
...
export function StreamSourceWowzaUpdateInputFromJSON(json: any): StreamSourceWowzaUpdateInput {
    return StreamSourceWowzaUpdateInputFromJSONTyped(json, false);
}

export function StreamSourceWowzaUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamSourceWowzaUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamSourceWowza': StreamSourceWowzaUpdateInputInnerFromJSON(json['stream_source_wowza']),
    };
}

export function StreamSourceWowzaUpdateInputToJSON(value?: StreamSourceWowzaUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_source_wowza': StreamSourceWowzaUpdateInputInnerToJSON(value.streamSourceWowza),
    };
}
