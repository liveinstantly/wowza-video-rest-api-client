 ...
 * 
 * @export
 * @interface IndexStreamTargetAkamai
 */
export interface IndexStreamTargetAkamai {
    /**
     * The date and time that the stream target was created.
     * @type {Date}
     * @memberof IndexStreamTargetAkamai
     */
    createdAt?: Date;
    /**
...
/**
 * Check if a given object implements the IndexStreamTargetAkamai interface.
 */
export function instanceOfIndexStreamTargetAkamai(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexStreamTargetAkamaiFromJSON(json: any): IndexStreamTargetAkamai {
    return IndexStreamTargetAkamaiFromJSONTyped(json, false);
}

export function IndexStreamTargetAkamaiFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexStreamTargetAkamai {
...
export function IndexStreamTargetAkamaiToJSON(value?: IndexStreamTargetAkamai | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
