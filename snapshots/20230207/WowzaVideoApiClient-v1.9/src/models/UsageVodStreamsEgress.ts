...
import type { UsageEgressDataPerVodStream } from './UsageEgressDataPerVodStream';
import {
    UsageEgressDataPerVodStreamFromJSON,
    UsageEgressDataPerVodStreamFromJSONTyped,
    UsageEgressDataPerVodStreamToJSON,
} from './UsageEgressDataPerVodStream';
 ...
 * 
 * @export
 * @interface UsageVodStreamsEgress
 */
export interface UsageVodStreamsEgress {
    /**
     * An array of VOD streams and the details of their egress usage.
     * @type {Array<UsageEgressDataPerVodStream>}
     * @memberof UsageVodStreamsEgress
     */
    vodStreams?: Array<UsageEgressDataPerVodStream>;
    /**
     * 
...
/**
 * Check if a given object implements the UsageVodStreamsEgress interface.
 */
export function instanceOfUsageVodStreamsEgress(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamsEgressFromJSON(json: any): UsageVodStreamsEgress {
    return UsageVodStreamsEgressFromJSONTyped(json, false);
}

export function UsageVodStreamsEgressFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamsEgress {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'vodStreams': !exists(json, 'vod_streams') ? undefined : ((json['vod_streams'] as Array<any>).map(UsageEgressDataPerVodStreamFromJSON)),
...
export function UsageVodStreamsEgressToJSON(value?: UsageVodStreamsEgress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'vod_streams': value.vodStreams === undefined ? undefined : ((value.vodStreams as Array<any>).map(UsageEgressDataPerVodStreamToJSON)),
