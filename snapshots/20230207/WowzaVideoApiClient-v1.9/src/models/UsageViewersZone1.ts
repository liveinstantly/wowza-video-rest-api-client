 ...
 * 
 * @export
 * @interface UsageViewersZone1
 */
export interface UsageViewersZone1 {
    /**
     * The name of the billing zone where the usage was generated.
     * @type {string}
     * @memberof UsageViewersZone1
     */
    name?: string;
    /**
    ...
    viewingBytes?: number;
    /**
     * The type of stream target. <br/> **fastly** is a Wowza CDN on Fastly target. <br/>
     * @type {string}
     * @memberof UsageViewersZone1
     */
    type?: UsageViewersZone1TypeEnum;
}
 ...
 * @export
 */
export const UsageViewersZone1TypeEnum = {
    Fastly: 'fastly',
    Akamai: 'akamai'
} as const;
export type UsageViewersZone1TypeEnum = typeof UsageViewersZone1TypeEnum[keyof typeof UsageViewersZone1TypeEnum];


/**
 * Check if a given object implements the UsageViewersZone1 interface.
 */
export function instanceOfUsageViewersZone1(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersZone1FromJSON(json: any): UsageViewersZone1 {
    return UsageViewersZone1FromJSONTyped(json, false);
}

export function UsageViewersZone1FromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersZone1 {
...
export function UsageViewersZone1ToJSON(value?: UsageViewersZone1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
