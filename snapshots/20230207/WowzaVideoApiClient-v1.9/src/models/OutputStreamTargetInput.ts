...
import type { OutputStreamTargetInputInner } from './OutputStreamTargetInputInner';
import {
    OutputStreamTargetInputInnerFromJSON,
    OutputStreamTargetInputInnerFromJSONTyped,
    OutputStreamTargetInputInnerToJSON,
} from './OutputStreamTargetInputInner';

/**
 * 
 * @export
 * @interface OutputStreamTargetInput
 */
export interface OutputStreamTargetInput {
    /**
     * 
     * @type {OutputStreamTargetInputInner}
     * @memberof OutputStreamTargetInput
     */
    outputStreamTarget: OutputStreamTargetInputInner;
}

/**
 * Check if a given object implements the OutputStreamTargetInput interface.
 */
export function instanceOfOutputStreamTargetInput(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "outputStreamTarget" in value;

    return isInstance;
}

export function OutputStreamTargetInputFromJSON(json: any): OutputStreamTargetInput {
    return OutputStreamTargetInputFromJSONTyped(json, false);
}

export function OutputStreamTargetInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutputStreamTargetInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'outputStreamTarget': OutputStreamTargetInputInnerFromJSON(json['output_stream_target']),
    };
}

export function OutputStreamTargetInputToJSON(value?: OutputStreamTargetInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'output_stream_target': OutputStreamTargetInputInnerToJSON(value.outputStreamTarget),
    };
}
