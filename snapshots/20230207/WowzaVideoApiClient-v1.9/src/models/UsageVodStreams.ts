...
import type { UsageViewersDataPerVodStream } from './UsageViewersDataPerVodStream';
import {
    UsageViewersDataPerVodStreamFromJSON,
    UsageViewersDataPerVodStreamFromJSONTyped,
    UsageViewersDataPerVodStreamToJSON,
} from './UsageViewersDataPerVodStream';

/**
 * 
 * @export
 * @interface UsageVodStreams
 */
export interface UsageVodStreams {
    /**
     * An array of VOD streams and the details of their CDN usage.
     * @type {Array<UsageViewersDataPerVodStream>}
     * @memberof UsageVodStreams
     */
    vodStreams?: Array<UsageViewersDataPerVodStream>;
    /**
     * 
...
/**
 * Check if a given object implements the UsageVodStreams interface.
 */
export function instanceOfUsageVodStreams(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamsFromJSON(json: any): UsageVodStreams {
    return UsageVodStreamsFromJSONTyped(json, false);
}

export function UsageVodStreamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreams {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'vodStreams': !exists(json, 'vod_streams') ? undefined : ((json['vod_streams'] as Array<any>).map(UsageViewersDataPerVodStreamFromJSON)),
...
export function UsageVodStreamsToJSON(value?: UsageVodStreams | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'vod_streams': value.vodStreams === undefined ? undefined : ((value.vodStreams as Array<any>).map(UsageViewersDataPerVodStreamToJSON)),
