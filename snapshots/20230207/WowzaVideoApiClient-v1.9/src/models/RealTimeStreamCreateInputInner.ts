 ...
 * 
 * @export
 * @interface RealTimeStreamCreateInputInner
 */
export interface RealTimeStreamCreateInputInner {
    /**
     * A descriptive name for the real-time stream. Maximum 255 characters.


<blockquote><strong>Note:</strong> 
If you record a real-time stream, the name is used to for the recording file name. To avoid file management issues in storage, Wowza Video removes or replaces special 
characters in file names, so the recording file name might vary from the name you provided here.</blockquote>
     * @type {string}
     * @memberof RealTimeStreamCreateInputInner
     */
    name: string;
    /**
...
**Example:** <code>"region": emea</code>
     ...
     * @memberof RealTimeStreamCreateInputInner
     */
    region?: RealTimeStreamCreateInputInnerRegionEnum;
    /**
 ...
 * @export
 */
export const RealTimeStreamCreateInputInnerRegionEnum = {
    Americas: 'americas',
    Emea: 'emea'
} as const;
export type RealTimeStreamCreateInputInnerRegionEnum = typeof RealTimeStreamCreateInputInnerRegionEnum[keyof typeof RealTimeStreamCreateInputInnerRegionEnum];


/**
 * Check if a given object implements the RealTimeStreamCreateInputInner interface.
 */
export function instanceOfRealTimeStreamCreateInputInner(value: object): boolean {
    let isInstance = true;
...
export function RealTimeStreamCreateInputInnerFromJSON(json: any): RealTimeStreamCreateInputInner {
    return RealTimeStreamCreateInputInnerFromJSONTyped(json, false);
}

export function RealTimeStreamCreateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RealTimeStreamCreateInputInner {
...
export function RealTimeStreamCreateInputInnerToJSON(value?: RealTimeStreamCreateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
