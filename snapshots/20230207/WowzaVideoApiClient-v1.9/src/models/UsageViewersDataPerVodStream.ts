 ...
 * 
 * @export
 * @interface UsageViewersDataPerVodStream
 */
export interface UsageViewersDataPerVodStream {
    /**
     * The unique alphanumeric string that identifies the VOD stream.
     * @type {string}
     * @memberof UsageViewersDataPerVodStream
     */
    id?: string;
    /**
     ...
     * @memberof UsageViewersDataPerVodStream
     */
    type?: UsageViewersDataPerVodStreamTypeEnum;
    /**
 ...
 * @export
 */
export const UsageViewersDataPerVodStreamTypeEnum = {
    Fastly: 'fastly'
} as const;
export type UsageViewersDataPerVodStreamTypeEnum = typeof UsageViewersDataPerVodStreamTypeEnum[keyof typeof UsageViewersDataPerVodStreamTypeEnum];


/**
 * Check if a given object implements the UsageViewersDataPerVodStream interface.
 */
export function instanceOfUsageViewersDataPerVodStream(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataPerVodStreamFromJSON(json: any): UsageViewersDataPerVodStream {
    return UsageViewersDataPerVodStreamFromJSONTyped(json, false);
}

export function UsageViewersDataPerVodStreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataPerVodStream {
...
export function UsageViewersDataPerVodStreamToJSON(value?: UsageViewersDataPerVodStream | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
