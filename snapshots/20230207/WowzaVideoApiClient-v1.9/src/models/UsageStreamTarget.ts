...
import type { UsageViewersDataPerStreamTargetWithZones } from './UsageViewersDataPerStreamTargetWithZones';
import {
    UsageViewersDataPerStreamTargetWithZonesFromJSON,
    UsageViewersDataPerStreamTargetWithZonesFromJSONTyped,
    UsageViewersDataPerStreamTargetWithZonesToJSON,
} from './UsageViewersDataPerStreamTargetWithZones';

/**
 * 
 * @export
 * @interface UsageStreamTarget
 */
export interface UsageStreamTarget {
    /**
     * 
     * @type {UsageViewersDataPerStreamTargetWithZones}
     * @memberof UsageStreamTarget
     */
    streamTarget?: UsageViewersDataPerStreamTargetWithZones;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageStreamTarget
...
/**
 * Check if a given object implements the UsageStreamTarget interface.
 */
export function instanceOfUsageStreamTarget(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageStreamTargetFromJSON(json: any): UsageStreamTarget {
    return UsageStreamTargetFromJSONTyped(json, false);
}

export function UsageStreamTargetFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageStreamTarget {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTarget': !exists(json, 'stream_target') ? undefined : UsageViewersDataPerStreamTargetWithZonesFromJSON(json['stream_target']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageStreamTargetToJSON(value?: UsageStreamTarget | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target': UsageViewersDataPerStreamTargetWithZonesToJSON(value.streamTarget),
