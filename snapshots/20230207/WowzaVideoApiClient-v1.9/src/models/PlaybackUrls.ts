...
export interface PlaybackUrls {
    /**
     * Web address that the target uses to play HLS streams. <br/><br/> The format is a hash where the key is **hls** and the value is the playback URL. <br/>Example&#58; "hls":&nbsp;"http&#58;//&lt;*domain*&gt;/master.m3u8"
     * @type {string}
     * @memberof PlaybackUrls
     */
    hls?: string;
    /**
     * Web address that the target uses to play HDS streams. Not for use with the akamai_cupertino custom *provider*. <br/><br/>The format is a hash where the key is **hds** and the value is the playback URL. <br/>Example&#58; "hds":&nbsp;"http&#58;//&lt;*domain*&gt;/manifest.f4m"
     * @type {string}
     * @memberof PlaybackUrls
     */
    hds?: string;
    /**
     * Web address that the target uses to play RTMP streams. <br/><br/>The format is a hash where the key is **rtmp** and the value is the playback URL. <br/>Example&#58; "rtmp":&nbsp;"rtmp&#58;//cp319499.live.edgefcs.net/live/c9467d50@337857"
     * @type {string}
     * @memberof PlaybackUrls
     */
    rtmp?: string;
...
/**
 * Check if a given object implements the PlaybackUrls interface.
 */
export function instanceOfPlaybackUrls(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PlaybackUrlsFromJSON(json: any): PlaybackUrls {
    return PlaybackUrlsFromJSONTyped(json, false);
}

export function PlaybackUrlsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlaybackUrls {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'hls': !exists(json, 'hls') ? undefined : json['hls'],
        'hds': !exists(json, 'hds') ? undefined : json['hds'],
        'rtmp': !exists(json, 'rtmp') ? undefined : json['rtmp'],
    };
}

export function PlaybackUrlsToJSON(value?: PlaybackUrls | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
