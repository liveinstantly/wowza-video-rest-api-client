...
import type { TranscoderStreamTargets } from './TranscoderStreamTargets';
import {
    TranscoderStreamTargetsFromJSON,
    TranscoderStreamTargetsFromJSONTyped,
    TranscoderStreamTargetsToJSON,
} from './TranscoderStreamTargets';

/**
 * 
 * @export
 * @interface TranscoderEnableAllStreamTargetResponse
 */
export interface TranscoderEnableAllStreamTargetResponse {
    /**
     * 
     * @type {TranscoderStreamTargets}
     * @memberof TranscoderEnableAllStreamTargetResponse
     */
    transcoder: TranscoderStreamTargets;
}

/**
 * Check if a given object implements the TranscoderEnableAllStreamTargetResponse interface.
 */
export function instanceOfTranscoderEnableAllStreamTargetResponse(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "transcoder" in value;

    return isInstance;
}

export function TranscoderEnableAllStreamTargetResponseFromJSON(json: any): TranscoderEnableAllStreamTargetResponse {
    return TranscoderEnableAllStreamTargetResponseFromJSONTyped(json, false);
}

export function TranscoderEnableAllStreamTargetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderEnableAllStreamTargetResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': TranscoderStreamTargetsFromJSON(json['transcoder']),
    };
}

export function TranscoderEnableAllStreamTargetResponseToJSON(value?: TranscoderEnableAllStreamTargetResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': TranscoderStreamTargetsToJSON(value.transcoder),
    };
}
