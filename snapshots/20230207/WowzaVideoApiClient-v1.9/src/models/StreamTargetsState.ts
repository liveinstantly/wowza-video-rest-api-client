 ...
 */
export interface StreamTargetsState {
    /**
     * The state of the transcoder's stream targets.
     * @type {string}
     * @memberof StreamTargetsState
     */
    state?: StreamTargetsStateStateEnum;
}
 ...
 * @export
 */
export const StreamTargetsStateStateEnum = {
    Enabled: 'enabled',
    Disabled: 'disabled'
} as const;
export type StreamTargetsStateStateEnum = typeof StreamTargetsStateStateEnum[keyof typeof StreamTargetsStateStateEnum];


/**
 * Check if a given object implements the StreamTargetsState interface.
 */
export function instanceOfStreamTargetsState(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetsStateFromJSON(json: any): StreamTargetsState {
    return StreamTargetsStateFromJSONTyped(json, false);
}

export function StreamTargetsStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetsState {
...
export function StreamTargetsStateToJSON(value?: StreamTargetsState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
