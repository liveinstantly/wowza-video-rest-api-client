...
/**
 * Check if a given object implements the Rtmp interface.
 */
export function instanceOfRtmp(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RtmpFromJSON(json: any): Rtmp {
    return RtmpFromJSONTyped(json, false);
}

export function RtmpFromJSONTyped(json: any, ignoreDiscriminator: boolean): Rtmp {
...
export function RtmpToJSON(value?: Rtmp | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
