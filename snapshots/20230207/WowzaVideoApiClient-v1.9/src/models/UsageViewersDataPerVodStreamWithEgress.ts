 ...
 * 
 * @export
 * @interface UsageViewersDataPerVodStreamWithEgress
 */
export interface UsageViewersDataPerVodStreamWithEgress {
    /**
     * The unique alphanumeric string that identifies the VOD stream.
     * @type {string}
     * @memberof UsageViewersDataPerVodStreamWithEgress
     */
    id?: string;
    /**
     * A descriptive name for the VOD stream. Maximum 255 characters.
     * @type {string}
     * @memberof UsageViewersDataPerVodStreamWithEgress
     */
    name?: string;
    /**
     * A value of **true** indicates that the VOD stream has been removed from Wowza Video.
     * @type {boolean}
     * @memberof UsageViewersDataPerVodStreamWithEgress
     */
    archived?: boolean;
    /**
     * **fastly** is a Wowza CDN on Fastly target.
     * @type {string}
     * @memberof UsageViewersDataPerVodStreamWithEgress
     */
    type?: UsageViewersDataPerVodStreamWithEgressTypeEnum;
    /**
    ...
    viewingBytes?: number;
    /**
     * The amount of content, in bytes, that Wowza CDN on Fastly pulled from storage during the selected time frame.
     * @type {number}
     * @memberof UsageViewersDataPerVodStreamWithEgress
     */
    egressBytes?: number;
 ...
 * @export
 */
export const UsageViewersDataPerVodStreamWithEgressTypeEnum = {
    Fastly: 'fastly'
} as const;
export type UsageViewersDataPerVodStreamWithEgressTypeEnum = typeof UsageViewersDataPerVodStreamWithEgressTypeEnum[keyof typeof UsageViewersDataPerVodStreamWithEgressTypeEnum];


/**
 * Check if a given object implements the UsageViewersDataPerVodStreamWithEgress interface.
 */
export function instanceOfUsageViewersDataPerVodStreamWithEgress(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataPerVodStreamWithEgressFromJSON(json: any): UsageViewersDataPerVodStreamWithEgress {
    return UsageViewersDataPerVodStreamWithEgressFromJSONTyped(json, false);
}

export function UsageViewersDataPerVodStreamWithEgressFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataPerVodStreamWithEgress {
...
export function UsageViewersDataPerVodStreamWithEgressToJSON(value?: UsageViewersDataPerVodStreamWithEgress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
