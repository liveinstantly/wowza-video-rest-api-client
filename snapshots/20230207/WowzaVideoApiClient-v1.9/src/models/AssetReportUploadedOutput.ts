 ...
 * 
 * @export
 * @interface AssetReportUploadedOutput
 */
export interface AssetReportUploadedOutput {
    /**
     * The unique alphanumeric string that identifies the asset
     * @type {string}
     * @memberof AssetReportUploadedOutput
     */
    id?: string;
    /**
     ...
     * @memberof AssetReportUploadedOutput
     */
    state?: AssetReportUploadedOutputStateEnum;
    /**
 ...
 * @export
 */
export const AssetReportUploadedOutputStateEnum = {
    Uploading: 'uploading',
    Processing: 'processing',
    Completed: 'completed',
    Failed: 'failed'
} as const;
export type AssetReportUploadedOutputStateEnum = typeof AssetReportUploadedOutputStateEnum[keyof typeof AssetReportUploadedOutputStateEnum];


/**
 * Check if a given object implements the AssetReportUploadedOutput interface.
 */
export function instanceOfAssetReportUploadedOutput(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AssetReportUploadedOutputFromJSON(json: any): AssetReportUploadedOutput {
    return AssetReportUploadedOutputFromJSONTyped(json, false);
}

export function AssetReportUploadedOutputFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetReportUploadedOutput {
...
export function AssetReportUploadedOutputToJSON(value?: AssetReportUploadedOutput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
