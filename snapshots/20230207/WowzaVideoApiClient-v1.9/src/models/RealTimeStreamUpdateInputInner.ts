 ...
 * 
 * @export
 * @interface RealTimeStreamUpdateInputInner
 */
export interface RealTimeStreamUpdateInputInner {
    /**
...
characters in file names, so the recording file name might vary from the name you provided here.</blockquote>
     * @type {string}
     * @memberof RealTimeStreamUpdateInputInner
     */
    name: string;
    /**
...
/**
 * Check if a given object implements the RealTimeStreamUpdateInputInner interface.
 */
export function instanceOfRealTimeStreamUpdateInputInner(value: object): boolean {
    let isInstance = true;
...
export function RealTimeStreamUpdateInputInnerFromJSON(json: any): RealTimeStreamUpdateInputInner {
    return RealTimeStreamUpdateInputInnerFromJSONTyped(json, false);
}

export function RealTimeStreamUpdateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RealTimeStreamUpdateInputInner {
...
export function RealTimeStreamUpdateInputInnerToJSON(value?: RealTimeStreamUpdateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
