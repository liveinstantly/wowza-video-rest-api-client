 ...
 * 
 * @export
 * @interface UsageViewersDataByRendition
 */
export interface UsageViewersDataByRendition {
    /**
     * The name of the VOD stream's output rendition.
     * @type {string}
     * @memberof UsageViewersDataByRendition
     */
    name?: string;
    /**
...
/**
 * Check if a given object implements the UsageViewersDataByRendition interface.
 */
export function instanceOfUsageViewersDataByRendition(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataByRenditionFromJSON(json: any): UsageViewersDataByRendition {
    return UsageViewersDataByRenditionFromJSONTyped(json, false);
}

export function UsageViewersDataByRenditionFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataByRendition {
...
export function UsageViewersDataByRenditionToJSON(value?: UsageViewersDataByRendition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
