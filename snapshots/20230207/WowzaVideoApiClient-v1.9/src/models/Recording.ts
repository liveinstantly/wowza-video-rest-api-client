 ...
 */
export function instanceOfRecording(value: object): boolean {
    let isInstance = true;
...
export function RecordingFromJSONTyped(json: any, ignoreDiscriminator: boolean): Recording {
    ...
    return {
        ...
        'transcodingUptimeId': !exists(json, 'transcoding_uptime_id') ? undefined : (new Date(json['transcoding_uptime_id'])),
...
export function RecordingToJSON(value?: Recording | null): any {
    ...
    return {
        ...
        'transcoding_uptime_id': value.transcodingUptimeId === undefined ? undefined : (value.transcodingUptimeId.toISOString()),
