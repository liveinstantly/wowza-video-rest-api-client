 ...
 * 
 * @export
 * @interface IndexStreamTarget
 */
export interface IndexStreamTarget {
    /**
     * The date and time that the stream target was created.
     * @type {Date}
     * @memberof IndexStreamTarget
     */
    createdAt?: Date;
    /**
     ...
     * @memberof IndexStreamTarget
     */
    state?: IndexStreamTargetStateEnum;
    /**
     * **wowza** is a Wowza CDN target; **custom** is an external, third-party destination; and **fastly** is a Wowza CDN on Fastly target. 
     * @type {string}
     * @memberof IndexStreamTarget
     */
    type?: IndexStreamTargetTypeEnum;
    /**
 ...
 * @export
 */
export const IndexStreamTargetStateEnum = {
    Activated: 'activated',
    Archived: 'archived'
} as const;
export type IndexStreamTargetStateEnum = typeof IndexStreamTargetStateEnum[keyof typeof IndexStreamTargetStateEnum];

/**
 * @export
 */
export const IndexStreamTargetTypeEnum = {
    Wowza: 'wowza',
    Custom: 'custom',
    Fastly: 'fastly'
} as const;
export type IndexStreamTargetTypeEnum = typeof IndexStreamTargetTypeEnum[keyof typeof IndexStreamTargetTypeEnum];


/**
 * Check if a given object implements the IndexStreamTarget interface.
 */
export function instanceOfIndexStreamTarget(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexStreamTargetFromJSON(json: any): IndexStreamTarget {
    return IndexStreamTargetFromJSONTyped(json, false);
}

export function IndexStreamTargetFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexStreamTarget {
...
export function IndexStreamTargetToJSON(value?: IndexStreamTarget | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
