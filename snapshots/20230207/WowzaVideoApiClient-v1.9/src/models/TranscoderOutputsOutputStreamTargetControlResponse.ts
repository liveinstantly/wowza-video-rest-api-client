...
import type { OutputStreamTargetControlState } from './OutputStreamTargetControlState';
import {
    OutputStreamTargetControlStateFromJSON,
    OutputStreamTargetControlStateFromJSONTyped,
    OutputStreamTargetControlStateToJSON,
} from './OutputStreamTargetControlState';

/**
 * 
 * @export
 * @interface TranscoderOutputsOutputStreamTargetControlResponse
 */
export interface TranscoderOutputsOutputStreamTargetControlResponse {
    /**
     * 
     * @type {OutputStreamTargetControlState}
     * @memberof TranscoderOutputsOutputStreamTargetControlResponse
     */
    streamTarget: OutputStreamTargetControlState;
}

/**
 * Check if a given object implements the TranscoderOutputsOutputStreamTargetControlResponse interface.
 */
export function instanceOfTranscoderOutputsOutputStreamTargetControlResponse(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamTarget" in value;

    return isInstance;
}

export function TranscoderOutputsOutputStreamTargetControlResponseFromJSON(json: any): TranscoderOutputsOutputStreamTargetControlResponse {
    return TranscoderOutputsOutputStreamTargetControlResponseFromJSONTyped(json, false);
}

export function TranscoderOutputsOutputStreamTargetControlResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderOutputsOutputStreamTargetControlResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTarget': OutputStreamTargetControlStateFromJSON(json['stream_target']),
    };
}

export function TranscoderOutputsOutputStreamTargetControlResponseToJSON(value?: TranscoderOutputsOutputStreamTargetControlResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target': OutputStreamTargetControlStateToJSON(value.streamTarget),
    };
}
