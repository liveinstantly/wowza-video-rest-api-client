 ...
 * 
 * @export
 * @interface IndexStreamSourceWowza
 */
export interface IndexStreamSourceWowza {
    /**
     * The date and time that the Wowza stream source was created.
     * @type {Date}
     * @memberof IndexStreamSourceWowza
     */
    createdAt?: Date;
    /**
...
/**
 * Check if a given object implements the IndexStreamSourceWowza interface.
 */
export function instanceOfIndexStreamSourceWowza(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexStreamSourceWowzaFromJSON(json: any): IndexStreamSourceWowza {
    return IndexStreamSourceWowzaFromJSONTyped(json, false);
}

export function IndexStreamSourceWowzaFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexStreamSourceWowza {
...
export function IndexStreamSourceWowzaToJSON(value?: IndexStreamSourceWowza | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
