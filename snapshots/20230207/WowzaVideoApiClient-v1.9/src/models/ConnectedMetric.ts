...
/**
 * Check if a given object implements the ConnectedMetric interface.
 */
export function instanceOfConnectedMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ConnectedMetricFromJSON(json: any): ConnectedMetric {
    return ConnectedMetricFromJSONTyped(json, false);
}

export function ConnectedMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectedMetric {
...
export function ConnectedMetricToJSON(value?: ConnectedMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
