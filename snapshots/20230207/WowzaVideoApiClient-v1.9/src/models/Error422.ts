...
/**
 * Check if a given object implements the Error422 interface.
 */
export function instanceOfError422(value: object): boolean {
    let isInstance = true;
...
export function Error422FromJSON(json: any): Error422 {
    return Error422FromJSONTyped(json, false);
}

export function Error422FromJSONTyped(json: any, ignoreDiscriminator: boolean): Error422 {
...
export function Error422ToJSON(value?: Error422 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
