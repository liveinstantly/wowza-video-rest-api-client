...
import type { UsageLimitsResources } from './UsageLimitsResources';
import {
    UsageLimitsResourcesFromJSON,
    UsageLimitsResourcesFromJSONTyped,
    UsageLimitsResourcesToJSON,
} from './UsageLimitsResources';

/**
 * The query parameters applied to the request.
 * @export
 * @interface UsageLimitsWithResources
 */
export interface UsageLimitsWithResources {
    /**
     * 
     * @type {UsageLimitsResources}
     * @memberof UsageLimitsWithResources
     */
    resources?: UsageLimitsResources;
    /**
     * The start of the range of time represented in the response.
     * @type {Date}
     * @memberof UsageLimitsWithResources
     */
    from?: Date;
    /**
     * The end of the range of time represented in the response.
     * @type {Date}
     * @memberof UsageLimitsWithResources
     */
    to?: Date;
...
/**
 * Check if a given object implements the UsageLimitsWithResources interface.
 */
export function instanceOfUsageLimitsWithResources(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageLimitsWithResourcesFromJSON(json: any): UsageLimitsWithResources {
    return UsageLimitsWithResourcesFromJSONTyped(json, false);
}

export function UsageLimitsWithResourcesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageLimitsWithResources {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'resources': !exists(json, 'resources') ? undefined : UsageLimitsResourcesFromJSON(json['resources']),
        'from': !exists(json, 'from') ? undefined : (new Date(json['from'])),
        'to': !exists(json, 'to') ? undefined : (new Date(json['to'])),
    };
}

export function UsageLimitsWithResourcesToJSON(value?: UsageLimitsWithResources | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'resources': UsageLimitsResourcesToJSON(value.resources),
