...
import type { IndexStreamTargetFastly } from './IndexStreamTargetFastly';
import {
    IndexStreamTargetFastlyFromJSON,
    IndexStreamTargetFastlyFromJSONTyped,
    IndexStreamTargetFastlyToJSON,
} from './IndexStreamTargetFastly';

/**
 * 
 * @export
 * @interface StreamTargetsFastly
 */
export interface StreamTargetsFastly {
    /**
     * 
     * @type {Array<IndexStreamTargetFastly>}
     * @memberof StreamTargetsFastly
     */
    streamTargetsFastly: Array<IndexStreamTargetFastly>;
}

/**
 * Check if a given object implements the StreamTargetsFastly interface.
 */
export function instanceOfStreamTargetsFastly(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamTargetsFastly" in value;

    return isInstance;
}

export function StreamTargetsFastlyFromJSON(json: any): StreamTargetsFastly {
    return StreamTargetsFastlyFromJSONTyped(json, false);
}

export function StreamTargetsFastlyFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetsFastly {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetsFastly': ((json['stream_targets_fastly'] as Array<any>).map(IndexStreamTargetFastlyFromJSON)),
    };
}

export function StreamTargetsFastlyToJSON(value?: StreamTargetsFastly | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_targets_fastly': ((value.streamTargetsFastly as Array<any>).map(IndexStreamTargetFastlyToJSON)),
    };
}
