 ...
 * 
 * @export
 * @interface IndexTranscoder
 */
export interface IndexTranscoder {
    /**
     * The date and time that the transcoder was created.
     * @type {Date}
     * @memberof IndexTranscoder
     */
    createdAt?: Date;
    /**
     ...
     * @memberof IndexTranscoder
     */
    state?: IndexTranscoderStateEnum;
    /**
     ...
     * @memberof IndexTranscoder
     */
    workflow?: IndexTranscoderWorkflowEnum;
    /**
 ...
 * @export
 */
export const IndexTranscoderStateEnum = {
    Starting: 'starting',
    Stopping: 'stopping',
    Started: 'started',
    Stopped: 'stopped',
...
export type IndexTranscoderStateEnum = typeof IndexTranscoderStateEnum[keyof typeof IndexTranscoderStateEnum];

/**
 * @export
 */
export const IndexTranscoderWorkflowEnum = {
    LiveStream: 'live_stream',
    Transcoder: 'transcoder'
} as const;
export type IndexTranscoderWorkflowEnum = typeof IndexTranscoderWorkflowEnum[keyof typeof IndexTranscoderWorkflowEnum];


/**
 * Check if a given object implements the IndexTranscoder interface.
 */
export function instanceOfIndexTranscoder(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexTranscoderFromJSON(json: any): IndexTranscoder {
    return IndexTranscoderFromJSONTyped(json, false);
}

export function IndexTranscoderFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexTranscoder {
...
export function IndexTranscoderToJSON(value?: IndexTranscoder | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
