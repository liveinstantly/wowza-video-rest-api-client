...
import type { AssetCreateOutput } from './AssetCreateOutput';
import {
    AssetCreateOutputFromJSON,
    AssetCreateOutputFromJSONTyped,
    AssetCreateOutputToJSON,
} from './AssetCreateOutput';
...
export interface AssetCreateResponse {
    /**
     * 
     * @type {AssetCreateOutput}
     * @memberof AssetCreateResponse
     */
    asset: AssetCreateOutput;
}
...
export function AssetCreateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetCreateResponse {
    ...
    return {
        ...
        'asset': AssetCreateOutputFromJSON(json['asset']),
    };
}
...
export function AssetCreateResponseToJSON(value?: AssetCreateResponse | null): any {
    ...
    return {
        ...
        'asset': AssetCreateOutputToJSON(value.asset),
    };
}
