 ...
 * 
 * @export
 * @interface LiveStreamStatsResponse
 */
export interface LiveStreamStatsResponse {
    /**
     * 
     * @type {ShmMetrics}
     * @memberof LiveStreamStatsResponse
     */
    liveStream: ShmMetrics;
}

/**
 * Check if a given object implements the LiveStreamStatsResponse interface.
 */
export function instanceOfLiveStreamStatsResponse(value: object): boolean {
    let isInstance = true;
...
export function LiveStreamStatsResponseFromJSON(json: any): LiveStreamStatsResponse {
    return LiveStreamStatsResponseFromJSONTyped(json, false);
}

export function LiveStreamStatsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamStatsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'liveStream': ShmMetricsFromJSON(json['live_stream']),
    };
}

export function LiveStreamStatsResponseToJSON(value?: LiveStreamStatsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'live_stream': ShmMetricsToJSON(value.liveStream),
    };
}
