...
import type { StreamTargetCustomPlaybackUrls } from './StreamTargetCustomPlaybackUrls';
import {
    StreamTargetCustomPlaybackUrlsFromJSON,
    StreamTargetCustomPlaybackUrlsFromJSONTyped,
    StreamTargetCustomPlaybackUrlsToJSON,
} from './StreamTargetCustomPlaybackUrls';

/**
 * 
 * @export
 * @interface StreamTargetCustomPatchResponse
 */
export interface StreamTargetCustomPatchResponse {
    /**
     * The backup ingest URL for a custom stream target. Not for use with the akamai_cupertino custom *provider*.
     * @type {string}
     * @memberof StreamTargetCustomPatchResponse
     */
    backupUrl?: string;
    /**
    ...
    /**
     * 
     * @type {StreamTargetCustomPlaybackUrls}
     * @memberof StreamTargetCustomPatchResponse
     */
    playbackUrls?: StreamTargetCustomPlaybackUrls;
    /**
...
/**
 * Check if a given object implements the StreamTargetCustomPatchResponse interface.
 */
export function instanceOfStreamTargetCustomPatchResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetCustomPatchResponseFromJSON(json: any): StreamTargetCustomPatchResponse {
    return StreamTargetCustomPatchResponseFromJSONTyped(json, false);
}

export function StreamTargetCustomPatchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetCustomPatchResponse {
    ...
    return {
        ...
        'playbackUrls': !exists(json, 'playback_urls') ? undefined : StreamTargetCustomPlaybackUrlsFromJSON(json['playback_urls']),
...
export function StreamTargetCustomPatchResponseToJSON(value?: StreamTargetCustomPatchResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'playback_urls': StreamTargetCustomPlaybackUrlsToJSON(value.playbackUrls),
