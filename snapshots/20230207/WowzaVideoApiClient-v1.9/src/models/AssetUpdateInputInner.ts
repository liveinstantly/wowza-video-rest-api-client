...
/**
 * Check if a given object implements the AssetUpdateInputInner interface.
 */
export function instanceOfAssetUpdateInputInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AssetUpdateInputInnerFromJSON(json: any): AssetUpdateInputInner {
    return AssetUpdateInputInnerFromJSONTyped(json, false);
}

export function AssetUpdateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetUpdateInputInner {
...
export function AssetUpdateInputInnerToJSON(value?: AssetUpdateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
