...
import type { RealTimeStreamUpdateInputInner } from './RealTimeStreamUpdateInputInner';
import {
    RealTimeStreamUpdateInputInnerFromJSON,
    RealTimeStreamUpdateInputInnerFromJSONTyped,
    RealTimeStreamUpdateInputInnerToJSON,
} from './RealTimeStreamUpdateInputInner';

/**
 * 
 * @export
 * @interface RealTimeStreamUpdateInput
 */
export interface RealTimeStreamUpdateInput {
    /**
     * 
     * @type {RealTimeStreamUpdateInputInner}
     * @memberof RealTimeStreamUpdateInput
     */
    realTimeStream?: RealTimeStreamUpdateInputInner;
}

/**
 * Check if a given object implements the RealTimeStreamUpdateInput interface.
 */
export function instanceOfRealTimeStreamUpdateInput(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RealTimeStreamUpdateInputFromJSON(json: any): RealTimeStreamUpdateInput {
    return RealTimeStreamUpdateInputFromJSONTyped(json, false);
}

export function RealTimeStreamUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): RealTimeStreamUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'realTimeStream': !exists(json, 'real_time_stream') ? undefined : RealTimeStreamUpdateInputInnerFromJSON(json['real_time_stream']),
    };
}

export function RealTimeStreamUpdateInputToJSON(value?: RealTimeStreamUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'real_time_stream': RealTimeStreamUpdateInputInnerToJSON(value.realTimeStream),
    };
}
