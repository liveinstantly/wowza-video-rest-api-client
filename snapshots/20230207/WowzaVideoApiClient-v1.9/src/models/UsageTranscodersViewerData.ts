 ...
 * 
 * @export
 * @interface UsageTranscodersViewerData
 */
export interface UsageTranscodersViewerData {
    /**
     * 
     * @type {UsageViewersDataCurrent}
     * @memberof UsageTranscodersViewerData
     */
    transcoder?: UsageViewersDataCurrent;
}

/**
 * Check if a given object implements the UsageTranscodersViewerData interface.
 */
export function instanceOfUsageTranscodersViewerData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageTranscodersViewerDataFromJSON(json: any): UsageTranscodersViewerData {
    return UsageTranscodersViewerDataFromJSONTyped(json, false);
}

export function UsageTranscodersViewerDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageTranscodersViewerData {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': !exists(json, 'transcoder') ? undefined : UsageViewersDataCurrentFromJSON(json['transcoder']),
    };
}

export function UsageTranscodersViewerDataToJSON(value?: UsageTranscodersViewerData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': UsageViewersDataCurrentToJSON(value.transcoder),
    };
}
