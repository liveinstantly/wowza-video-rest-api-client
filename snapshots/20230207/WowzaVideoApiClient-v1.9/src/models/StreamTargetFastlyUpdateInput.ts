...
import type { StreamTargetFastlyUpdateInputInner } from './StreamTargetFastlyUpdateInputInner';
import {
    StreamTargetFastlyUpdateInputInnerFromJSON,
    StreamTargetFastlyUpdateInputInnerFromJSONTyped,
    StreamTargetFastlyUpdateInputInnerToJSON,
} from './StreamTargetFastlyUpdateInputInner';

/**
 * 
 * @export
 * @interface StreamTargetFastlyUpdateInput
 */
export interface StreamTargetFastlyUpdateInput {
    /**
     * 
     * @type {StreamTargetFastlyUpdateInputInner}
     * @memberof StreamTargetFastlyUpdateInput
     */
    streamTargetFastly: StreamTargetFastlyUpdateInputInner;
}

/**
 * Check if a given object implements the StreamTargetFastlyUpdateInput interface.
 */
export function instanceOfStreamTargetFastlyUpdateInput(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamTargetFastly" in value;

    return isInstance;
}

export function StreamTargetFastlyUpdateInputFromJSON(json: any): StreamTargetFastlyUpdateInput {
    return StreamTargetFastlyUpdateInputFromJSONTyped(json, false);
}

export function StreamTargetFastlyUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetFastlyUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetFastly': StreamTargetFastlyUpdateInputInnerFromJSON(json['stream_target_fastly']),
    };
}

export function StreamTargetFastlyUpdateInputToJSON(value?: StreamTargetFastlyUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target_fastly': StreamTargetFastlyUpdateInputInnerToJSON(value.streamTargetFastly),
    };
}
