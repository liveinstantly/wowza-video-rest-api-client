 ...
 * 
 * @export
 * @interface BytesInRateMetric
 */
export interface BytesInRateMetric {
    /**
...
/**
 * Check if a given object implements the BytesInRateMetric interface.
 */
export function instanceOfBytesInRateMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BytesInRateMetricFromJSON(json: any): BytesInRateMetric {
    return BytesInRateMetricFromJSONTyped(json, false);
}

export function BytesInRateMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): BytesInRateMetric {
...
export function BytesInRateMetricToJSON(value?: BytesInRateMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
