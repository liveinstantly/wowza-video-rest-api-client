...
import type { AssetUpdateInputInner } from './AssetUpdateInputInner';
import {
    AssetUpdateInputInnerFromJSON,
    AssetUpdateInputInnerFromJSONTyped,
    AssetUpdateInputInnerToJSON,
} from './AssetUpdateInputInner';
...
export interface AssetUpdateInput {
    /**
     * 
     * @type {AssetUpdateInputInner}
     * @memberof AssetUpdateInput
     */
    asset: AssetUpdateInputInner;
}

/**
 * Check if a given object implements the AssetUpdateInput interface.
 */
export function instanceOfAssetUpdateInput(value: object): boolean {
    let isInstance = true;
...
export function AssetUpdateInputFromJSON(json: any): AssetUpdateInput {
    return AssetUpdateInputFromJSONTyped(json, false);
}

export function AssetUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'asset': AssetUpdateInputInnerFromJSON(json['asset']),
    };
}

export function AssetUpdateInputToJSON(value?: AssetUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'asset': AssetUpdateInputInnerToJSON(value.asset),
    };
}
