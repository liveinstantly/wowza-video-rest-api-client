 ...
 * 
 * @export
 * @interface UsageAccountsViewerData
 */
export interface UsageAccountsViewerData {
    /**
     * 
     * @type {UsageViewersDataCurrent}
     * @memberof UsageAccountsViewerData
     */
    account?: UsageViewersDataCurrent;
}

/**
 * Check if a given object implements the UsageAccountsViewerData interface.
 */
export function instanceOfUsageAccountsViewerData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageAccountsViewerDataFromJSON(json: any): UsageAccountsViewerData {
    return UsageAccountsViewerDataFromJSONTyped(json, false);
}

export function UsageAccountsViewerDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageAccountsViewerData {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'account': !exists(json, 'account') ? undefined : UsageViewersDataCurrentFromJSON(json['account']),
    };
}

export function UsageAccountsViewerDataToJSON(value?: UsageAccountsViewerData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'account': UsageViewersDataCurrentToJSON(value.account),
    };
}
