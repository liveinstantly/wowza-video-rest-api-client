 ...
 * 
 * @export
 * @interface TranscoderThumbnailUrl
 */
export interface TranscoderThumbnailUrl {
    /**
     * The URL to receive the preview thumbnail.
     * @type {string}
     * @memberof TranscoderThumbnailUrl
     */
    thumbnailUrl?: string;
}

/**
 * Check if a given object implements the TranscoderThumbnailUrl interface.
 */
export function instanceOfTranscoderThumbnailUrl(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranscoderThumbnailUrlFromJSON(json: any): TranscoderThumbnailUrl {
    return TranscoderThumbnailUrlFromJSONTyped(json, false);
}

export function TranscoderThumbnailUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderThumbnailUrl {
...
export function TranscoderThumbnailUrlToJSON(value?: TranscoderThumbnailUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
