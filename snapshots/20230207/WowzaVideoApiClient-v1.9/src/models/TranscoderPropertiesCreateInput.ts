 ...
 * 
 * @export
 * @interface TranscoderPropertiesCreateInput
 */
export interface TranscoderPropertiesCreateInput {
    /**
...
Available from version 1.7.
     ...
     * @memberof TranscoderPropertiesCreateInput
     */
    properties?: Array<TranscoderProperty>;
}

/**
 * Check if a given object implements the TranscoderPropertiesCreateInput interface.
 */
export function instanceOfTranscoderPropertiesCreateInput(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranscoderPropertiesCreateInputFromJSON(json: any): TranscoderPropertiesCreateInput {
    return TranscoderPropertiesCreateInputFromJSONTyped(json, false);
}

export function TranscoderPropertiesCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderPropertiesCreateInput {
...
export function TranscoderPropertiesCreateInputToJSON(value?: TranscoderPropertiesCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
