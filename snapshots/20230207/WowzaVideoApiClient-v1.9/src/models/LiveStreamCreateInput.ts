...
import type { LiveStreamCreateInputInner } from './LiveStreamCreateInputInner';
import {
    LiveStreamCreateInputInnerFromJSON,
    LiveStreamCreateInputInnerFromJSONTyped,
    LiveStreamCreateInputInnerToJSON,
} from './LiveStreamCreateInputInner';

/**
 * 
 * @export
 * @interface LiveStreamCreateInput
 */
export interface LiveStreamCreateInput {
    /**
     * 
     * @type {LiveStreamCreateInputInner}
     * @memberof LiveStreamCreateInput
     */
    liveStream: LiveStreamCreateInputInner;
}

/**
 * Check if a given object implements the LiveStreamCreateInput interface.
 */
export function instanceOfLiveStreamCreateInput(value: object): boolean {
    let isInstance = true;
...
export function LiveStreamCreateInputFromJSON(json: any): LiveStreamCreateInput {
    return LiveStreamCreateInputFromJSONTyped(json, false);
}

export function LiveStreamCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamCreateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'liveStream': LiveStreamCreateInputInnerFromJSON(json['live_stream']),
    };
}

export function LiveStreamCreateInputToJSON(value?: LiveStreamCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'live_stream': LiveStreamCreateInputInnerToJSON(value.liveStream),
    };
}
