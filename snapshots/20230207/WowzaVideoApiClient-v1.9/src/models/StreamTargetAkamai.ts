...
import type { StreamTargetAkamaiPlaybackUrls } from './StreamTargetAkamaiPlaybackUrls';
import {
    StreamTargetAkamaiPlaybackUrlsFromJSON,
    StreamTargetAkamaiPlaybackUrlsFromJSONTyped,
    StreamTargetAkamaiPlaybackUrlsToJSON,
} from './StreamTargetAkamaiPlaybackUrls';

/**
 * 
 * @export
 * @interface StreamTargetAkamai
 */
export interface StreamTargetAkamai {
    /**
     * The backup RTMP ingest URL of the Wowza Stream Target. Not for use with the akamai_cupertino custom *provider*.
...
**Note:** When both the primary and backup URLs are used, Wowza Video sends the stream to both URLs, allowing a provider or 3rd party CDN to improve reliability and prevent playback disruption. If you want to use both URLs, make sure you add the stream target to the output rendition twice, once with *use_stream_target_backup_url* as **false** (the default) and once with *use_stream_target_backup_url* as **true**. See <a href="https://api.docs.video.wowza.com/index/current/tag/transcoders/#tag/transcoders/operation/createTranscoderOutputOutputStreamTarget">POST /transcoders/[ID]/outputs/[ID]/output_stream_targets</a> for more information.
    ...
    id?: string;
    /**
     * Choose a location as close as possible to your video source. Not for use with the akamai_cupertino custom *provider*.
     * @type {string}
     * @memberof StreamTargetAkamai
     */
    location?: StreamTargetAkamaiLocationEnum;
    /**
    ...
    /**
     * 
     * @type {StreamTargetAkamaiPlaybackUrls}
     * @memberof StreamTargetAkamai
     */
    playbackUrls?: StreamTargetAkamaiPlaybackUrls;
    /**
    ...
    updatedAt?: Date;
    /**
     * Only for Wowza custom stream targets whose *provider* is **akamai_cupertino**. CORS, or cross-origin resource sharing, allows streams to be safely delivered across domains.
     * @type {boolean}
     * @memberof StreamTargetAkamai
     */
    useCors?: boolean;
    /**
     * Only for Wowza custom stream targets whose *provider* is **akamai_cupertino**. If **true**, generates a *secure_ingest_query_param* to securely deliver the stream from the transcoder to the provider.
     * @type {boolean}
     * @memberof StreamTargetAkamai
     */
    useSecureIngest?: boolean;
}
 ...
 * @export
 */
export const StreamTargetAkamaiLocationEnum = {
...
export type StreamTargetAkamaiLocationEnum = typeof StreamTargetAkamaiLocationEnum[keyof typeof StreamTargetAkamaiLocationEnum];


/**
 * Check if a given object implements the StreamTargetAkamai interface.
 */
export function instanceOfStreamTargetAkamai(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetAkamaiFromJSON(json: any): StreamTargetAkamai {
    return StreamTargetAkamaiFromJSONTyped(json, false);
}

export function StreamTargetAkamaiFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetAkamai {
    ...
    return {
        ...
        'playbackUrls': !exists(json, 'playback_urls') ? undefined : StreamTargetAkamaiPlaybackUrlsFromJSON(json['playback_urls']),
        'primaryUrl': !exists(json, 'primary_url') ? undefined : json['primary_url'],
        'provider': !exists(json, 'provider') ? undefined : json['provider'],
        'secureIngestQueryParam': !exists(json, 'secure_ingest_query_param') ? undefined : json['secure_ingest_query_param'],
        'streamName': !exists(json, 'stream_name') ? undefined : json['stream_name'],
        'updatedAt': !exists(json, 'updated_at') ? undefined : (new Date(json['updated_at'])),
        'useCors': !exists(json, 'use_cors') ? undefined : json['use_cors'],
        'useSecureIngest': !exists(json, 'use_secure_ingest') ? undefined : json['use_secure_ingest'],
    };
}

export function StreamTargetAkamaiToJSON(value?: StreamTargetAkamai | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'name': value.name,
        'playback_urls': StreamTargetAkamaiPlaybackUrlsToJSON(value.playbackUrls),
        'primary_url': value.primaryUrl,
        'provider': value.provider,
        'secure_ingest_query_param': value.secureIngestQueryParam,
        'stream_name': value.streamName,
        'updated_at': value.updatedAt === undefined ? undefined : (value.updatedAt.toISOString()),
        'use_cors': value.useCors,
        'use_secure_ingest': value.useSecureIngest,
    };
}
