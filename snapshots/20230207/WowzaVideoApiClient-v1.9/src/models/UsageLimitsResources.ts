...
/**
 * The resources represented in the response.
 * @export
 * @interface UsageLimitsResources
 */
export interface UsageLimitsResources {
    /**
     * The response includes transcoders.
     * @type {string}
     * @memberof UsageLimitsResources
     */
    transcoders?: string;
    /**
     * The response includes VOD streams.
     * @type {string}
     * @memberof UsageLimitsResources
     */
    vodStreams?: string;
...
/**
 * Check if a given object implements the UsageLimitsResources interface.
 */
export function instanceOfUsageLimitsResources(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageLimitsResourcesFromJSON(json: any): UsageLimitsResources {
    return UsageLimitsResourcesFromJSONTyped(json, false);
}

export function UsageLimitsResourcesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageLimitsResources {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoders': !exists(json, 'transcoders') ? undefined : json['transcoders'],
        'vodStreams': !exists(json, 'vod_streams') ? undefined : json['vod_streams'],
    };
}

export function UsageLimitsResourcesToJSON(value?: UsageLimitsResources | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoders': value.transcoders,
        'vod_streams': value.vodStreams,
    };
}
