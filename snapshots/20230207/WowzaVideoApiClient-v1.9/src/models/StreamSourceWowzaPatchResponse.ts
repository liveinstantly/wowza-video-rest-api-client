 ...
 * 
 * @export
 * @interface StreamSourceWowzaPatchResponse
 */
export interface StreamSourceWowzaPatchResponse {
    /**
     * The date and time that the Wowza stream source was created.
     * @type {Date}
     * @memberof StreamSourceWowzaPatchResponse
     */
    createdAt?: Date;
    /**
     ...
     * @memberof StreamSourceWowzaPatchResponse
     */
    state?: StreamSourceWowzaPatchResponseStateEnum;
    /**
 ...
 * @export
 */
export const StreamSourceWowzaPatchResponseStateEnum = {
    Started: 'started',
    Stopped: 'stopped',
    Error: 'error'
} as const;
export type StreamSourceWowzaPatchResponseStateEnum = typeof StreamSourceWowzaPatchResponseStateEnum[keyof typeof StreamSourceWowzaPatchResponseStateEnum];


/**
 * Check if a given object implements the StreamSourceWowzaPatchResponse interface.
 */
export function instanceOfStreamSourceWowzaPatchResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamSourceWowzaPatchResponseFromJSON(json: any): StreamSourceWowzaPatchResponse {
    return StreamSourceWowzaPatchResponseFromJSONTyped(json, false);
}

export function StreamSourceWowzaPatchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamSourceWowzaPatchResponse {
...
export function StreamSourceWowzaPatchResponseToJSON(value?: StreamSourceWowzaPatchResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
