 ...
 * 
 * @export
 * @interface StreamTargetFastlyUpdateInputInner
 */
export interface StreamTargetFastlyUpdateInputInner {
    /**
     * A descriptive name for the stream target. Maximum 255 characters.

**Example:** <code>"name": "My Updated Fastly Stream Target"</code>
     * @type {string}
     * @memberof StreamTargetFastlyUpdateInputInner
     */
    name?: string;
    /**
...
**Example:** See response body sample
     ...
     * @memberof StreamTargetFastlyUpdateInputInner
     */
    deliveryProtocols?: Array<StreamTargetFastlyUpdateInputInnerDeliveryProtocolsEnum>;
    /**
...
**Example:** <code>"geoblock_location": "allow"</code>
     ...
     * @memberof StreamTargetFastlyUpdateInputInner
     */
    geoblockByLocation?: StreamTargetFastlyUpdateInputInnerGeoblockByLocationEnum;
    /**
...
**Example:** <code>"geoblock_ip_override": "allow"</code>
     ...
     * @memberof StreamTargetFastlyUpdateInputInner
     */
    geoblockIpOverride?: StreamTargetFastlyUpdateInputInnerGeoblockIpOverrideEnum;
    /**
...
**Example:** <code>"referer_policy": "allow"</code>
     ...
     * @memberof StreamTargetFastlyUpdateInputInner
     */
    refererPolicy?: StreamTargetFastlyUpdateInputInnerRefererPolicyEnum;
    /**
 ...
 * @export
 */
export const StreamTargetFastlyUpdateInputInnerDeliveryProtocolsEnum = {
    Dash: 'dash',
    Hls: 'hls'
} as const;
export type StreamTargetFastlyUpdateInputInnerDeliveryProtocolsEnum = typeof StreamTargetFastlyUpdateInputInnerDeliveryProtocolsEnum[keyof typeof StreamTargetFastlyUpdateInputInnerDeliveryProtocolsEnum];

/**
 * @export
 */
export const StreamTargetFastlyUpdateInputInnerGeoblockByLocationEnum = {
    Allow: 'allow',
    Deny: 'deny',
    Disabled: 'disabled'
} as const;
export type StreamTargetFastlyUpdateInputInnerGeoblockByLocationEnum = typeof StreamTargetFastlyUpdateInputInnerGeoblockByLocationEnum[keyof typeof StreamTargetFastlyUpdateInputInnerGeoblockByLocationEnum];

/**
 * @export
 */
export const StreamTargetFastlyUpdateInputInnerGeoblockIpOverrideEnum = {
    Allow: 'allow',
    Deny: 'deny',
    Disabled: 'disabled'
} as const;
export type StreamTargetFastlyUpdateInputInnerGeoblockIpOverrideEnum = typeof StreamTargetFastlyUpdateInputInnerGeoblockIpOverrideEnum[keyof typeof StreamTargetFastlyUpdateInputInnerGeoblockIpOverrideEnum];

/**
 * @export
 */
export const StreamTargetFastlyUpdateInputInnerRefererPolicyEnum = {
    Allow: 'allow',
    Deny: 'deny'
} as const;
export type StreamTargetFastlyUpdateInputInnerRefererPolicyEnum = typeof StreamTargetFastlyUpdateInputInnerRefererPolicyEnum[keyof typeof StreamTargetFastlyUpdateInputInnerRefererPolicyEnum];


/**
 * Check if a given object implements the StreamTargetFastlyUpdateInputInner interface.
 */
export function instanceOfStreamTargetFastlyUpdateInputInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetFastlyUpdateInputInnerFromJSON(json: any): StreamTargetFastlyUpdateInputInner {
    return StreamTargetFastlyUpdateInputInnerFromJSONTyped(json, false);
}

export function StreamTargetFastlyUpdateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetFastlyUpdateInputInner {
...
export function StreamTargetFastlyUpdateInputInnerToJSON(value?: StreamTargetFastlyUpdateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
