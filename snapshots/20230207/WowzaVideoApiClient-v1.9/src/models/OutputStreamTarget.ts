...
import type { IndexStreamTarget } from './IndexStreamTarget';
import {
    IndexStreamTargetFromJSON,
    IndexStreamTargetFromJSONTyped,
    IndexStreamTargetToJSON,
} from './IndexStreamTarget';
 ...
 */
export interface OutputStreamTarget {
    /**
     * The date and time that the output stream target was created.
     * @type {Date}
     * @memberof OutputStreamTarget
     */
    createdAt?: Date;
    /**
    ...
    /**
     * 
     * @type {IndexStreamTarget}
     * @memberof OutputStreamTarget
     */
    streamTarget?: IndexStreamTarget;
    /**
     ...
     * @memberof OutputStreamTarget
     */
    useStreamTargetBackupUrl?: boolean;
}

/**
 * Check if a given object implements the OutputStreamTarget interface.
 */
export function instanceOfOutputStreamTarget(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OutputStreamTargetFromJSON(json: any): OutputStreamTarget {
    return OutputStreamTargetFromJSONTyped(json, false);
}

export function OutputStreamTargetFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutputStreamTarget {
    ...
    return {
        ...
        'streamTarget': !exists(json, 'stream_target') ? undefined : IndexStreamTargetFromJSON(json['stream_target']),
        'streamTargetId': !exists(json, 'stream_target_id') ? undefined : json['stream_target_id'],
        'updatedAt': !exists(json, 'updated_at') ? undefined : (new Date(json['updated_at'])),
        'useStreamTargetBackupUrl': !exists(json, 'use_stream_target_backup_url') ? undefined : json['use_stream_target_backup_url'],
    };
}

export function OutputStreamTargetToJSON(value?: OutputStreamTarget | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'id': value.id,
        'stream_target': IndexStreamTargetToJSON(value.streamTarget),
        'stream_target_id': value.streamTargetId,
        'updated_at': value.updatedAt === undefined ? undefined : (value.updatedAt.toISOString()),
        'use_stream_target_backup_url': value.useStreamTargetBackupUrl,
    };
}
