...
import type { TranscoderControlState } from './TranscoderControlState';
import {
    TranscoderControlStateFromJSON,
    TranscoderControlStateFromJSONTyped,
    TranscoderControlStateToJSON,
} from './TranscoderControlState';

/**
 * 
 * @export
 * @interface TranscoderControlResponse
 */
export interface TranscoderControlResponse {
    /**
     * 
     * @type {TranscoderControlState}
     * @memberof TranscoderControlResponse
     */
    transcoder: TranscoderControlState;
}

/**
 * Check if a given object implements the TranscoderControlResponse interface.
 */
export function instanceOfTranscoderControlResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderControlResponseFromJSON(json: any): TranscoderControlResponse {
    return TranscoderControlResponseFromJSONTyped(json, false);
}

export function TranscoderControlResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderControlResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': TranscoderControlStateFromJSON(json['transcoder']),
    };
}

export function TranscoderControlResponseToJSON(value?: TranscoderControlResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': TranscoderControlStateToJSON(value.transcoder),
    };
}
