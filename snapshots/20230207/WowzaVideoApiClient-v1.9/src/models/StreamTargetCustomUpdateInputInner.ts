 ...
 * 
 * @export
 * @interface StreamTargetCustomUpdateInputInner
 */
export interface StreamTargetCustomUpdateInputInner {
    /**
...
**Example:** <code>"backup_url": "rtmp://b.ep337857.i.akamaientrypoint.net/EntryPoint"</code>
     * @type {string}
     * @memberof StreamTargetCustomUpdateInputInner
     */
    backupUrl?: string;
    /**
...
**Example:** <code>"provider": "akamai_cupertino"</code>
     ...
     * @memberof StreamTargetCustomUpdateInputInner
     */
    provider?: StreamTargetCustomUpdateInputInnerProviderEnum;
    /**
 ...
 * @export
 */
export const StreamTargetCustomUpdateInputInnerProviderEnum = {
    AkamaiCupertino: 'akamai_cupertino',
    Rtmp: 'rtmp',
    Rtmps: 'rtmps'
} as const;
export type StreamTargetCustomUpdateInputInnerProviderEnum = typeof StreamTargetCustomUpdateInputInnerProviderEnum[keyof typeof StreamTargetCustomUpdateInputInnerProviderEnum];


/**
 * Check if a given object implements the StreamTargetCustomUpdateInputInner interface.
 */
export function instanceOfStreamTargetCustomUpdateInputInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetCustomUpdateInputInnerFromJSON(json: any): StreamTargetCustomUpdateInputInner {
    return StreamTargetCustomUpdateInputInnerFromJSONTyped(json, false);
}

export function StreamTargetCustomUpdateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetCustomUpdateInputInner {
...
export function StreamTargetCustomUpdateInputInnerToJSON(value?: StreamTargetCustomUpdateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
