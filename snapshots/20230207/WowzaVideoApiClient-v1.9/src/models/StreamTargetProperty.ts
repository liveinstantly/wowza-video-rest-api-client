 ...
 * @export
 * @interface StreamTargetProperty
 */
export interface StreamTargetProperty {
    /**
...
**relativePlaylists** | Allows the viewer to watch the stream over HTTP and HTTPS, whichever protocol their browser calls. <br/><br/>**Available on these targets types:** Wowza CDN on Fastly, Custom: akamai_cupertino
     * @type {string}
     * @memberof StreamTargetProperty
     */
    key: StreamTargetPropertyKeyEnum;
    /**
...
**playlist** | **playSSL**, **playlistSeconds**, **redundantChunklists**, and **relativePlaylists**
     ...
     * @memberof StreamTargetProperty
     */
    section: StreamTargetPropertySectionEnum;
    /**
     * 
 ...
 * @export
 */
export const StreamTargetPropertyKeyEnum = {
    Acao: 'acao',
    ChunkSize: 'chunkSize',
...
export type StreamTargetPropertyKeyEnum = typeof StreamTargetPropertyKeyEnum[keyof typeof StreamTargetPropertyKeyEnum];

/**
 * @export
 */
export const StreamTargetPropertySectionEnum = {
    Hls: 'hls',
    Playlist: 'playlist'
} as const;
export type StreamTargetPropertySectionEnum = typeof StreamTargetPropertySectionEnum[keyof typeof StreamTargetPropertySectionEnum];


/**
 * Check if a given object implements the StreamTargetProperty interface.
 */
export function instanceOfStreamTargetProperty(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetPropertyFromJSON(json: any): StreamTargetProperty {
    return StreamTargetPropertyFromJSONTyped(json, false);
}

export function StreamTargetPropertyFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetProperty {
...
export function StreamTargetPropertyToJSON(value?: StreamTargetProperty | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
