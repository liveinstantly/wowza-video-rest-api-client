...
import {
    ...
    instanceOfStreamTargetPropertiesCreateInputResponse,
    StreamTargetPropertiesCreateInputResponseFromJSON,
    StreamTargetPropertiesCreateInputResponseFromJSONTyped,
    StreamTargetPropertiesCreateInputResponseToJSON,
} from './StreamTargetPropertiesCreateInputResponse';
import {
    StreamTargetPropertyCreateInputRepsonse,
    instanceOfStreamTargetPropertyCreateInputRepsonse,
    StreamTargetPropertyCreateInputRepsonseFromJSON,
    StreamTargetPropertyCreateInputRepsonseFromJSONTyped,
    StreamTargetPropertyCreateInputRepsonseToJSON,
} from './StreamTargetPropertyCreateInputRepsonse';

/**
 * @type StreamTargetPropertyCreateResponse
 * 
 * @export
 */
export type StreamTargetPropertyCreateResponse = StreamTargetPropertiesCreateInputResponse | StreamTargetPropertyCreateInputRepsonse;

export function StreamTargetPropertyCreateResponseFromJSON(json: any): StreamTargetPropertyCreateResponse {
    return StreamTargetPropertyCreateResponseFromJSONTyped(json, false);
}

export function StreamTargetPropertyCreateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetPropertyCreateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...StreamTargetPropertiesCreateInputResponseFromJSONTyped(json, true), ...StreamTargetPropertyCreateInputRepsonseFromJSONTyped(json, true) };
}

export function StreamTargetPropertyCreateResponseToJSON(value?: StreamTargetPropertyCreateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfStreamTargetPropertiesCreateInputResponse(value)) {
        return StreamTargetPropertiesCreateInputResponseToJSON(value as StreamTargetPropertiesCreateInputResponse);
    }
    if (instanceOfStreamTargetPropertyCreateInputRepsonse(value)) {
        return StreamTargetPropertyCreateInputRepsonseToJSON(value as StreamTargetPropertyCreateInputRepsonse);
    }
