...
/**
 * Check if a given object implements the Renditions interface.
 */
export function instanceOfRenditions(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RenditionsFromJSON(json: any): Renditions {
    return RenditionsFromJSONTyped(json, false);
}

export function RenditionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Renditions {
    ...
    return {
        ...
        'bitrateKbps': !exists(json, 'bitrate_kbps') ? undefined : json['bitrate_kbps'],
    };
}

export function RenditionsToJSON(value?: Renditions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'height': value.height,
        'width': value.width,
        'bitrate_kbps': value.bitrateKbps,
    };
}
