...
import type { VodStreamUpdateInputInner } from './VodStreamUpdateInputInner';
import {
    VodStreamUpdateInputInnerFromJSON,
    VodStreamUpdateInputInnerFromJSONTyped,
    VodStreamUpdateInputInnerToJSON,
} from './VodStreamUpdateInputInner';

/**
 * 
 * @export
 * @interface VodStreamUpdateInput
 */
export interface VodStreamUpdateInput {
    /**
     * 
     * @type {VodStreamUpdateInputInner}
     * @memberof VodStreamUpdateInput
     */
    vodStream: VodStreamUpdateInputInner;
}

/**
 * Check if a given object implements the VodStreamUpdateInput interface.
 */
export function instanceOfVodStreamUpdateInput(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "vodStream" in value;

    return isInstance;
}

export function VodStreamUpdateInputFromJSON(json: any): VodStreamUpdateInput {
    return VodStreamUpdateInputFromJSONTyped(json, false);
}

export function VodStreamUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): VodStreamUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'vodStream': VodStreamUpdateInputInnerFromJSON(json['vod_stream']),
    };
}

export function VodStreamUpdateInputToJSON(value?: VodStreamUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'vod_stream': VodStreamUpdateInputInnerToJSON(value.vodStream),
    };
}
