...
import type { StreamTargetCustomPatchResponse } from './StreamTargetCustomPatchResponse';
import {
    StreamTargetCustomPatchResponseFromJSON,
    StreamTargetCustomPatchResponseFromJSONTyped,
    StreamTargetCustomPatchResponseToJSON,
} from './StreamTargetCustomPatchResponse';

/**
 * 
 * @export
 * @interface StreamTargetCustomResponse
 */
export interface StreamTargetCustomResponse {
    /**
     * 
     * @type {StreamTargetCustomPatchResponse}
     * @memberof StreamTargetCustomResponse
     */
    streamTargetCustom?: StreamTargetCustomPatchResponse;
}

/**
 * Check if a given object implements the StreamTargetCustomResponse interface.
 */
export function instanceOfStreamTargetCustomResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetCustomResponseFromJSON(json: any): StreamTargetCustomResponse {
    return StreamTargetCustomResponseFromJSONTyped(json, false);
}

export function StreamTargetCustomResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetCustomResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetCustom': !exists(json, 'stream_target_custom') ? undefined : StreamTargetCustomPatchResponseFromJSON(json['stream_target_custom']),
    };
}

export function StreamTargetCustomResponseToJSON(value?: StreamTargetCustomResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target_custom': StreamTargetCustomPatchResponseToJSON(value.streamTargetCustom),
    };
}
