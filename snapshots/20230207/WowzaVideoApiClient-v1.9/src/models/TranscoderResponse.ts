...
export interface TranscoderResponse {
     ...
     * 
     * @type {Transcoder}
     * @memberof TranscoderResponse
     */
    transcoder: Transcoder;
}

/**
 * Check if a given object implements the TranscoderResponse interface.
 */
export function instanceOfTranscoderResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderResponseFromJSON(json: any): TranscoderResponse {
    return TranscoderResponseFromJSONTyped(json, false);
}

export function TranscoderResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': TranscoderFromJSON(json['transcoder']),
    };
}

export function TranscoderResponseToJSON(value?: TranscoderResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': TranscoderToJSON(value.transcoder),
    };
}
