 ...
 * 
 * @export
 * @interface VideoCodecMetric
 */
export interface VideoCodecMetric {
    /**
...
/**
 * Check if a given object implements the VideoCodecMetric interface.
 */
export function instanceOfVideoCodecMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VideoCodecMetricFromJSON(json: any): VideoCodecMetric {
    return VideoCodecMetricFromJSONTyped(json, false);
}

export function VideoCodecMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): VideoCodecMetric {
...
export function VideoCodecMetricToJSON(value?: VideoCodecMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
