 ...
 * 
 * @export
 * @interface LiveStreamConnectionCode
 */
export interface LiveStreamConnectionCode {
     ...
     * @type {string}
     * @memberof LiveStreamConnectionCode
     */
    connectionCode?: string;
}

/**
 * Check if a given object implements the LiveStreamConnectionCode interface.
 */
export function instanceOfLiveStreamConnectionCode(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LiveStreamConnectionCodeFromJSON(json: any): LiveStreamConnectionCode {
    return LiveStreamConnectionCodeFromJSONTyped(json, false);
}

export function LiveStreamConnectionCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamConnectionCode {
...
export function LiveStreamConnectionCodeToJSON(value?: LiveStreamConnectionCode | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
