...
import {
    TranscoderPropertiesCreateInput,
    instanceOfTranscoderPropertiesCreateInput,
    TranscoderPropertiesCreateInputFromJSON,
    TranscoderPropertiesCreateInputFromJSONTyped,
    TranscoderPropertiesCreateInputToJSON,
} from './TranscoderPropertiesCreateInput';
import {
    TranscoderPropertyCreateInput,
    instanceOfTranscoderPropertyCreateInput,
    TranscoderPropertyCreateInputFromJSON,
    TranscoderPropertyCreateInputFromJSONTyped,
    TranscoderPropertyCreateInputToJSON,
} from './TranscoderPropertyCreateInput';

/**
 * @type TranscoderPropertyCreateRequest
 * 
 * @export
 */
export type TranscoderPropertyCreateRequest = TranscoderPropertiesCreateInput | TranscoderPropertyCreateInput;

export function TranscoderPropertyCreateRequestFromJSON(json: any): TranscoderPropertyCreateRequest {
    return TranscoderPropertyCreateRequestFromJSONTyped(json, false);
}

export function TranscoderPropertyCreateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderPropertyCreateRequest {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...TranscoderPropertiesCreateInputFromJSONTyped(json, true), ...TranscoderPropertyCreateInputFromJSONTyped(json, true) };
}

export function TranscoderPropertyCreateRequestToJSON(value?: TranscoderPropertyCreateRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfTranscoderPropertiesCreateInput(value)) {
        return TranscoderPropertiesCreateInputToJSON(value as TranscoderPropertiesCreateInput);
    }
    if (instanceOfTranscoderPropertyCreateInput(value)) {
        return TranscoderPropertyCreateInputToJSON(value as TranscoderPropertyCreateInput);
    }
