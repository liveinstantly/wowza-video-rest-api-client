 ...
 * @export
 * @interface UniqueViewsMetric
 */
export interface UniqueViewsMetric {
    /**
...
/**
 * Check if a given object implements the UniqueViewsMetric interface.
 */
export function instanceOfUniqueViewsMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UniqueViewsMetricFromJSON(json: any): UniqueViewsMetric {
    return UniqueViewsMetricFromJSONTyped(json, false);
}

export function UniqueViewsMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): UniqueViewsMetric {
...
export function UniqueViewsMetricToJSON(value?: UniqueViewsMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
