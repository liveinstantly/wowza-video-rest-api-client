 ...
 * 
 * @export
 * @interface StreamTargetConnectionCode
 */
export interface StreamTargetConnectionCode {
    /**
     ...
     * @type {string}
     * @memberof StreamTargetConnectionCode
     */
    connectionCode?: string;
}

/**
 * Check if a given object implements the StreamTargetConnectionCode interface.
 */
export function instanceOfStreamTargetConnectionCode(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetConnectionCodeFromJSON(json: any): StreamTargetConnectionCode {
    return StreamTargetConnectionCodeFromJSONTyped(json, false);
}

export function StreamTargetConnectionCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetConnectionCode {
...
export function StreamTargetConnectionCodeToJSON(value?: StreamTargetConnectionCode | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
