 ...
 * @export
 * @interface UsageViewersDataPerAccount
 */
export interface UsageViewersDataPerAccount {
    /**
     ...
     * @type {number}
     * @memberof UsageViewersDataPerAccount
     */
    ...
    viewingBytes?: number;
    /**
     * The length of time, in seconds, that Wowza CDN on Fastly pulled from storage during the selected time frame.
     * @type {number}
     * @memberof UsageViewersDataPerAccount
     */
...
/**
 * Check if a given object implements the UsageViewersDataPerAccount interface.
 */
export function instanceOfUsageViewersDataPerAccount(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataPerAccountFromJSON(json: any): UsageViewersDataPerAccount {
    return UsageViewersDataPerAccountFromJSONTyped(json, false);
}

export function UsageViewersDataPerAccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataPerAccount {
...
export function UsageViewersDataPerAccountToJSON(value?: UsageViewersDataPerAccount | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
