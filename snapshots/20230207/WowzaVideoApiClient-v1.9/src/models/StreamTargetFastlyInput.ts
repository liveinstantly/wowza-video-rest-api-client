...
import type { StreamTargetFastlyInputInner } from './StreamTargetFastlyInputInner';
import {
    StreamTargetFastlyInputInnerFromJSON,
    StreamTargetFastlyInputInnerFromJSONTyped,
    StreamTargetFastlyInputInnerToJSON,
} from './StreamTargetFastlyInputInner';

/**
 * 
 * @export
 * @interface StreamTargetFastlyInput
 */
export interface StreamTargetFastlyInput {
    /**
     * 
     * @type {StreamTargetFastlyInputInner}
     * @memberof StreamTargetFastlyInput
     */
    streamTargetFastly: StreamTargetFastlyInputInner;
}

/**
 * Check if a given object implements the StreamTargetFastlyInput interface.
 */
export function instanceOfStreamTargetFastlyInput(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetFastlyInputFromJSON(json: any): StreamTargetFastlyInput {
    return StreamTargetFastlyInputFromJSONTyped(json, false);
}

export function StreamTargetFastlyInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetFastlyInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetFastly': StreamTargetFastlyInputInnerFromJSON(json['stream_target_fastly']),
    };
}

export function StreamTargetFastlyInputToJSON(value?: StreamTargetFastlyInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target_fastly': StreamTargetFastlyInputInnerToJSON(value.streamTargetFastly),
    };
}
