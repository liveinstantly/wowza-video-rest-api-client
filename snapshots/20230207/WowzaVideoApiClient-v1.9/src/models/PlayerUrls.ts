...
export interface PlayerUrls {
    /**
     * 
     * @type {Array<PlayerUrl>}
     * @memberof PlayerUrls
     */
    urls: Array<PlayerUrl>;
}

/**
 * Check if a given object implements the PlayerUrls interface.
 */
export function instanceOfPlayerUrls(value: object): boolean {
    let isInstance = true;
...
export function PlayerUrlsFromJSON(json: any): PlayerUrls {
    return PlayerUrlsFromJSONTyped(json, false);
}

export function PlayerUrlsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerUrls {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'urls': ((json['urls'] as Array<any>).map(PlayerUrlFromJSON)),
    };
}

export function PlayerUrlsToJSON(value?: PlayerUrls | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'urls': ((value.urls as Array<any>).map(PlayerUrlToJSON)),
    };
}
