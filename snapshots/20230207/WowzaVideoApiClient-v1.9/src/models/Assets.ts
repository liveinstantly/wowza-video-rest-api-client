...
import type { IndexAsset } from './IndexAsset';
import {
    IndexAssetFromJSON,
    IndexAssetFromJSONTyped,
    IndexAssetToJSON,
} from './IndexAsset';
...
export function AssetsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Assets {
    ...
    return {
        ...
        'assets': ((json['assets'] as Array<any>).map(IndexAssetFromJSON)),
    };
}
...
export function AssetsToJSON(value?: Assets | null): any {
    ...
    return {
        ...
        'assets': ((value.assets as Array<any>).map(IndexAssetToJSON)),
    };
}
