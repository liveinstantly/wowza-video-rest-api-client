 ...
 * 
 * @export
 * @interface ScheduleStateResponse
 */
export interface ScheduleStateResponse {
    /**
     * 
     * @type {ScheduleState}
     * @memberof ScheduleStateResponse
     */
    schedule: ScheduleState;
}

/**
 * Check if a given object implements the ScheduleStateResponse interface.
 */
export function instanceOfScheduleStateResponse(value: object): boolean {
    let isInstance = true;
...
export function ScheduleStateResponseFromJSON(json: any): ScheduleStateResponse {
    return ScheduleStateResponseFromJSONTyped(json, false);
}

export function ScheduleStateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScheduleStateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'schedule': ScheduleStateFromJSON(json['schedule']),
    };
}

export function ScheduleStateResponseToJSON(value?: ScheduleStateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'schedule': ScheduleStateToJSON(value.schedule),
    };
}
