...
import type { UsageVodStreamEgressSummaryData } from './UsageVodStreamEgressSummaryData';
import {
    UsageVodStreamEgressSummaryDataFromJSON,
    UsageVodStreamEgressSummaryDataFromJSONTyped,
    UsageVodStreamEgressSummaryDataToJSON,
} from './UsageVodStreamEgressSummaryData';

/**
 * 
 * @export
 * @interface UsageVodStreamEgressSummary
 */
export interface UsageVodStreamEgressSummary {
    /**
     * 
     * @type {UsageVodStreamEgressSummaryData}
     * @memberof UsageVodStreamEgressSummary
     */
    summary?: UsageVodStreamEgressSummaryData;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageVodStreamEgressSummary
...
/**
 * Check if a given object implements the UsageVodStreamEgressSummary interface.
 */
export function instanceOfUsageVodStreamEgressSummary(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamEgressSummaryFromJSON(json: any): UsageVodStreamEgressSummary {
    return UsageVodStreamEgressSummaryFromJSONTyped(json, false);
}

export function UsageVodStreamEgressSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamEgressSummary {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'summary': !exists(json, 'summary') ? undefined : UsageVodStreamEgressSummaryDataFromJSON(json['summary']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageVodStreamEgressSummaryToJSON(value?: UsageVodStreamEgressSummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'summary': UsageVodStreamEgressSummaryDataToJSON(value.summary),
