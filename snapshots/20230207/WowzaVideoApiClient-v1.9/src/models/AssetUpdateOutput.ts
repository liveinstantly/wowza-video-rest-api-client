...
import type { Renditions } from './Renditions';
import {
    RenditionsFromJSON,
    RenditionsFromJSONTyped,
    RenditionsToJSON,
} from './Renditions';
 ...
 * 
 * @export
 * @interface AssetUpdateOutput
 */
export interface AssetUpdateOutput {
    /**
     * The renditions available for the asset.
     * @type {Array<Renditions>}
     * @memberof AssetUpdateOutput
     */
    availableRenditions?: Array<Renditions>;
    /**
     ...
     * @memberof AssetUpdateOutput
     */
    state?: AssetUpdateOutputStateEnum;
    /**
 ...
 * @export
 */
export const AssetUpdateOutputStateEnum = {
    Uploading: 'uploading',
    Processing: 'processing',
    Completed: 'completed',
    Failed: 'failed'
} as const;
export type AssetUpdateOutputStateEnum = typeof AssetUpdateOutputStateEnum[keyof typeof AssetUpdateOutputStateEnum];


/**
 * Check if a given object implements the AssetUpdateOutput interface.
 */
export function instanceOfAssetUpdateOutput(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AssetUpdateOutputFromJSON(json: any): AssetUpdateOutput {
    return AssetUpdateOutputFromJSONTyped(json, false);
}

export function AssetUpdateOutputFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetUpdateOutput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'availableRenditions': !exists(json, 'available_renditions') ? undefined : ((json['available_renditions'] as Array<any>).map(RenditionsFromJSON)),
        'id': !exists(json, 'id') ? undefined : json['id'],
        'name': !exists(json, 'name') ? undefined : json['name'],
        'description': !exists(json, 'description') ? undefined : json['description'],
        'playbackEnabled': !exists(json, 'playback_enabled') ? undefined : json['playback_enabled'],
        'tags': !exists(json, 'tags') ? undefined : json['tags'],
        'vodStreamId': !exists(json, 'vod_stream_id') ? undefined : json['vod_stream_id'],
        ...
        'totalViewingTime': !exists(json, 'total_viewing_time') ? undefined : json['total_viewing_time'],
        ...
        'totalStorageSize': !exists(json, 'total_storage_size') ? undefined : json['total_storage_size'],
...
export function AssetUpdateOutputToJSON(value?: AssetUpdateOutput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'available_renditions': value.availableRenditions === undefined ? undefined : ((value.availableRenditions as Array<any>).map(RenditionsToJSON)),
        'id': value.id,
        'name': value.name,
        'description': value.description,
        'playback_enabled': value.playbackEnabled,
        'tags': value.tags,
        'vod_stream_id': value.vodStreamId,
        ...
        'total_viewing_time': value.totalViewingTime,
        'average_view_time': value.averageViewTime,
        'playback_url': value.playbackUrl,
        'total_storage_size': value.totalStorageSize,
