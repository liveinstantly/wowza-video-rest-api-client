 ...
 * @export
 */
export const BroadcastLocation = {
...
export type BroadcastLocation = typeof BroadcastLocation[keyof typeof BroadcastLocation];


export function BroadcastLocationFromJSON(json: any): BroadcastLocation {
    return BroadcastLocationFromJSONTyped(json, false);
}

export function BroadcastLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): BroadcastLocation {
    return json as BroadcastLocation;
}

export function BroadcastLocationToJSON(value?: BroadcastLocation | null): any {
    return value as any;
}
