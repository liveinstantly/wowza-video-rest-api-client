 ...
 * 
 * @export
 * @interface IndexRecordings
 */
export interface IndexRecordings {
    /**
     * The date and time that the recording was created.
     * @type {Date}
     * @memberof IndexRecordings
     */
    createdAt?: Date;
    /**
...
<blockquote><strong>Note:</strong> To avoid file management issues in storage, Wowza Video removes or replaces special characters in file names.</blockquote>
     ...
     * @memberof IndexRecordings
     */
    state?: IndexRecordingsStateEnum;
    /**
 ...
 * @export
 */
export const IndexRecordingsStateEnum = {
    Uploading: 'uploading',
...
export type IndexRecordingsStateEnum = typeof IndexRecordingsStateEnum[keyof typeof IndexRecordingsStateEnum];


/**
 * Check if a given object implements the IndexRecordings interface.
 */
export function instanceOfIndexRecordings(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexRecordingsFromJSON(json: any): IndexRecordings {
    return IndexRecordingsFromJSONTyped(json, false);
}

export function IndexRecordingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexRecordings {
...
export function IndexRecordingsToJSON(value?: IndexRecordings | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
