 ...
 * 
 * @export
 * @interface UsageRealTimeStreamData
 */
export interface UsageRealTimeStreamData {
    /**
     * The unique alphanumeric string that identifies the real time stream.
     * @type {string}
     * @memberof UsageRealTimeStreamData
     */
    id?: string;
    /**
    ...
    name?: string;
    /**
     * The amount of content, in bytes, that came from a video source in to Wowza Video during the selected time frame.
     * @type {number}
     * @memberof UsageRealTimeStreamData
     */
    bytesIn?: number;
    /**
     * The amount of content, in bytes, that went to a viewer during the selected time frame.
     * @type {number}
     * @memberof UsageRealTimeStreamData
     */
    bytesOut?: number;
...
/**
 * Check if a given object implements the UsageRealTimeStreamData interface.
 */
export function instanceOfUsageRealTimeStreamData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageRealTimeStreamDataFromJSON(json: any): UsageRealTimeStreamData {
    return UsageRealTimeStreamDataFromJSONTyped(json, false);
}

export function UsageRealTimeStreamDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageRealTimeStreamData {
    ...
    return {
        ...
        'bytesIn': !exists(json, 'bytes_in') ? undefined : json['bytes_in'],
        'bytesOut': !exists(json, 'bytes_out') ? undefined : json['bytes_out'],
    };
}

export function UsageRealTimeStreamDataToJSON(value?: UsageRealTimeStreamData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
