 ...
 * 
 * @export
 * @interface UsageEgressDataPerVodStream
 */
export interface UsageEgressDataPerVodStream {
    /**
     * The unique alphanumeric string that identifies the VOD stream.
     * @type {string}
     * @memberof UsageEgressDataPerVodStream
     */
    id?: string;
    /**
     ...
     * @memberof UsageEgressDataPerVodStream
     */
    type?: UsageEgressDataPerVodStreamTypeEnum;
    /**
 ...
 * @export
 */
export const UsageEgressDataPerVodStreamTypeEnum = {
    Fastly: 'fastly'
} as const;
export type UsageEgressDataPerVodStreamTypeEnum = typeof UsageEgressDataPerVodStreamTypeEnum[keyof typeof UsageEgressDataPerVodStreamTypeEnum];


/**
 * Check if a given object implements the UsageEgressDataPerVodStream interface.
 */
export function instanceOfUsageEgressDataPerVodStream(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageEgressDataPerVodStreamFromJSON(json: any): UsageEgressDataPerVodStream {
    return UsageEgressDataPerVodStreamFromJSONTyped(json, false);
}

export function UsageEgressDataPerVodStreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageEgressDataPerVodStream {
...
export function UsageEgressDataPerVodStreamToJSON(value?: UsageEgressDataPerVodStream | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
