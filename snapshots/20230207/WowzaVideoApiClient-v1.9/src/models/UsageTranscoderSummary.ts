...
import type { UsageTranscoderSummaryData } from './UsageTranscoderSummaryData';
import {
    UsageTranscoderSummaryDataFromJSON,
    UsageTranscoderSummaryDataFromJSONTyped,
    UsageTranscoderSummaryDataToJSON,
} from './UsageTranscoderSummaryData';

/**
 * 
 * @export
 * @interface UsageTranscoderSummary
 */
export interface UsageTranscoderSummary {
    /**
     * 
     * @type {UsageTranscoderSummaryData}
     * @memberof UsageTranscoderSummary
     */
    summary?: UsageTranscoderSummaryData;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageTranscoderSummary
...
/**
 * Check if a given object implements the UsageTranscoderSummary interface.
 */
export function instanceOfUsageTranscoderSummary(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageTranscoderSummaryFromJSON(json: any): UsageTranscoderSummary {
    return UsageTranscoderSummaryFromJSONTyped(json, false);
}

export function UsageTranscoderSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageTranscoderSummary {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'summary': !exists(json, 'summary') ? undefined : UsageTranscoderSummaryDataFromJSON(json['summary']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageTranscoderSummaryToJSON(value?: UsageTranscoderSummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'summary': UsageTranscoderSummaryDataToJSON(value.summary),
