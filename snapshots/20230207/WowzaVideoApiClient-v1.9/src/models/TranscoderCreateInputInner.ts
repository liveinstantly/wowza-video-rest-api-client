 ...
 * 
 * @export
 * @interface TranscoderCreateInputInner
 */
export interface TranscoderCreateInputInner {
    /**
     * The billing mode for the transcoder. The default is **pay_as_you_go**.
     * @type {string}
     * @memberof TranscoderCreateInputInner
     */
    billingMode: TranscoderCreateInputInnerBillingModeEnum;
    /**
     * The location where Wowza Video transcodes your stream. Choose a location as close as possible to your video source.
     * @type {string}
     * @memberof TranscoderCreateInputInner
     */
    broadcastLocation: TranscoderCreateInputInnerBroadcastLocationEnum;
    /**
     ...
     * @memberof TranscoderCreateInputInner
     */
    deliveryMethod: TranscoderCreateInputInnerDeliveryMethodEnum;
    /**
     ...
     * @memberof TranscoderCreateInputInner
     */
    protocol: TranscoderCreateInputInnerProtocolEnum;
    /**
     ...
     * @memberof TranscoderCreateInputInner
     */
    transcoderType: TranscoderCreateInputInnerTranscoderTypeEnum;
    /**
...
**Example:** <code>"buffer_size": 4000</code>
     ...
     * @memberof TranscoderCreateInputInner
     */
    bufferSize?: TranscoderCreateInputInnerBufferSizeEnum;
    /**
...
**Example:** <code>"closed_caption_type": "cea"</code>
     ...
     * @memberof TranscoderCreateInputInner
     */
    closedCaptionType?: TranscoderCreateInputInnerClosedCaptionTypeEnum;
    /**
...
**Example:** <code>"watermark_opacity": 75</code>
     ...
     * @memberof TranscoderCreateInputInner
     */
    watermarkOpacity?: TranscoderCreateInputInnerWatermarkOpacityEnum;
    /**
...
**Example:** <code>"watermark_position": "top-left"</code>
     ...
     * @memberof TranscoderCreateInputInner
     */
    watermarkPosition?: TranscoderCreateInputInnerWatermarkPositionEnum;
    /**
 ...
 * @export
 */
export const TranscoderCreateInputInnerBillingModeEnum = {
    PayAsYouGo: 'pay_as_you_go',
    TwentyfourSeven: 'twentyfour_seven'
} as const;
export type TranscoderCreateInputInnerBillingModeEnum = typeof TranscoderCreateInputInnerBillingModeEnum[keyof typeof TranscoderCreateInputInnerBillingModeEnum];

/**
 * @export
 */
export const TranscoderCreateInputInnerBroadcastLocationEnum = {
...
export type TranscoderCreateInputInnerBroadcastLocationEnum = typeof TranscoderCreateInputInnerBroadcastLocationEnum[keyof typeof TranscoderCreateInputInnerBroadcastLocationEnum];

/**
 * @export
 */
export const TranscoderCreateInputInnerDeliveryMethodEnum = {
    Pull: 'pull',
    Cdn: 'cdn',
    Push: 'push'
} as const;
export type TranscoderCreateInputInnerDeliveryMethodEnum = typeof TranscoderCreateInputInnerDeliveryMethodEnum[keyof typeof TranscoderCreateInputInnerDeliveryMethodEnum];

/**
 * @export
 */
export const TranscoderCreateInputInnerProtocolEnum = {
    File: 'file',
    Rtmp: 'rtmp',
    Rtsp: 'rtsp',
    Srt: 'srt',
...
export type TranscoderCreateInputInnerProtocolEnum = typeof TranscoderCreateInputInnerProtocolEnum[keyof typeof TranscoderCreateInputInnerProtocolEnum];

/**
 * @export
 */
export const TranscoderCreateInputInnerTranscoderTypeEnum = {
    Transcoded: 'transcoded',
    Passthrough: 'passthrough'
} as const;
export type TranscoderCreateInputInnerTranscoderTypeEnum = typeof TranscoderCreateInputInnerTranscoderTypeEnum[keyof typeof TranscoderCreateInputInnerTranscoderTypeEnum];

/**
 * @export
 */
export const TranscoderCreateInputInnerBufferSizeEnum = {
    NUMBER_0: 0,
    NUMBER_1000: 1000,
    NUMBER_2000: 2000,
    NUMBER_3000: 3000,
...
export type TranscoderCreateInputInnerBufferSizeEnum = typeof TranscoderCreateInputInnerBufferSizeEnum[keyof typeof TranscoderCreateInputInnerBufferSizeEnum];

/**
 * @export
 */
export const TranscoderCreateInputInnerClosedCaptionTypeEnum = {
    None: 'none',
    Cea: 'cea',
    OnText: 'on_text',
    Both: 'both'
} as const;
export type TranscoderCreateInputInnerClosedCaptionTypeEnum = typeof TranscoderCreateInputInnerClosedCaptionTypeEnum[keyof typeof TranscoderCreateInputInnerClosedCaptionTypeEnum];

/**
 * @export
 */
export const TranscoderCreateInputInnerWatermarkOpacityEnum = {
    NUMBER_0: 0,
    NUMBER_1: 1,
    NUMBER_2: 2,
    NUMBER_3: 3,
...
export type TranscoderCreateInputInnerWatermarkOpacityEnum = typeof TranscoderCreateInputInnerWatermarkOpacityEnum[keyof typeof TranscoderCreateInputInnerWatermarkOpacityEnum];

/**
 * @export
 */
export const TranscoderCreateInputInnerWatermarkPositionEnum = {
    TopLeft: 'top-left',
    TopRight: 'top-right',
    BottomLeft: 'bottom-left',
    BottomRight: 'bottom-right'
} as const;
export type TranscoderCreateInputInnerWatermarkPositionEnum = typeof TranscoderCreateInputInnerWatermarkPositionEnum[keyof typeof TranscoderCreateInputInnerWatermarkPositionEnum];


/**
 * Check if a given object implements the TranscoderCreateInputInner interface.
 */
export function instanceOfTranscoderCreateInputInner(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "billingMode" in value;
    isInstance = isInstance && "broadcastLocation" in value;
    isInstance = isInstance && "deliveryMethod" in value;
...
export function TranscoderCreateInputInnerFromJSON(json: any): TranscoderCreateInputInner {
    return TranscoderCreateInputInnerFromJSONTyped(json, false);
}

export function TranscoderCreateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderCreateInputInner {
    ...
    return {
        ...
        'broadcastLocation': json['broadcast_location'],
...
export function TranscoderCreateInputInnerToJSON(value?: TranscoderCreateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
