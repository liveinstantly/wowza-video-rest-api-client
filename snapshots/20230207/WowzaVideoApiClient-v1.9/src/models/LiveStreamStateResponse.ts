...
import type { LiveStreamState } from './LiveStreamState';
import {
    LiveStreamStateFromJSON,
    LiveStreamStateFromJSONTyped,
    LiveStreamStateToJSON,
} from './LiveStreamState';

/**
 * 
 * @export
 * @interface LiveStreamStateResponse
 */
export interface LiveStreamStateResponse {
    /**
     * 
     * @type {LiveStreamState}
     * @memberof LiveStreamStateResponse
     */
    liveStream: LiveStreamState;
}

/**
 * Check if a given object implements the LiveStreamStateResponse interface.
 */
export function instanceOfLiveStreamStateResponse(value: object): boolean {
    let isInstance = true;
...
export function LiveStreamStateResponseFromJSON(json: any): LiveStreamStateResponse {
    return LiveStreamStateResponseFromJSONTyped(json, false);
}

export function LiveStreamStateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamStateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'liveStream': LiveStreamStateFromJSON(json['live_stream']),
    };
}

export function LiveStreamStateResponseToJSON(value?: LiveStreamStateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'live_stream': LiveStreamStateToJSON(value.liveStream),
    };
}
