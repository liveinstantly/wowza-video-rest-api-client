...
import type { AssetReportUploadFailedInputInner } from './AssetReportUploadFailedInputInner';
import {
    AssetReportUploadFailedInputInnerFromJSON,
    AssetReportUploadFailedInputInnerFromJSONTyped,
    AssetReportUploadFailedInputInnerToJSON,
} from './AssetReportUploadFailedInputInner';

/**
 * 
 * @export
 * @interface AssetReportUploadFailedInput
 */
export interface AssetReportUploadFailedInput {
    /**
     * 
     * @type {AssetReportUploadFailedInputInner}
     * @memberof AssetReportUploadFailedInput
     */
    asset: AssetReportUploadFailedInputInner;
}

/**
 * Check if a given object implements the AssetReportUploadFailedInput interface.
 */
export function instanceOfAssetReportUploadFailedInput(value: object): boolean {
    let isInstance = true;
...
export function AssetReportUploadFailedInputFromJSON(json: any): AssetReportUploadFailedInput {
    return AssetReportUploadFailedInputFromJSONTyped(json, false);
}

export function AssetReportUploadFailedInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetReportUploadFailedInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'asset': AssetReportUploadFailedInputInnerFromJSON(json['asset']),
    };
}

export function AssetReportUploadFailedInputToJSON(value?: AssetReportUploadFailedInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'asset': AssetReportUploadFailedInputInnerToJSON(value.asset),
    };
}
