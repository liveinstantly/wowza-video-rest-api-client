 ...
 * 
 * @export
 * @interface UsageViewersDataByCountry
 */
export interface UsageViewersDataByCountry {
    /**
     * A country code where the stream was requested.
     * @type {string}
     * @memberof UsageViewersDataByCountry
     */
    code?: string;
    /**
...
/**
 * Check if a given object implements the UsageViewersDataByCountry interface.
 */
export function instanceOfUsageViewersDataByCountry(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataByCountryFromJSON(json: any): UsageViewersDataByCountry {
    return UsageViewersDataByCountryFromJSONTyped(json, false);
}

export function UsageViewersDataByCountryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataByCountry {
...
export function UsageViewersDataByCountryToJSON(value?: UsageViewersDataByCountry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
