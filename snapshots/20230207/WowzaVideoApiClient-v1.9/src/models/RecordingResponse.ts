...
/**
 * Check if a given object implements the RecordingResponse interface.
 */
export function instanceOfRecordingResponse(value: object): boolean {
    let isInstance = true;
...
export function RecordingResponseFromJSON(json: any): RecordingResponse {
    return RecordingResponseFromJSONTyped(json, false);
}

export function RecordingResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecordingResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'recording': RecordingFromJSON(json['recording']),
    };
}

export function RecordingResponseToJSON(value?: RecordingResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
