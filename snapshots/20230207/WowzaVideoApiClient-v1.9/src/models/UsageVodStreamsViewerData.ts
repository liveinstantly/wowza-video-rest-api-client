 ...
 * 
 * @export
 * @interface UsageVodStreamsViewerData
 */
export interface UsageVodStreamsViewerData {
    /**
     * 
     * @type {UsageViewersDataCurrent}
     * @memberof UsageVodStreamsViewerData
     */
    vodStream?: UsageViewersDataCurrent;
}

/**
 * Check if a given object implements the UsageVodStreamsViewerData interface.
 */
export function instanceOfUsageVodStreamsViewerData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamsViewerDataFromJSON(json: any): UsageVodStreamsViewerData {
    return UsageVodStreamsViewerDataFromJSONTyped(json, false);
}

export function UsageVodStreamsViewerDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamsViewerData {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'vodStream': !exists(json, 'vod_stream') ? undefined : UsageViewersDataCurrentFromJSON(json['vod_stream']),
    };
}

export function UsageVodStreamsViewerDataToJSON(value?: UsageVodStreamsViewerData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'vod_stream': UsageViewersDataCurrentToJSON(value.vodStream),
    };
}
