 ...
 * 
 * @export
 * @interface UsageTranscoderTrend
 */
export interface UsageTranscoderTrend {
    /**
     * An array of trend data
     * @type {Array<UsageViewersTrendsDetails>}
     * @memberof UsageTranscoderTrend
     */
...
/**
 * Check if a given object implements the UsageTranscoderTrend interface.
 */
export function instanceOfUsageTranscoderTrend(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageTranscoderTrendFromJSON(json: any): UsageTranscoderTrend {
    return UsageTranscoderTrendFromJSONTyped(json, false);
}

export function UsageTranscoderTrendFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageTranscoderTrend {
...
export function UsageTranscoderTrendToJSON(value?: UsageTranscoderTrend | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
