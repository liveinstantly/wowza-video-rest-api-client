...
import type { TranscoderRecordingStateRecording } from './TranscoderRecordingStateRecording';
import {
    TranscoderRecordingStateRecordingFromJSON,
    TranscoderRecordingStateRecordingFromJSONTyped,
    TranscoderRecordingStateRecordingToJSON,
} from './TranscoderRecordingStateRecording';

/**
 * 
 * @export
 * @interface TranscoderRecordingState
 */
export interface TranscoderRecordingState {
    /**
     * 
     * @type {TranscoderRecordingStateRecording}
     * @memberof TranscoderRecordingState
     */
    recording?: TranscoderRecordingStateRecording;
}

/**
 * Check if a given object implements the TranscoderRecordingState interface.
 */
export function instanceOfTranscoderRecordingState(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranscoderRecordingStateFromJSON(json: any): TranscoderRecordingState {
    return TranscoderRecordingStateFromJSONTyped(json, false);
}

export function TranscoderRecordingStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderRecordingState {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'recording': !exists(json, 'recording') ? undefined : TranscoderRecordingStateRecordingFromJSON(json['recording']),
    };
}

export function TranscoderRecordingStateToJSON(value?: TranscoderRecordingState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'recording': TranscoderRecordingStateRecordingToJSON(value.recording),
    };
}
