...
import type { StreamTargetAkamaiUpdateInputInner } from './StreamTargetAkamaiUpdateInputInner';
import {
    StreamTargetAkamaiUpdateInputInnerFromJSON,
    StreamTargetAkamaiUpdateInputInnerFromJSONTyped,
    StreamTargetAkamaiUpdateInputInnerToJSON,
} from './StreamTargetAkamaiUpdateInputInner';

/**
 * 
 * @export
 * @interface StreamTargetAkamaiUpdateInput
 */
export interface StreamTargetAkamaiUpdateInput {
    /**
     * 
     * @type {StreamTargetAkamaiUpdateInputInner}
     * @memberof StreamTargetAkamaiUpdateInput
     */
    streamTargetAkamai: StreamTargetAkamaiUpdateInputInner;
}

/**
 * Check if a given object implements the StreamTargetAkamaiUpdateInput interface.
 */
export function instanceOfStreamTargetAkamaiUpdateInput(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamTargetAkamai" in value;

    return isInstance;
}

export function StreamTargetAkamaiUpdateInputFromJSON(json: any): StreamTargetAkamaiUpdateInput {
    return StreamTargetAkamaiUpdateInputFromJSONTyped(json, false);
}

export function StreamTargetAkamaiUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetAkamaiUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetAkamai': StreamTargetAkamaiUpdateInputInnerFromJSON(json['stream_target_akamai']),
    };
}

export function StreamTargetAkamaiUpdateInputToJSON(value?: StreamTargetAkamaiUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target_akamai': StreamTargetAkamaiUpdateInputInnerToJSON(value.streamTargetAkamai),
    };
}
