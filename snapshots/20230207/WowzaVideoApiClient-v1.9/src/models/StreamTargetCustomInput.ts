...
import type { StreamTargetCustomInputInner } from './StreamTargetCustomInputInner';
import {
    StreamTargetCustomInputInnerFromJSON,
    StreamTargetCustomInputInnerFromJSONTyped,
    StreamTargetCustomInputInnerToJSON,
} from './StreamTargetCustomInputInner';

/**
 * 
 * @export
 * @interface StreamTargetCustomInput
 */
export interface StreamTargetCustomInput {
    /**
     * 
     * @type {StreamTargetCustomInputInner}
     * @memberof StreamTargetCustomInput
     */
    streamTargetCustom: StreamTargetCustomInputInner;
}

/**
 * Check if a given object implements the StreamTargetCustomInput interface.
 */
export function instanceOfStreamTargetCustomInput(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetCustomInputFromJSON(json: any): StreamTargetCustomInput {
    return StreamTargetCustomInputFromJSONTyped(json, false);
}

export function StreamTargetCustomInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetCustomInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetCustom': StreamTargetCustomInputInnerFromJSON(json['stream_target_custom']),
    };
}

export function StreamTargetCustomInputToJSON(value?: StreamTargetCustomInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target_custom': StreamTargetCustomInputInnerToJSON(value.streamTargetCustom),
    };
}
