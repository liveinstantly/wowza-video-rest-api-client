 ...
 * 
 * @export
 * @interface UsageRealTimeStream
 */
export interface UsageRealTimeStream {
    /**
     * 
     * @type {UsageRealTimeStreamData}
     * @memberof UsageRealTimeStream
     */
    realTimeStream?: UsageRealTimeStreamData;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageRealTimeStream
...
/**
 * Check if a given object implements the UsageRealTimeStream interface.
 */
export function instanceOfUsageRealTimeStream(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageRealTimeStreamFromJSON(json: any): UsageRealTimeStream {
    return UsageRealTimeStreamFromJSONTyped(json, false);
}

export function UsageRealTimeStreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageRealTimeStream {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'realTimeStream': !exists(json, 'real_time_stream') ? undefined : UsageRealTimeStreamDataFromJSON(json['real_time_stream']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageRealTimeStreamToJSON(value?: UsageRealTimeStream | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'real_time_stream': UsageRealTimeStreamDataToJSON(value.realTimeStream),
