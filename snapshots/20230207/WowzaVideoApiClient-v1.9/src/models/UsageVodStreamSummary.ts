...
import type { UsageVodStreamSummaryData } from './UsageVodStreamSummaryData';
import {
    UsageVodStreamSummaryDataFromJSON,
    UsageVodStreamSummaryDataFromJSONTyped,
    UsageVodStreamSummaryDataToJSON,
} from './UsageVodStreamSummaryData';

/**
 * 
 * @export
 * @interface UsageVodStreamSummary
 */
export interface UsageVodStreamSummary {
    /**
     * 
     * @type {UsageVodStreamSummaryData}
     * @memberof UsageVodStreamSummary
     */
    summary?: UsageVodStreamSummaryData;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageVodStreamSummary
...
/**
 * Check if a given object implements the UsageVodStreamSummary interface.
 */
export function instanceOfUsageVodStreamSummary(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamSummaryFromJSON(json: any): UsageVodStreamSummary {
    return UsageVodStreamSummaryFromJSONTyped(json, false);
}

export function UsageVodStreamSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamSummary {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'summary': !exists(json, 'summary') ? undefined : UsageVodStreamSummaryDataFromJSON(json['summary']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageVodStreamSummaryToJSON(value?: UsageVodStreamSummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'summary': UsageVodStreamSummaryDataToJSON(value.summary),
