...
import type { PlayerUrlInputInner } from './PlayerUrlInputInner';
import {
    PlayerUrlInputInnerFromJSON,
    PlayerUrlInputInnerFromJSONTyped,
    PlayerUrlInputInnerToJSON,
} from './PlayerUrlInputInner';

/**
 * 
 * @export
 * @interface PlayerUrlInput
 */
export interface PlayerUrlInput {
    /**
     * 
     * @type {PlayerUrlInputInner}
     * @memberof PlayerUrlInput
     */
    url: PlayerUrlInputInner;
}

/**
 * Check if a given object implements the PlayerUrlInput interface.
 */
export function instanceOfPlayerUrlInput(value: object): boolean {
    let isInstance = true;
...
export function PlayerUrlInputFromJSON(json: any): PlayerUrlInput {
    return PlayerUrlInputFromJSONTyped(json, false);
}

export function PlayerUrlInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerUrlInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'url': PlayerUrlInputInnerFromJSON(json['url']),
    };
}

export function PlayerUrlInputToJSON(value?: PlayerUrlInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'url': PlayerUrlInputInnerToJSON(value.url),
    };
}
