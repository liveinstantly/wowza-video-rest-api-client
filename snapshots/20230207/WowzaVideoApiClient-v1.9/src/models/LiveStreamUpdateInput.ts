...
import type { LiveStreamUpdateInputInner } from './LiveStreamUpdateInputInner';
import {
    LiveStreamUpdateInputInnerFromJSON,
    LiveStreamUpdateInputInnerFromJSONTyped,
    LiveStreamUpdateInputInnerToJSON,
} from './LiveStreamUpdateInputInner';

/**
 * 
 * @export
 * @interface LiveStreamUpdateInput
 */
export interface LiveStreamUpdateInput {
    /**
     * 
     * @type {LiveStreamUpdateInputInner}
     * @memberof LiveStreamUpdateInput
     */
    liveStream: LiveStreamUpdateInputInner;
}

/**
 * Check if a given object implements the LiveStreamUpdateInput interface.
 */
export function instanceOfLiveStreamUpdateInput(value: object): boolean {
    let isInstance = true;
...
export function LiveStreamUpdateInputFromJSON(json: any): LiveStreamUpdateInput {
    return LiveStreamUpdateInputFromJSONTyped(json, false);
}

export function LiveStreamUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'liveStream': LiveStreamUpdateInputInnerFromJSON(json['live_stream']),
    };
}

export function LiveStreamUpdateInputToJSON(value?: LiveStreamUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'live_stream': LiveStreamUpdateInputInnerToJSON(value.liveStream),
    };
}
