...
import type { VodStream } from './VodStream';
import {
    VodStreamFromJSON,
    VodStreamFromJSONTyped,
    VodStreamToJSON,
} from './VodStream';
 ...
 * 
 * @export
 * @interface VodStreamResponse
 */
export interface VodStreamResponse {
    /**
     * 
     * @type {VodStream}
     * @memberof VodStreamResponse
     */
    vodStream: VodStream;
}

/**
 * Check if a given object implements the VodStreamResponse interface.
 */
export function instanceOfVodStreamResponse(value: object): boolean {
    let isInstance = true;
...
export function VodStreamResponseFromJSON(json: any): VodStreamResponse {
    return VodStreamResponseFromJSONTyped(json, false);
}

export function VodStreamResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): VodStreamResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'vodStream': VodStreamFromJSON(json['vod_stream']),
    };
}

export function VodStreamResponseToJSON(value?: VodStreamResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'vod_stream': VodStreamToJSON(value.vodStream),
    };
}
