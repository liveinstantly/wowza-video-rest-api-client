...
import type { UsageViewersDataByRendition } from './UsageViewersDataByRendition';
import {
    UsageViewersDataByRenditionFromJSON,
    UsageViewersDataByRenditionFromJSONTyped,
    UsageViewersDataByRenditionToJSON,
} from './UsageViewersDataByRendition';

/**
 * 
 * @export
 * @interface UsageVodStreamRenditions
 */
export interface UsageVodStreamRenditions {
    /**
     * An array of viewer renditions.
     * @type {Array<UsageViewersDataByRendition>}
     * @memberof UsageVodStreamRenditions
     */
    renditions?: Array<UsageViewersDataByRendition>;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageVodStreamRenditions
...
/**
 * Check if a given object implements the UsageVodStreamRenditions interface.
 */
export function instanceOfUsageVodStreamRenditions(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamRenditionsFromJSON(json: any): UsageVodStreamRenditions {
    return UsageVodStreamRenditionsFromJSONTyped(json, false);
}

export function UsageVodStreamRenditionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamRenditions {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'renditions': !exists(json, 'renditions') ? undefined : ((json['renditions'] as Array<any>).map(UsageViewersDataByRenditionFromJSON)),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageVodStreamRenditionsToJSON(value?: UsageVodStreamRenditions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'renditions': value.renditions === undefined ? undefined : ((value.renditions as Array<any>).map(UsageViewersDataByRenditionToJSON)),
