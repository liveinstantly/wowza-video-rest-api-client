 ...
 * 
 * @export
 * @interface IndexLiveStream
 */
export interface IndexLiveStream {
    /**
     * The date and time that the live stream was created.
     * @type {Date}
     * @memberof IndexLiveStream
     */
    createdAt?: Date;
    /**
...
/**
 * Check if a given object implements the IndexLiveStream interface.
 */
export function instanceOfIndexLiveStream(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexLiveStreamFromJSON(json: any): IndexLiveStream {
    return IndexLiveStreamFromJSONTyped(json, false);
}

export function IndexLiveStreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexLiveStream {
...
export function IndexLiveStreamToJSON(value?: IndexLiveStream | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
