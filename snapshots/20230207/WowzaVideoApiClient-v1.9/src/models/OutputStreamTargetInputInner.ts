 ...
 * 
 * @export
 * @interface OutputStreamTargetInputInner
 */
export interface OutputStreamTargetInputInner {
    /**
     * The unique alphanumeric string that identifies the stream target.
     * @type {string}
     * @memberof OutputStreamTargetInputInner
     */
...
/**
 * Check if a given object implements the OutputStreamTargetInputInner interface.
 */
export function instanceOfOutputStreamTargetInputInner(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "streamTargetId" in value;

    return isInstance;
}

export function OutputStreamTargetInputInnerFromJSON(json: any): OutputStreamTargetInputInner {
    return OutputStreamTargetInputInnerFromJSONTyped(json, false);
}

export function OutputStreamTargetInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutputStreamTargetInputInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetId': json['stream_target_id'],
        'useStreamTargetBackupUrl': !exists(json, 'use_stream_target_backup_url') ? undefined : json['use_stream_target_backup_url'],
    };
}

export function OutputStreamTargetInputInnerToJSON(value?: OutputStreamTargetInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
