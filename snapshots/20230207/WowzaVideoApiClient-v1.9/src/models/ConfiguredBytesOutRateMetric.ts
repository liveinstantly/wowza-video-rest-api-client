 ...
 * 
 * @export
 * @interface ConfiguredBytesOutRateMetric
 */
export interface ConfiguredBytesOutRateMetric {
    /**
     ...
     * @type {string}
     * @memberof ConfiguredBytesOutRateMetric
     */
    status?: string;
    /**
...
/**
 * Check if a given object implements the ConfiguredBytesOutRateMetric interface.
 */
export function instanceOfConfiguredBytesOutRateMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ConfiguredBytesOutRateMetricFromJSON(json: any): ConfiguredBytesOutRateMetric {
    return ConfiguredBytesOutRateMetricFromJSONTyped(json, false);
}

export function ConfiguredBytesOutRateMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfiguredBytesOutRateMetric {
...
export function ConfiguredBytesOutRateMetricToJSON(value?: ConfiguredBytesOutRateMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
