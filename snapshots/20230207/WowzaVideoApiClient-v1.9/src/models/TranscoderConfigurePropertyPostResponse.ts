 ...
 * 
 * @export
 * @interface TranscoderConfigurePropertyPostResponse
 */
export interface TranscoderConfigurePropertyPostResponse {
    /**
     * 
     * @type {TranscoderProperty}
     * @memberof TranscoderConfigurePropertyPostResponse
     */
    property?: TranscoderProperty;
}

/**
 * Check if a given object implements the TranscoderConfigurePropertyPostResponse interface.
 */
export function instanceOfTranscoderConfigurePropertyPostResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranscoderConfigurePropertyPostResponseFromJSON(json: any): TranscoderConfigurePropertyPostResponse {
    return TranscoderConfigurePropertyPostResponseFromJSONTyped(json, false);
}

export function TranscoderConfigurePropertyPostResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderConfigurePropertyPostResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'property': !exists(json, 'property') ? undefined : TranscoderPropertyFromJSON(json['property']),
    };
}

export function TranscoderConfigurePropertyPostResponseToJSON(value?: TranscoderConfigurePropertyPostResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'property': TranscoderPropertyToJSON(value.property),
    };
}
