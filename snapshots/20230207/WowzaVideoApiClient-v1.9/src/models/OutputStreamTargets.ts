 ...
 * 
 * @export
 * @interface OutputStreamTargets
 */
export interface OutputStreamTargets {
    /**
     * 
     * @type {Array<OutputStreamTarget>}
     * @memberof OutputStreamTargets
     */
    outputStreamTargets: Array<OutputStreamTarget>;
}

/**
 * Check if a given object implements the OutputStreamTargets interface.
 */
export function instanceOfOutputStreamTargets(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "outputStreamTargets" in value;

    return isInstance;
}

export function OutputStreamTargetsFromJSON(json: any): OutputStreamTargets {
    return OutputStreamTargetsFromJSONTyped(json, false);
}

export function OutputStreamTargetsFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutputStreamTargets {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'outputStreamTargets': ((json['output_stream_targets'] as Array<any>).map(OutputStreamTargetFromJSON)),
    };
}

export function OutputStreamTargetsToJSON(value?: OutputStreamTargets | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'output_stream_targets': ((value.outputStreamTargets as Array<any>).map(OutputStreamTargetToJSON)),
    };
}
