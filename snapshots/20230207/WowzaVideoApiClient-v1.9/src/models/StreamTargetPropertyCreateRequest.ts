...
import {
    ...
    instanceOfStreamTargetPropertiesCreateInput,
    StreamTargetPropertiesCreateInputFromJSON,
    StreamTargetPropertiesCreateInputFromJSONTyped,
    StreamTargetPropertiesCreateInputToJSON,
} from './StreamTargetPropertiesCreateInput';
import {
    StreamTargetPropertyCreateInput,
    instanceOfStreamTargetPropertyCreateInput,
    StreamTargetPropertyCreateInputFromJSON,
    StreamTargetPropertyCreateInputFromJSONTyped,
    StreamTargetPropertyCreateInputToJSON,
} from './StreamTargetPropertyCreateInput';

/**
 * @type StreamTargetPropertyCreateRequest
 * 
 * @export
 */
export type StreamTargetPropertyCreateRequest = StreamTargetPropertiesCreateInput | StreamTargetPropertyCreateInput;

export function StreamTargetPropertyCreateRequestFromJSON(json: any): StreamTargetPropertyCreateRequest {
    return StreamTargetPropertyCreateRequestFromJSONTyped(json, false);
}

export function StreamTargetPropertyCreateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetPropertyCreateRequest {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...StreamTargetPropertiesCreateInputFromJSONTyped(json, true), ...StreamTargetPropertyCreateInputFromJSONTyped(json, true) };
}

export function StreamTargetPropertyCreateRequestToJSON(value?: StreamTargetPropertyCreateRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfStreamTargetPropertiesCreateInput(value)) {
        return StreamTargetPropertiesCreateInputToJSON(value as StreamTargetPropertiesCreateInput);
    }
    if (instanceOfStreamTargetPropertyCreateInput(value)) {
        return StreamTargetPropertyCreateInputToJSON(value as StreamTargetPropertyCreateInput);
    }
