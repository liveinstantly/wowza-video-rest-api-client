...
import type { OutputInputInner } from './OutputInputInner';
import {
    OutputInputInnerFromJSON,
    OutputInputInnerFromJSONTyped,
    OutputInputInnerToJSON,
} from './OutputInputInner';
...
export interface OutputInput {
    /**
     * 
     * @type {OutputInputInner}
     * @memberof OutputInput
     */
    output: OutputInputInner;
}

/**
 * Check if a given object implements the OutputInput interface.
 */
export function instanceOfOutputInput(value: object): boolean {
    let isInstance = true;
...
export function OutputInputFromJSON(json: any): OutputInput {
    return OutputInputFromJSONTyped(json, false);
}

export function OutputInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutputInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'output': OutputInputInnerFromJSON(json['output']),
    };
}

export function OutputInputToJSON(value?: OutputInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'output': OutputInputInnerToJSON(value.output),
    };
}
