...
import type { StreamTargetFastlyPatchResponse } from './StreamTargetFastlyPatchResponse';
import {
    StreamTargetFastlyPatchResponseFromJSON,
    StreamTargetFastlyPatchResponseFromJSONTyped,
    StreamTargetFastlyPatchResponseToJSON,
} from './StreamTargetFastlyPatchResponse';

/**
 * 
 * @export
 * @interface StreamTargetFastlyResponse
 */
export interface StreamTargetFastlyResponse {
    /**
     * 
     * @type {StreamTargetFastlyPatchResponse}
     * @memberof StreamTargetFastlyResponse
     */
    streamTargetFastly: StreamTargetFastlyPatchResponse;
}

/**
 * Check if a given object implements the StreamTargetFastlyResponse interface.
 */
export function instanceOfStreamTargetFastlyResponse(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetFastlyResponseFromJSON(json: any): StreamTargetFastlyResponse {
    return StreamTargetFastlyResponseFromJSONTyped(json, false);
}

export function StreamTargetFastlyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetFastlyResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetFastly': StreamTargetFastlyPatchResponseFromJSON(json['stream_target_fastly']),
    };
}

export function StreamTargetFastlyResponseToJSON(value?: StreamTargetFastlyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target_fastly': StreamTargetFastlyPatchResponseToJSON(value.streamTargetFastly),
    };
}
