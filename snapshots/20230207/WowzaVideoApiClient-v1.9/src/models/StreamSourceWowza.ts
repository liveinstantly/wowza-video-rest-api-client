 ...
 * 
 * @export
 * @interface StreamSourceWowza
 */
export interface StreamSourceWowza {
    /**
     * The date and time that the Wowza stream source was created.
     * @type {Date}
     * @memberof StreamSourceWowza
     */
    createdAt?: Date;
    /**
     ...
     * @memberof StreamSourceWowza
     */
    state?: StreamSourceWowzaStateEnum;
    /**
 ...
 * @export
 */
export const StreamSourceWowzaStateEnum = {
    Started: 'started',
    Stopped: 'stopped',
    Error: 'error'
} as const;
export type StreamSourceWowzaStateEnum = typeof StreamSourceWowzaStateEnum[keyof typeof StreamSourceWowzaStateEnum];


/**
 * Check if a given object implements the StreamSourceWowza interface.
 */
export function instanceOfStreamSourceWowza(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamSourceWowzaFromJSON(json: any): StreamSourceWowza {
    return StreamSourceWowzaFromJSONTyped(json, false);
}

export function StreamSourceWowzaFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamSourceWowza {
...
export function StreamSourceWowzaToJSON(value?: StreamSourceWowza | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
