...
import type { TranscoderRecordingState } from './TranscoderRecordingState';
import {
    TranscoderRecordingStateFromJSON,
    TranscoderRecordingStateFromJSONTyped,
    TranscoderRecordingStateToJSON,
} from './TranscoderRecordingState';

/**
 * 
 * @export
 * @interface TranscoderRecordingStateResponse
 */
export interface TranscoderRecordingStateResponse {
    /**
     * 
     * @type {TranscoderRecordingState}
     * @memberof TranscoderRecordingStateResponse
     */
    transcoder: TranscoderRecordingState;
}

/**
 * Check if a given object implements the TranscoderRecordingStateResponse interface.
 */
export function instanceOfTranscoderRecordingStateResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderRecordingStateResponseFromJSON(json: any): TranscoderRecordingStateResponse {
    return TranscoderRecordingStateResponseFromJSONTyped(json, false);
}

export function TranscoderRecordingStateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderRecordingStateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': TranscoderRecordingStateFromJSON(json['transcoder']),
    };
}

export function TranscoderRecordingStateResponseToJSON(value?: TranscoderRecordingStateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': TranscoderRecordingStateToJSON(value.transcoder),
    };
}
