 ...
 * 
 * @export
 * @interface VodStreamUpdateInputInner
 */
export interface VodStreamUpdateInputInner {
    /**
     * A descriptive name for the VOD stream. Maximum 200 characters.

**Example:** <code>"name": "My updated VOD stream"</code>
     * @type {string}
     * @memberof VodStreamUpdateInputInner
     */
    name: string;
    /**
...
**Example:** <code>"playback_enabled": true</code>
     ...
     * @memberof VodStreamUpdateInputInner
     */
    playbackEnabled?: VodStreamUpdateInputInnerPlaybackEnabledEnum;
}
 ...
 * @export
 */
export const VodStreamUpdateInputInnerPlaybackEnabledEnum = {
    True: true,
    False: false
} as const;
export type VodStreamUpdateInputInnerPlaybackEnabledEnum = typeof VodStreamUpdateInputInnerPlaybackEnabledEnum[keyof typeof VodStreamUpdateInputInnerPlaybackEnabledEnum];


/**
 * Check if a given object implements the VodStreamUpdateInputInner interface.
 */
export function instanceOfVodStreamUpdateInputInner(value: object): boolean {
    let isInstance = true;
...
export function VodStreamUpdateInputInnerFromJSON(json: any): VodStreamUpdateInputInner {
    return VodStreamUpdateInputInnerFromJSONTyped(json, false);
}

export function VodStreamUpdateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): VodStreamUpdateInputInner {
...
export function VodStreamUpdateInputInnerToJSON(value?: VodStreamUpdateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
