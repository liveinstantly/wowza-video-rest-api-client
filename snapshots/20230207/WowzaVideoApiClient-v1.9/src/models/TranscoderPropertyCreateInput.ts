 ...
 * 
 * @export
 * @interface TranscoderPropertyCreateInput
 */
export interface TranscoderPropertyCreateInput {
    /**
     * 
     * @type {Property}
     * @memberof TranscoderPropertyCreateInput
     */
    property?: Property;
}

/**
 * Check if a given object implements the TranscoderPropertyCreateInput interface.
 */
export function instanceOfTranscoderPropertyCreateInput(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranscoderPropertyCreateInputFromJSON(json: any): TranscoderPropertyCreateInput {
    return TranscoderPropertyCreateInputFromJSONTyped(json, false);
}

export function TranscoderPropertyCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderPropertyCreateInput {
...
export function TranscoderPropertyCreateInputToJSON(value?: TranscoderPropertyCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
