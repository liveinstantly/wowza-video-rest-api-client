 ...
 * 
 * @export
 * @interface StreamTargetFastly
 */
export interface StreamTargetFastly {
    /**
     * The date and time that the stream target was created.
     * @type {Date}
     * @memberof StreamTargetFastly
     */
    createdAt?: Date;
    /**
     ...
     * @memberof StreamTargetFastly
     */
    geoblockByLocation?: StreamTargetFastlyGeoblockByLocationEnum;
    /**
     ...
     * @memberof StreamTargetFastly
     */
    geoblockIpOverride?: StreamTargetFastlyGeoblockIpOverrideEnum;
    /**
     ...
     * @memberof StreamTargetFastly
     */
    state?: StreamTargetFastlyStateEnum;
    /**
...
Available from version 1.7.
     ...
     * @memberof StreamTargetFastly
     */
    refererPolicy?: StreamTargetFastlyRefererPolicyEnum;
    /**
 ...
 * @export
 */
export const StreamTargetFastlyGeoblockByLocationEnum = {
    Allow: 'allow',
    Deny: 'deny',
    Disabled: 'disabled'
} as const;
export type StreamTargetFastlyGeoblockByLocationEnum = typeof StreamTargetFastlyGeoblockByLocationEnum[keyof typeof StreamTargetFastlyGeoblockByLocationEnum];

/**
 * @export
 */
export const StreamTargetFastlyGeoblockIpOverrideEnum = {
    Allow: 'allow',
    Deny: 'deny',
    Disabled: 'disabled'
} as const;
export type StreamTargetFastlyGeoblockIpOverrideEnum = typeof StreamTargetFastlyGeoblockIpOverrideEnum[keyof typeof StreamTargetFastlyGeoblockIpOverrideEnum];

/**
 * @export
 */
export const StreamTargetFastlyStateEnum = {
    Activated: 'activated',
    Archived: 'archived'
} as const;
export type StreamTargetFastlyStateEnum = typeof StreamTargetFastlyStateEnum[keyof typeof StreamTargetFastlyStateEnum];

/**
 * @export
 */
export const StreamTargetFastlyRefererPolicyEnum = {
    Allow: 'allow',
    Deny: 'deny'
} as const;
export type StreamTargetFastlyRefererPolicyEnum = typeof StreamTargetFastlyRefererPolicyEnum[keyof typeof StreamTargetFastlyRefererPolicyEnum];


/**
 * Check if a given object implements the StreamTargetFastly interface.
 */
export function instanceOfStreamTargetFastly(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetFastlyFromJSON(json: any): StreamTargetFastly {
    return StreamTargetFastlyFromJSONTyped(json, false);
}

export function StreamTargetFastlyFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetFastly {
...
export function StreamTargetFastlyToJSON(value?: StreamTargetFastly | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
