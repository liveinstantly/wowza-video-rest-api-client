...
/**
 * Check if a given object implements the Error410 interface.
 */
export function instanceOfError410(value: object): boolean {
    let isInstance = true;
...
export function Error410FromJSON(json: any): Error410 {
    return Error410FromJSONTyped(json, false);
}

export function Error410FromJSONTyped(json: any, ignoreDiscriminator: boolean): Error410 {
...
export function Error410ToJSON(value?: Error410 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
