 ...
 * 
 * @export
 * @interface IndexStreamTargetFastly
 */
export interface IndexStreamTargetFastly {
    /**
     * The date and time that the stream target was created.
     * @type {Date}
     * @memberof IndexStreamTargetFastly
     */
    createdAt?: Date;
    /**
...
/**
 * Check if a given object implements the IndexStreamTargetFastly interface.
 */
export function instanceOfIndexStreamTargetFastly(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexStreamTargetFastlyFromJSON(json: any): IndexStreamTargetFastly {
    return IndexStreamTargetFastlyFromJSONTyped(json, false);
}

export function IndexStreamTargetFastlyFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexStreamTargetFastly {
...
export function IndexStreamTargetFastlyToJSON(value?: IndexStreamTargetFastly | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
