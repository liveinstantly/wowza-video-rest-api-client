 ...
 * 
 * @export
 * @interface UsageTranscoderCountries
 */
export interface UsageTranscoderCountries {
    /**
     * An array of viewer countries.
     * @type {Array<UsageViewersDataByCountry>}
     * @memberof UsageTranscoderCountries
     */
...
/**
 * Check if a given object implements the UsageTranscoderCountries interface.
 */
export function instanceOfUsageTranscoderCountries(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageTranscoderCountriesFromJSON(json: any): UsageTranscoderCountries {
    return UsageTranscoderCountriesFromJSONTyped(json, false);
}

export function UsageTranscoderCountriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageTranscoderCountries {
...
export function UsageTranscoderCountriesToJSON(value?: UsageTranscoderCountries | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
