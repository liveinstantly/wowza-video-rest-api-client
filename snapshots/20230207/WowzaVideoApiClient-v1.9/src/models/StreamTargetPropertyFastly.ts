 ...
 * 
 * @export
 * @interface StreamTargetPropertyFastly
 */
export interface StreamTargetPropertyFastly {
    /**
...
**relativePlaylists** | Allows the viewer to watch the stream over HTTP and HTTPS, whichever protocol their browser calls.
     * @type {string}
     * @memberof StreamTargetPropertyFastly
     */
    key: StreamTargetPropertyFastlyKeyEnum;
    /**
...
**playlist** | **playlistSeconds** and **relativePlaylists**
     ...
     * @memberof StreamTargetPropertyFastly
     */
    section: StreamTargetPropertyFastlySectionEnum;
    /**
     * 
 ...
 * @export
 */
export const StreamTargetPropertyFastlyKeyEnum = {
    Acao: 'acao',
    ChunkSize: 'chunkSize',
...
export type StreamTargetPropertyFastlyKeyEnum = typeof StreamTargetPropertyFastlyKeyEnum[keyof typeof StreamTargetPropertyFastlyKeyEnum];

/**
 * @export
 */
export const StreamTargetPropertyFastlySectionEnum = {
    Hls: 'hls',
    Playlist: 'playlist'
} as const;
export type StreamTargetPropertyFastlySectionEnum = typeof StreamTargetPropertyFastlySectionEnum[keyof typeof StreamTargetPropertyFastlySectionEnum];


/**
 * Check if a given object implements the StreamTargetPropertyFastly interface.
 */
export function instanceOfStreamTargetPropertyFastly(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetPropertyFastlyFromJSON(json: any): StreamTargetPropertyFastly {
    return StreamTargetPropertyFastlyFromJSONTyped(json, false);
}

export function StreamTargetPropertyFastlyFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetPropertyFastly {
...
export function StreamTargetPropertyFastlyToJSON(value?: StreamTargetPropertyFastly | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
