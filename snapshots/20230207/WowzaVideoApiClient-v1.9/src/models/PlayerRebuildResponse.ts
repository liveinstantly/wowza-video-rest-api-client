...
import type { PlayerRebuildState } from './PlayerRebuildState';
import {
    PlayerRebuildStateFromJSON,
    PlayerRebuildStateFromJSONTyped,
    PlayerRebuildStateToJSON,
} from './PlayerRebuildState';

/**
 * 
 * @export
 * @interface PlayerRebuildResponse
 */
export interface PlayerRebuildResponse {
    /**
     * 
     * @type {PlayerRebuildState}
     * @memberof PlayerRebuildResponse
     */
    player: PlayerRebuildState;
}

/**
 * Check if a given object implements the PlayerRebuildResponse interface.
 */
export function instanceOfPlayerRebuildResponse(value: object): boolean {
    let isInstance = true;
...
export function PlayerRebuildResponseFromJSON(json: any): PlayerRebuildResponse {
    return PlayerRebuildResponseFromJSONTyped(json, false);
}

export function PlayerRebuildResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerRebuildResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'player': PlayerRebuildStateFromJSON(json['player']),
    };
}

export function PlayerRebuildResponseToJSON(value?: PlayerRebuildResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'player': PlayerRebuildStateToJSON(value.player),
    };
}
