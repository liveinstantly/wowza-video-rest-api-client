 ...
 * 
 * @export
 * @interface AssetCreateInputInnner
 */
export interface AssetCreateInputInnner {
    /**
     * The name of the mp4 file you are uploading.
     * @type {string}
     * @memberof AssetCreateInputInnner
     */
    fileName: string;
}

/**
 * Check if a given object implements the AssetCreateInputInnner interface.
 */
export function instanceOfAssetCreateInputInnner(value: object): boolean {
    let isInstance = true;
...
export function AssetCreateInputInnnerFromJSON(json: any): AssetCreateInputInnner {
    return AssetCreateInputInnnerFromJSONTyped(json, false);
}

export function AssetCreateInputInnnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetCreateInputInnner {
...
export function AssetCreateInputInnnerToJSON(value?: AssetCreateInputInnner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
