 ...
 * 
 * @export
 * @interface LiveStreamThumbnailUrl
 */
export interface LiveStreamThumbnailUrl {
    /**
     * The URL to receive the preview thumbnail.
     * @type {string}
     * @memberof LiveStreamThumbnailUrl
     */
    thumbnailUrl?: string;
}

/**
 * Check if a given object implements the LiveStreamThumbnailUrl interface.
 */
export function instanceOfLiveStreamThumbnailUrl(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LiveStreamThumbnailUrlFromJSON(json: any): LiveStreamThumbnailUrl {
    return LiveStreamThumbnailUrlFromJSONTyped(json, false);
}

export function LiveStreamThumbnailUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamThumbnailUrl {
...
export function LiveStreamThumbnailUrlToJSON(value?: LiveStreamThumbnailUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
