 ...
 * @export
 * @interface StreamTargetFastlyPlaybackUrls
 */
export interface StreamTargetFastlyPlaybackUrls {
    /**
     * Web address that the target uses to play HLS streams.
     * @type {Array<Hls>}
     * @memberof StreamTargetFastlyPlaybackUrls
     */
    hls?: Array<Hls>;
}

/**
 * Check if a given object implements the StreamTargetFastlyPlaybackUrls interface.
 */
export function instanceOfStreamTargetFastlyPlaybackUrls(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetFastlyPlaybackUrlsFromJSON(json: any): StreamTargetFastlyPlaybackUrls {
    return StreamTargetFastlyPlaybackUrlsFromJSONTyped(json, false);
}

export function StreamTargetFastlyPlaybackUrlsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetFastlyPlaybackUrls {
...
export function StreamTargetFastlyPlaybackUrlsToJSON(value?: StreamTargetFastlyPlaybackUrls | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
