 ...
 * 
 * @export
 * @interface AssetReportUploadedInputInner
 */
export interface AssetReportUploadedInputInner {
    /**
     * The length of an asset in seconds. In this example, 9241 would represent 9,241 seconds or roughly 2.5 hours.
     * @type {number}
     * @memberof AssetReportUploadedInputInner
     */
    duration: number;
}

/**
 * Check if a given object implements the AssetReportUploadedInputInner interface.
 */
export function instanceOfAssetReportUploadedInputInner(value: object): boolean {
    let isInstance = true;
...
export function AssetReportUploadedInputInnerFromJSON(json: any): AssetReportUploadedInputInner {
    return AssetReportUploadedInputInnerFromJSONTyped(json, false);
}

export function AssetReportUploadedInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetReportUploadedInputInner {
...
export function AssetReportUploadedInputInnerToJSON(value?: AssetReportUploadedInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
