 ...
 * 
 * @export
 * @interface TranscoderOutputsOutputStreamTargetResponse
 */
export interface TranscoderOutputsOutputStreamTargetResponse {
    /**
     * 
     * @type {OutputStreamTarget}
     * @memberof TranscoderOutputsOutputStreamTargetResponse
     */
    outputStreamTarget?: OutputStreamTarget;
}

/**
 * Check if a given object implements the TranscoderOutputsOutputStreamTargetResponse interface.
 */
export function instanceOfTranscoderOutputsOutputStreamTargetResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranscoderOutputsOutputStreamTargetResponseFromJSON(json: any): TranscoderOutputsOutputStreamTargetResponse {
    return TranscoderOutputsOutputStreamTargetResponseFromJSONTyped(json, false);
}

export function TranscoderOutputsOutputStreamTargetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderOutputsOutputStreamTargetResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'outputStreamTarget': !exists(json, 'output_stream_target') ? undefined : OutputStreamTargetFromJSON(json['output_stream_target']),
    };
}

export function TranscoderOutputsOutputStreamTargetResponseToJSON(value?: TranscoderOutputsOutputStreamTargetResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'output_stream_target': OutputStreamTargetToJSON(value.outputStreamTarget),
    };
}
