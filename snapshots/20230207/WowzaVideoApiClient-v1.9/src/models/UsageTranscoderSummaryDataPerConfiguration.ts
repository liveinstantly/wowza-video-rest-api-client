 ...
 * 
 * @export
 * @interface UsageTranscoderSummaryDataPerConfiguration
 */
export interface UsageTranscoderSummaryDataPerConfiguration {
    /**
     * The type of transcoder. The default is **transcoded**.
     * @type {string}
     * @memberof UsageTranscoderSummaryDataPerConfiguration
     */
    transcoderType?: UsageTranscoderSummaryDataPerConfigurationTranscoderTypeEnum;
    /**
     * The billing mode for the transcoder. The default is **pay_as_you_go**.
     * @type {string}
     * @memberof UsageTranscoderSummaryDataPerConfiguration
     */
    billingMode?: UsageTranscoderSummaryDataPerConfigurationBillingModeEnum;
    /**
    ...
    egressBytes?: number;
    /**
     * The amount of time, in seconds, that it took for the transcoder to be processed.
     * @type {number}
     * @memberof UsageTranscoderSummaryDataPerConfiguration
     */
 ...
 * @export
 */
export const UsageTranscoderSummaryDataPerConfigurationTranscoderTypeEnum = {
    Transcoded: 'transcoded',
    Passthrough: 'passthrough'
} as const;
export type UsageTranscoderSummaryDataPerConfigurationTranscoderTypeEnum = typeof UsageTranscoderSummaryDataPerConfigurationTranscoderTypeEnum[keyof typeof UsageTranscoderSummaryDataPerConfigurationTranscoderTypeEnum];

/**
 * @export
 */
export const UsageTranscoderSummaryDataPerConfigurationBillingModeEnum = {
    PayAsYouGo: 'pay_as_you_go',
    TwentyfourSeven: 'twentyfour_seven'
} as const;
export type UsageTranscoderSummaryDataPerConfigurationBillingModeEnum = typeof UsageTranscoderSummaryDataPerConfigurationBillingModeEnum[keyof typeof UsageTranscoderSummaryDataPerConfigurationBillingModeEnum];


/**
 * Check if a given object implements the UsageTranscoderSummaryDataPerConfiguration interface.
 */
export function instanceOfUsageTranscoderSummaryDataPerConfiguration(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageTranscoderSummaryDataPerConfigurationFromJSON(json: any): UsageTranscoderSummaryDataPerConfiguration {
    return UsageTranscoderSummaryDataPerConfigurationFromJSONTyped(json, false);
}

export function UsageTranscoderSummaryDataPerConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageTranscoderSummaryDataPerConfiguration {
...
export function UsageTranscoderSummaryDataPerConfigurationToJSON(value?: UsageTranscoderSummaryDataPerConfiguration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
