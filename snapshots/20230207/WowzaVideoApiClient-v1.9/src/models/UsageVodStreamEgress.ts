 ...
 * 
 * @export
 * @interface UsageVodStreamEgress
 */
export interface UsageVodStreamEgress {
    /**
     * 
     * @type {UsageEgressDataPerVodStream}
     * @memberof UsageVodStreamEgress
     */
    vodStream?: UsageEgressDataPerVodStream;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageVodStreamEgress
...
/**
 * Check if a given object implements the UsageVodStreamEgress interface.
 */
export function instanceOfUsageVodStreamEgress(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamEgressFromJSON(json: any): UsageVodStreamEgress {
    return UsageVodStreamEgressFromJSONTyped(json, false);
}

export function UsageVodStreamEgressFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamEgress {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'vodStream': !exists(json, 'vod_stream') ? undefined : UsageEgressDataPerVodStreamFromJSON(json['vod_stream']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageVodStreamEgressToJSON(value?: UsageVodStreamEgress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'vod_stream': UsageEgressDataPerVodStreamToJSON(value.vodStream),
