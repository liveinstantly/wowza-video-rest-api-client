 ...
 * 
 * @export
 * @interface StreamTargetProperties
 */
export interface StreamTargetProperties {
    /**
     * 
     * @type {Array<StreamTargetProperty>}
     * @memberof StreamTargetProperties
     */
    properties: Array<StreamTargetProperty>;
}

/**
 * Check if a given object implements the StreamTargetProperties interface.
 */
export function instanceOfStreamTargetProperties(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetPropertiesFromJSON(json: any): StreamTargetProperties {
    return StreamTargetPropertiesFromJSONTyped(json, false);
}

export function StreamTargetPropertiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetProperties {
...
export function StreamTargetPropertiesToJSON(value?: StreamTargetProperties | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
