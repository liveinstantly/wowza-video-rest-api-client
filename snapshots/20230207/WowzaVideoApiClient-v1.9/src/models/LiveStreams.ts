...
import type { IndexLiveStream } from './IndexLiveStream';
import {
    IndexLiveStreamFromJSON,
    IndexLiveStreamFromJSONTyped,
    IndexLiveStreamToJSON,
} from './IndexLiveStream';
...
export interface LiveStreams {
    /**
     * 
     * @type {Array<IndexLiveStream>}
     * @memberof LiveStreams
     */
    liveStreams: Array<IndexLiveStream>;
}

/**
 * Check if a given object implements the LiveStreams interface.
 */
export function instanceOfLiveStreams(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "liveStreams" in value;

    return isInstance;
}

export function LiveStreamsFromJSON(json: any): LiveStreams {
    return LiveStreamsFromJSONTyped(json, false);
}

export function LiveStreamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreams {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'liveStreams': ((json['live_streams'] as Array<any>).map(IndexLiveStreamFromJSON)),
    };
}

export function LiveStreamsToJSON(value?: LiveStreams | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'live_streams': ((value.liveStreams as Array<any>).map(IndexLiveStreamToJSON)),
    };
}
