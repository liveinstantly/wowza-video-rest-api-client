...
import type { UsageStreamTargetSummaryData } from './UsageStreamTargetSummaryData';
import {
    UsageStreamTargetSummaryDataFromJSON,
    UsageStreamTargetSummaryDataFromJSONTyped,
    UsageStreamTargetSummaryDataToJSON,
} from './UsageStreamTargetSummaryData';

/**
 * 
 * @export
 * @interface UsageStreamTargetSummary
 */
export interface UsageStreamTargetSummary {
    /**
     * 
     * @type {UsageStreamTargetSummaryData}
     * @memberof UsageStreamTargetSummary
     */
    summary?: UsageStreamTargetSummaryData;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageStreamTargetSummary
...
/**
 * Check if a given object implements the UsageStreamTargetSummary interface.
 */
export function instanceOfUsageStreamTargetSummary(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageStreamTargetSummaryFromJSON(json: any): UsageStreamTargetSummary {
    return UsageStreamTargetSummaryFromJSONTyped(json, false);
}

export function UsageStreamTargetSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageStreamTargetSummary {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'summary': !exists(json, 'summary') ? undefined : UsageStreamTargetSummaryDataFromJSON(json['summary']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageStreamTargetSummaryToJSON(value?: UsageStreamTargetSummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'summary': UsageStreamTargetSummaryDataToJSON(value.summary),
