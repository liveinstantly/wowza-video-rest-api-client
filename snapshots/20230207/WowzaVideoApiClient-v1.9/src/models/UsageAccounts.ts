...
import type { UsageViewersDataPerAccount } from './UsageViewersDataPerAccount';
import {
    UsageViewersDataPerAccountFromJSON,
    UsageViewersDataPerAccountFromJSONTyped,
    UsageViewersDataPerAccountToJSON,
} from './UsageViewersDataPerAccount';

/**
 * 
 * @export
 * @interface UsageAccounts
 */
export interface UsageAccounts {
    /**
     * 
     * @type {UsageViewersDataPerAccount}
     * @memberof UsageAccounts
     */
    account?: UsageViewersDataPerAccount;
    /**
     * 
...
/**
 * Check if a given object implements the UsageAccounts interface.
 */
export function instanceOfUsageAccounts(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageAccountsFromJSON(json: any): UsageAccounts {
    return UsageAccountsFromJSONTyped(json, false);
}

export function UsageAccountsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageAccounts {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'account': !exists(json, 'account') ? undefined : UsageViewersDataPerAccountFromJSON(json['account']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsWithResourcesFromJSON(json['limits']),
    };
}

export function UsageAccountsToJSON(value?: UsageAccounts | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'account': UsageViewersDataPerAccountToJSON(value.account),
