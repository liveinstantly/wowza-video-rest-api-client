...
import type { ScheduleCreateInputInner } from './ScheduleCreateInputInner';
import {
    ScheduleCreateInputInnerFromJSON,
    ScheduleCreateInputInnerFromJSONTyped,
    ScheduleCreateInputInnerToJSON,
} from './ScheduleCreateInputInner';
...
export interface ScheduleCreateInput {
    /**
     * 
     * @type {ScheduleCreateInputInner}
     * @memberof ScheduleCreateInput
     */
    schedule: ScheduleCreateInputInner;
}

/**
 * Check if a given object implements the ScheduleCreateInput interface.
 */
export function instanceOfScheduleCreateInput(value: object): boolean {
    let isInstance = true;
...
export function ScheduleCreateInputFromJSON(json: any): ScheduleCreateInput {
    return ScheduleCreateInputFromJSONTyped(json, false);
}

export function ScheduleCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScheduleCreateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'schedule': ScheduleCreateInputInnerFromJSON(json['schedule']),
    };
}

export function ScheduleCreateInputToJSON(value?: ScheduleCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'schedule': ScheduleCreateInputInnerToJSON(value.schedule),
    };
}
