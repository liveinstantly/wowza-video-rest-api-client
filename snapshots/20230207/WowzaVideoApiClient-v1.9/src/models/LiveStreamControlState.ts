 ...
 * 
 * @export
 * @interface LiveStreamControlState
 */
export interface LiveStreamControlState {
    /**
     * The state of the live stream.
     * @type {string}
     * @memberof LiveStreamControlState
     */
    state?: LiveStreamControlStateStateEnum;
}
 ...
 * @export
 */
export const LiveStreamControlStateStateEnum = {
    Started: 'started',
    Stopped: 'stopped',
    Starting: 'starting',
    Stopping: 'stopping',
...
export type LiveStreamControlStateStateEnum = typeof LiveStreamControlStateStateEnum[keyof typeof LiveStreamControlStateStateEnum];


/**
 * Check if a given object implements the LiveStreamControlState interface.
 */
export function instanceOfLiveStreamControlState(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LiveStreamControlStateFromJSON(json: any): LiveStreamControlState {
    return LiveStreamControlStateFromJSONTyped(json, false);
}

export function LiveStreamControlStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveStreamControlState {
...
export function LiveStreamControlStateToJSON(value?: LiveStreamControlState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
