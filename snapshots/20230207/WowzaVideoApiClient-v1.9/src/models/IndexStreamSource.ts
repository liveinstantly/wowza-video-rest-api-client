 ...
 * 
 * @export
 * @interface IndexStreamSource
 */
export interface IndexStreamSource {
    /**
     * The date and time that the stream source was created.
     * @type {Date}
     * @memberof IndexStreamSource
     */
    createdAt?: Date;
    /**
     ...
     * @memberof IndexStreamSource
     */
    type?: IndexStreamSourceTypeEnum;
    /**
 ...
 * @export
 */
export const IndexStreamSourceTypeEnum = {
    Akamai: 'akamai',
    Wowza: 'wowza'
} as const;
export type IndexStreamSourceTypeEnum = typeof IndexStreamSourceTypeEnum[keyof typeof IndexStreamSourceTypeEnum];


/**
 * Check if a given object implements the IndexStreamSource interface.
 */
export function instanceOfIndexStreamSource(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexStreamSourceFromJSON(json: any): IndexStreamSource {
    return IndexStreamSourceFromJSONTyped(json, false);
}

export function IndexStreamSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexStreamSource {
...
export function IndexStreamSourceToJSON(value?: IndexStreamSource | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
