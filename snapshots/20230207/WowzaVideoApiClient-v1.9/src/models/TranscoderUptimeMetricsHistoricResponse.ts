...
import type { LimitsWithRange } from './LimitsWithRange';
import {
    LimitsWithRangeFromJSON,
    LimitsWithRangeFromJSONTyped,
    LimitsWithRangeToJSON,
} from './LimitsWithRange';
import type { ShmHistoricMetrics } from './ShmHistoricMetrics';
import {
    ShmHistoricMetricsFromJSON,
    ShmHistoricMetricsFromJSONTyped,
    ShmHistoricMetricsToJSON,
} from './ShmHistoricMetrics';

/**
 * 
 * @export
 * @interface TranscoderUptimeMetricsHistoricResponse
 */
export interface TranscoderUptimeMetricsHistoricResponse {
    /**
     * 
     * @type {Array<ShmHistoricMetrics>}
     * @memberof TranscoderUptimeMetricsHistoricResponse
     */
    historic: Array<ShmHistoricMetrics>;
    /**
     * 
     * @type {LimitsWithRange}
     * @memberof TranscoderUptimeMetricsHistoricResponse
     */
    limits: LimitsWithRange;
}

/**
 * Check if a given object implements the TranscoderUptimeMetricsHistoricResponse interface.
 */
export function instanceOfTranscoderUptimeMetricsHistoricResponse(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "historic" in value;
    isInstance = isInstance && "limits" in value;

    return isInstance;
}

export function TranscoderUptimeMetricsHistoricResponseFromJSON(json: any): TranscoderUptimeMetricsHistoricResponse {
    return TranscoderUptimeMetricsHistoricResponseFromJSONTyped(json, false);
}

export function TranscoderUptimeMetricsHistoricResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderUptimeMetricsHistoricResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'historic': ((json['historic'] as Array<any>).map(ShmHistoricMetricsFromJSON)),
        'limits': LimitsWithRangeFromJSON(json['limits']),
    };
}

export function TranscoderUptimeMetricsHistoricResponseToJSON(value?: TranscoderUptimeMetricsHistoricResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'historic': ((value.historic as Array<any>).map(ShmHistoricMetricsToJSON)),
        'limits': LimitsWithRangeToJSON(value.limits),
    };
}
