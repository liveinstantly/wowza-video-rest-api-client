...
/**
 * Check if a given object implements the Hls interface.
 */
export function instanceOfHls(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HlsFromJSON(json: any): Hls {
    return HlsFromJSONTyped(json, false);
}

export function HlsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Hls {
...
export function HlsToJSON(value?: Hls | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
