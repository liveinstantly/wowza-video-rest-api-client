...
/**
 * Check if a given object implements the FrameRateMetric interface.
 */
export function instanceOfFrameRateMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function FrameRateMetricFromJSON(json: any): FrameRateMetric {
    return FrameRateMetricFromJSONTyped(json, false);
}

export function FrameRateMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): FrameRateMetric {
...
export function FrameRateMetricToJSON(value?: FrameRateMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
