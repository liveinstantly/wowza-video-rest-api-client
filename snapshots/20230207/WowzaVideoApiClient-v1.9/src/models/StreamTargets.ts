...
export interface StreamTargets {
    /**
     * 
     * @type {Array<IndexStreamTarget>}
     * @memberof StreamTargets
     */
    streamTargets: Array<IndexStreamTarget>;
}

/**
 * Check if a given object implements the StreamTargets interface.
 */
export function instanceOfStreamTargets(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetsFromJSON(json: any): StreamTargets {
    return StreamTargetsFromJSONTyped(json, false);
}

export function StreamTargetsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargets {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargets': ((json['stream_targets'] as Array<any>).map(IndexStreamTargetFromJSON)),
    };
}

export function StreamTargetsToJSON(value?: StreamTargets | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_targets': ((value.streamTargets as Array<any>).map(IndexStreamTargetToJSON)),
    };
}
