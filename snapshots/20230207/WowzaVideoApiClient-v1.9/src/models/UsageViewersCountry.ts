 ...
 * 
 * @export
 * @interface UsageViewersCountry
 */
export interface UsageViewersCountry {
    /**
     * A country code where the stream was requested.
     * @type {string}
     * @memberof UsageViewersCountry
     */
    code?: string;
    /**
...
/**
 * Check if a given object implements the UsageViewersCountry interface.
 */
export function instanceOfUsageViewersCountry(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersCountryFromJSON(json: any): UsageViewersCountry {
    return UsageViewersCountryFromJSONTyped(json, false);
}

export function UsageViewersCountryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersCountry {
...
export function UsageViewersCountryToJSON(value?: UsageViewersCountry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
