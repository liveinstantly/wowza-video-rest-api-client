 ...
 * 
 * @export
 * @interface UsageStreamTargetSummaryData
 */
export interface UsageStreamTargetSummaryData {
    /**
     ...
     * @type {number}
     * @memberof UsageStreamTargetSummaryData
     */
...
/**
 * Check if a given object implements the UsageStreamTargetSummaryData interface.
 */
export function instanceOfUsageStreamTargetSummaryData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageStreamTargetSummaryDataFromJSON(json: any): UsageStreamTargetSummaryData {
    return UsageStreamTargetSummaryDataFromJSONTyped(json, false);
}

export function UsageStreamTargetSummaryDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageStreamTargetSummaryData {
...
export function UsageStreamTargetSummaryDataToJSON(value?: UsageStreamTargetSummaryData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
