...
import type { TranscoderThumbnailUrl } from './TranscoderThumbnailUrl';
import {
    TranscoderThumbnailUrlFromJSON,
    TranscoderThumbnailUrlFromJSONTyped,
    TranscoderThumbnailUrlToJSON,
} from './TranscoderThumbnailUrl';

/**
 * 
 * @export
 * @interface TranscoderThumbnailUrlResponse
 */
export interface TranscoderThumbnailUrlResponse {
    /**
     * 
     * @type {TranscoderThumbnailUrl}
     * @memberof TranscoderThumbnailUrlResponse
     */
    transcoder: TranscoderThumbnailUrl;
}

/**
 * Check if a given object implements the TranscoderThumbnailUrlResponse interface.
 */
export function instanceOfTranscoderThumbnailUrlResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderThumbnailUrlResponseFromJSON(json: any): TranscoderThumbnailUrlResponse {
    return TranscoderThumbnailUrlResponseFromJSONTyped(json, false);
}

export function TranscoderThumbnailUrlResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderThumbnailUrlResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': TranscoderThumbnailUrlFromJSON(json['transcoder']),
    };
}

export function TranscoderThumbnailUrlResponseToJSON(value?: TranscoderThumbnailUrlResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': TranscoderThumbnailUrlToJSON(value.transcoder),
    };
}
