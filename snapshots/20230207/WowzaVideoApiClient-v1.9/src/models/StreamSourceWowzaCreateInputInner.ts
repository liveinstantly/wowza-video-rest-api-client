 ...
 * 
 * @export
 * @interface StreamSourceWowzaCreateInputInner
 */
export interface StreamSourceWowzaCreateInputInner {
    /**
     * A descriptive name for the Wowza stream source. Maximum 255 characters.
     * @type {string}
     * @memberof StreamSourceWowzaCreateInputInner
     */
    name: string;
}

/**
 * Check if a given object implements the StreamSourceWowzaCreateInputInner interface.
 */
export function instanceOfStreamSourceWowzaCreateInputInner(value: object): boolean {
    let isInstance = true;
...
export function StreamSourceWowzaCreateInputInnerFromJSON(json: any): StreamSourceWowzaCreateInputInner {
    return StreamSourceWowzaCreateInputInnerFromJSONTyped(json, false);
}

export function StreamSourceWowzaCreateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamSourceWowzaCreateInputInner {
...
export function StreamSourceWowzaCreateInputInnerToJSON(value?: StreamSourceWowzaCreateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
