...
export interface TranscoderState {
     ...
     * @memberof TranscoderState
     */
    state?: TranscoderStateStateEnum;
    /**
 ...
 * @export
 */
export const TranscoderStateStateEnum = {
    Starting: 'starting',
    Stopping: 'stopping',
    Started: 'started',
    Stopped: 'stopped',
...
export type TranscoderStateStateEnum = typeof TranscoderStateStateEnum[keyof typeof TranscoderStateStateEnum];


/**
 * Check if a given object implements the TranscoderState interface.
 */
export function instanceOfTranscoderState(value: object): boolean {
    let isInstance = true;
...
export function TranscoderStateToJSON(value?: TranscoderState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
