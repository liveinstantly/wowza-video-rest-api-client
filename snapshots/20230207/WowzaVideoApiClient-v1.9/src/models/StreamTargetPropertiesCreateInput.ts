 ...
 * 
 * @export
 * @interface StreamTargetPropertiesCreateInput
 */
export interface StreamTargetPropertiesCreateInput {
    /**
     ...
     * @memberof StreamTargetPropertiesCreateInput
     */
    properties: Array<StreamTargetProperty>;
}

/**
 * Check if a given object implements the StreamTargetPropertiesCreateInput interface.
 */
export function instanceOfStreamTargetPropertiesCreateInput(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetPropertiesCreateInputFromJSON(json: any): StreamTargetPropertiesCreateInput {
    return StreamTargetPropertiesCreateInputFromJSONTyped(json, false);
}

export function StreamTargetPropertiesCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetPropertiesCreateInput {
...
export function StreamTargetPropertiesCreateInputToJSON(value?: StreamTargetPropertiesCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
