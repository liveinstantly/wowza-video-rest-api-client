 ...
 * 
 * @export
 * @interface KeyframeIntervalMetric
 */
export interface KeyframeIntervalMetric {
    /**
     ...
     * @type {string}
     * @memberof KeyframeIntervalMetric
     */
    status?: string;
    /**
...
/**
 * Check if a given object implements the KeyframeIntervalMetric interface.
 */
export function instanceOfKeyframeIntervalMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function KeyframeIntervalMetricFromJSON(json: any): KeyframeIntervalMetric {
    return KeyframeIntervalMetricFromJSONTyped(json, false);
}

export function KeyframeIntervalMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): KeyframeIntervalMetric {
...
export function KeyframeIntervalMetricToJSON(value?: KeyframeIntervalMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
