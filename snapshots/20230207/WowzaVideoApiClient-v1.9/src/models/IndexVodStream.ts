 ...
 * 
 * @export
 * @interface IndexVodStream
 */
export interface IndexVodStream {
    /**
     * The unique alphanumeric string that identifies the VOD stream.
     * @type {string}
     * @memberof IndexVodStream
     */
    id?: string;
    /**
     ...
     * @memberof IndexVodStream
     */
    state?: IndexVodStreamStateEnum;
    /**
     * Specifies whether playback is enabled for the VOD stream.
     * @type {boolean}
     * @memberof IndexVodStream
     */
    playbackEnabled?: IndexVodStreamPlaybackEnabledEnum;
    /**
 ...
 * @export
 */
export const IndexVodStreamStateEnum = {
    Processing: 'processing',
    Completed: 'completed',
    Failed: 'failed'
} as const;
export type IndexVodStreamStateEnum = typeof IndexVodStreamStateEnum[keyof typeof IndexVodStreamStateEnum];

/**
 * @export
 */
export const IndexVodStreamPlaybackEnabledEnum = {
    True: true,
    False: false
} as const;
export type IndexVodStreamPlaybackEnabledEnum = typeof IndexVodStreamPlaybackEnabledEnum[keyof typeof IndexVodStreamPlaybackEnabledEnum];


/**
 * Check if a given object implements the IndexVodStream interface.
 */
export function instanceOfIndexVodStream(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexVodStreamFromJSON(json: any): IndexVodStream {
    return IndexVodStreamFromJSONTyped(json, false);
}

export function IndexVodStreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexVodStream {
...
export function IndexVodStreamToJSON(value?: IndexVodStream | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
