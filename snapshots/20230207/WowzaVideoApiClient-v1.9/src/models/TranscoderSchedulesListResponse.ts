 ...
 * 
 * @export
 * @interface TranscoderSchedulesListResponse
 */
export interface TranscoderSchedulesListResponse {
    /**
     * Array of schedules of this transcoder. See /schedules for more details.
     * @type {Array<Schedule>}
     * @memberof TranscoderSchedulesListResponse
     */
    schedules: Array<Schedule>;
}

/**
 * Check if a given object implements the TranscoderSchedulesListResponse interface.
 */
export function instanceOfTranscoderSchedulesListResponse(value: object): boolean {
    let isInstance = true;
...
export function TranscoderSchedulesListResponseFromJSON(json: any): TranscoderSchedulesListResponse {
    return TranscoderSchedulesListResponseFromJSONTyped(json, false);
}

export function TranscoderSchedulesListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderSchedulesListResponse {
...
export function TranscoderSchedulesListResponseToJSON(value?: TranscoderSchedulesListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
