 ...
 * 
 * @export
 * @interface ScheduleUpdateInputInner
 */
export interface ScheduleUpdateInputInner {
    /**
...
**Example:** <code>"action_type": "stop"</code>
     * @type {string}
     * @memberof ScheduleUpdateInputInner
     */
    actionType?: ScheduleUpdateInputInnerActionTypeEnum;
    /**
...
**Example:** <code>"recurrence_data": "monday,tuesday,wednesday,thursday,friday"</code>
     ...
     * @memberof ScheduleUpdateInputInner
     */
    recurrenceData?: ScheduleUpdateInputInnerRecurrenceDataEnum;
    /**
 ...
 * @export
 */
export const ScheduleUpdateInputInnerActionTypeEnum = {
    Start: 'start',
    Stop: 'stop',
    StartStop: 'start_stop'
} as const;
export type ScheduleUpdateInputInnerActionTypeEnum = typeof ScheduleUpdateInputInnerActionTypeEnum[keyof typeof ScheduleUpdateInputInnerActionTypeEnum];

/**
 * @export
 */
export const ScheduleUpdateInputInnerRecurrenceDataEnum = {
    Sunday: 'sunday',
    Monday: 'monday',
    Tuesday: 'tuesday',
    Wednesday: 'wednesday',
...
export type ScheduleUpdateInputInnerRecurrenceDataEnum = typeof ScheduleUpdateInputInnerRecurrenceDataEnum[keyof typeof ScheduleUpdateInputInnerRecurrenceDataEnum];


/**
 * Check if a given object implements the ScheduleUpdateInputInner interface.
 */
export function instanceOfScheduleUpdateInputInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ScheduleUpdateInputInnerFromJSON(json: any): ScheduleUpdateInputInner {
    return ScheduleUpdateInputInnerFromJSONTyped(json, false);
}

export function ScheduleUpdateInputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScheduleUpdateInputInner {
...
export function ScheduleUpdateInputInnerToJSON(value?: ScheduleUpdateInputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
