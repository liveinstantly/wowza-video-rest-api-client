...
import type { StreamTargetAkamaiPatchResponse } from './StreamTargetAkamaiPatchResponse';
import {
    StreamTargetAkamaiPatchResponseFromJSON,
    StreamTargetAkamaiPatchResponseFromJSONTyped,
    StreamTargetAkamaiPatchResponseToJSON,
} from './StreamTargetAkamaiPatchResponse';

/**
 * 
 * @export
 * @interface StreamTargetWowzaUpdateResponse
 */
export interface StreamTargetWowzaUpdateResponse {
    /**
     * 
     * @type {StreamTargetAkamaiPatchResponse}
     * @memberof StreamTargetWowzaUpdateResponse
     */
    streamTargetAkamai: StreamTargetAkamaiPatchResponse;
}

/**
 * Check if a given object implements the StreamTargetWowzaUpdateResponse interface.
 */
export function instanceOfStreamTargetWowzaUpdateResponse(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetWowzaUpdateResponseFromJSON(json: any): StreamTargetWowzaUpdateResponse {
    return StreamTargetWowzaUpdateResponseFromJSONTyped(json, false);
}

export function StreamTargetWowzaUpdateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetWowzaUpdateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'streamTargetAkamai': StreamTargetAkamaiPatchResponseFromJSON(json['stream_target_akamai']),
    };
}

export function StreamTargetWowzaUpdateResponseToJSON(value?: StreamTargetWowzaUpdateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stream_target_akamai': StreamTargetAkamaiPatchResponseToJSON(value.streamTargetAkamai),
    };
}
