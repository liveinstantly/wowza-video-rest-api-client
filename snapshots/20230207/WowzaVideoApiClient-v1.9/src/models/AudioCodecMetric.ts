 ...
 * 
 * @export
 * @interface AudioCodecMetric
 */
export interface AudioCodecMetric {
    /**
...
/**
 * Check if a given object implements the AudioCodecMetric interface.
 */
export function instanceOfAudioCodecMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AudioCodecMetricFromJSON(json: any): AudioCodecMetric {
    return AudioCodecMetricFromJSONTyped(json, false);
}

export function AudioCodecMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): AudioCodecMetric {
...
export function AudioCodecMetricToJSON(value?: AudioCodecMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
