...
import type { AssetReportUploadFailedOutput } from './AssetReportUploadFailedOutput';
import {
    AssetReportUploadFailedOutputFromJSON,
    AssetReportUploadFailedOutputFromJSONTyped,
    AssetReportUploadFailedOutputToJSON,
} from './AssetReportUploadFailedOutput';

/**
 * 
 * @export
 * @interface AssetReportUploadFailedResponse
 */
export interface AssetReportUploadFailedResponse {
    /**
     * 
     * @type {AssetReportUploadFailedOutput}
     * @memberof AssetReportUploadFailedResponse
     */
    asset: AssetReportUploadFailedOutput;
}

/**
 * Check if a given object implements the AssetReportUploadFailedResponse interface.
 */
export function instanceOfAssetReportUploadFailedResponse(value: object): boolean {
    let isInstance = true;
...
export function AssetReportUploadFailedResponseFromJSON(json: any): AssetReportUploadFailedResponse {
    return AssetReportUploadFailedResponseFromJSONTyped(json, false);
}

export function AssetReportUploadFailedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetReportUploadFailedResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'asset': AssetReportUploadFailedOutputFromJSON(json['asset']),
    };
}

export function AssetReportUploadFailedResponseToJSON(value?: AssetReportUploadFailedResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'asset': AssetReportUploadFailedOutputToJSON(value.asset),
    };
}
