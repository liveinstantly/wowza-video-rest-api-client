...
import type { PlayerUpdateInputInner } from './PlayerUpdateInputInner';
import {
    PlayerUpdateInputInnerFromJSON,
    PlayerUpdateInputInnerFromJSONTyped,
    PlayerUpdateInputInnerToJSON,
} from './PlayerUpdateInputInner';
...
export interface PlayerUpdateInput {
    /**
     * 
     * @type {PlayerUpdateInputInner}
     * @memberof PlayerUpdateInput
     */
    player: PlayerUpdateInputInner;
}

/**
 * Check if a given object implements the PlayerUpdateInput interface.
 */
export function instanceOfPlayerUpdateInput(value: object): boolean {
    let isInstance = true;
...
export function PlayerUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerUpdateInput {
    ...
    return {
        ...
        'player': PlayerUpdateInputInnerFromJSON(json['player']),
    };
}

export function PlayerUpdateInputToJSON(value?: PlayerUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'player': PlayerUpdateInputInnerToJSON(value.player),
    };
}
