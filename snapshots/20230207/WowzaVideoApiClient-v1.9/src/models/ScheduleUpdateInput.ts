...
import type { ScheduleUpdateInputInner } from './ScheduleUpdateInputInner';
import {
    ScheduleUpdateInputInnerFromJSON,
    ScheduleUpdateInputInnerFromJSONTyped,
    ScheduleUpdateInputInnerToJSON,
} from './ScheduleUpdateInputInner';
...
export interface ScheduleUpdateInput {
    /**
     * 
     * @type {ScheduleUpdateInputInner}
     * @memberof ScheduleUpdateInput
     */
    schedule: ScheduleUpdateInputInner;
}

/**
 * Check if a given object implements the ScheduleUpdateInput interface.
 */
export function instanceOfScheduleUpdateInput(value: object): boolean {
    let isInstance = true;
...
export function ScheduleUpdateInputFromJSON(json: any): ScheduleUpdateInput {
    return ScheduleUpdateInputFromJSONTyped(json, false);
}

export function ScheduleUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScheduleUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'schedule': ScheduleUpdateInputInnerFromJSON(json['schedule']),
    };
}

export function ScheduleUpdateInputToJSON(value?: ScheduleUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'schedule': ScheduleUpdateInputInnerToJSON(value.schedule),
    };
}
