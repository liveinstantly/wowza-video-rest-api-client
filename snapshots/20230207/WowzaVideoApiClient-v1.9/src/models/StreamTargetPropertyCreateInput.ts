 ...
 * 
 * @export
 * @interface StreamTargetPropertyCreateInput
 */
export interface StreamTargetPropertyCreateInput {
    /**
     * 
     * @type {StreamTargetProperty}
     * @memberof StreamTargetPropertyCreateInput
     */
    property: StreamTargetProperty;
}

/**
 * Check if a given object implements the StreamTargetPropertyCreateInput interface.
 */
export function instanceOfStreamTargetPropertyCreateInput(value: object): boolean {
    let isInstance = true;
...
export function StreamTargetPropertyCreateInputFromJSON(json: any): StreamTargetPropertyCreateInput {
    return StreamTargetPropertyCreateInputFromJSONTyped(json, false);
}

export function StreamTargetPropertyCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetPropertyCreateInput {
...
export function StreamTargetPropertyCreateInputToJSON(value?: StreamTargetPropertyCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
