...
export interface Schedule {
     ...
     * @memberof Schedule
     */
    actionType?: ScheduleActionTypeEnum;
    /**
     ...
     * @memberof Schedule
     */
    recurrenceData?: ScheduleRecurrenceDataEnum;
    /**
 ...
 * @export
 */
export const ScheduleActionTypeEnum = {
    Start: 'start',
    Stop: 'stop',
    StartStop: 'start_stop'
} as const;
export type ScheduleActionTypeEnum = typeof ScheduleActionTypeEnum[keyof typeof ScheduleActionTypeEnum];

/**
 * @export
 */
export const ScheduleRecurrenceDataEnum = {
    Sunday: 'sunday',
    Monday: 'monday',
    Tuesday: 'tuesday',
    Wednesday: 'wednesday',
...
export type ScheduleRecurrenceDataEnum = typeof ScheduleRecurrenceDataEnum[keyof typeof ScheduleRecurrenceDataEnum];

/**
 * @export
 */
export const ScheduleRecurrenceTypeEnum = {
    Once: 'once',
    Recur: 'recur'
} as const;
export type ScheduleRecurrenceTypeEnum = typeof ScheduleRecurrenceTypeEnum[keyof typeof ScheduleRecurrenceTypeEnum];

/**
 * @export
 */
export const ScheduleStateEnum = {
    Enabled: 'enabled',
    Disabled: 'disabled',
    Expired: 'expired'
} as const;
export type ScheduleStateEnum = typeof ScheduleStateEnum[keyof typeof ScheduleStateEnum];
...
export function ScheduleFromJSONTyped(json: any, ignoreDiscriminator: boolean): Schedule {
    ...
    return {
        ...
        'transcoderName': !exists(json, 'transcoder_name') ? undefined : json['transcoder_name'],
...
export function ScheduleToJSON(value?: Schedule | null): any {
    ...
    return {
        ...
        'transcoder_name': value.transcoderName,
