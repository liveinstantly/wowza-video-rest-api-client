...
import type { UsageEgressDataPerTranscoder } from './UsageEgressDataPerTranscoder';
import {
    UsageEgressDataPerTranscoderFromJSON,
    UsageEgressDataPerTranscoderFromJSONTyped,
    UsageEgressDataPerTranscoderToJSON,
} from './UsageEgressDataPerTranscoder';
...
import type { UsagePaginationWithIndex } from './UsagePaginationWithIndex';
import {
    UsagePaginationWithIndexFromJSON,
    UsagePaginationWithIndexFromJSONTyped,
    UsagePaginationWithIndexToJSON,
} from './UsagePaginationWithIndex';

/**
 * 
 * @export
 * @interface UsageTranscoders
 */
export interface UsageTranscoders {
    /**
     * An array of usage data for transcoders.
     * @type {Array<UsageEgressDataPerTranscoder>}
     * @memberof UsageTranscoders
     */
    transcoders?: Array<UsageEgressDataPerTranscoder>;
    /**
     * 
     * @type {UsagePaginationWithIndex}
     * @memberof UsageTranscoders
     */
    pagination?: UsagePaginationWithIndex;
    /**
     * 
     * @type {UsageLimits}
     * @memberof UsageTranscoders
...
/**
 * Check if a given object implements the UsageTranscoders interface.
 */
export function instanceOfUsageTranscoders(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageTranscodersFromJSON(json: any): UsageTranscoders {
    return UsageTranscodersFromJSONTyped(json, false);
}

export function UsageTranscodersFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageTranscoders {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoders': !exists(json, 'transcoders') ? undefined : ((json['transcoders'] as Array<any>).map(UsageEgressDataPerTranscoderFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : UsagePaginationWithIndexFromJSON(json['pagination']),
        'limits': !exists(json, 'limits') ? undefined : UsageLimitsFromJSON(json['limits']),
    };
}

export function UsageTranscodersToJSON(value?: UsageTranscoders | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoders': value.transcoders === undefined ? undefined : ((value.transcoders as Array<any>).map(UsageEgressDataPerTranscoderToJSON)),
        'pagination': UsagePaginationWithIndexToJSON(value.pagination),
