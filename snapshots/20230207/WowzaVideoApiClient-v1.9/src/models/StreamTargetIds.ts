 ...
 * 
 * @export
 * @interface StreamTargetIds
 */
export interface StreamTargetIds {
    /**
     * The unique alphanumeric string that identifies the stream target.
     * @type {string}
     * @memberof StreamTargetIds
     */
    id?: string;
}

/**
 * Check if a given object implements the StreamTargetIds interface.
 */
export function instanceOfStreamTargetIds(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetIdsFromJSON(json: any): StreamTargetIds {
    return StreamTargetIdsFromJSONTyped(json, false);
}

export function StreamTargetIdsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetIds {
...
export function StreamTargetIdsToJSON(value?: StreamTargetIds | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
