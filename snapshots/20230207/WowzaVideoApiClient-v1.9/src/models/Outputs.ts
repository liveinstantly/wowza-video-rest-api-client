 ...
 */
export function instanceOfOutputs(value: object): boolean {
    let isInstance = true;
...
export function OutputsFromJSON(json: any): Outputs {
    return OutputsFromJSONTyped(json, false);
}

export function OutputsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Outputs {
...
export function OutputsToJSON(value?: Outputs | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
