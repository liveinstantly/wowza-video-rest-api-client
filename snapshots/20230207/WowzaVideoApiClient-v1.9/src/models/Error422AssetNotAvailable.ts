 ...
 * 
 * @export
 * @interface Error422AssetNotAvailable
 */
export interface Error422AssetNotAvailable {
    /**
     * 
     * @type {Meta}
     * @memberof Error422AssetNotAvailable
     */
    meta: Meta;
}

/**
 * Check if a given object implements the Error422AssetNotAvailable interface.
 */
export function instanceOfError422AssetNotAvailable(value: object): boolean {
    let isInstance = true;
...
export function Error422AssetNotAvailableFromJSON(json: any): Error422AssetNotAvailable {
    return Error422AssetNotAvailableFromJSONTyped(json, false);
}

export function Error422AssetNotAvailableFromJSONTyped(json: any, ignoreDiscriminator: boolean): Error422AssetNotAvailable {
...
export function Error422AssetNotAvailableToJSON(value?: Error422AssetNotAvailable | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
