...
import type { AssetReportUploadedInputInner } from './AssetReportUploadedInputInner';
import {
    AssetReportUploadedInputInnerFromJSON,
    AssetReportUploadedInputInnerFromJSONTyped,
    AssetReportUploadedInputInnerToJSON,
} from './AssetReportUploadedInputInner';

/**
 * 
 * @export
 * @interface AssetReportUploadedInput
 */
export interface AssetReportUploadedInput {
    /**
     * 
     * @type {AssetReportUploadedInputInner}
     * @memberof AssetReportUploadedInput
     */
    asset: AssetReportUploadedInputInner;
}

/**
 * Check if a given object implements the AssetReportUploadedInput interface.
 */
export function instanceOfAssetReportUploadedInput(value: object): boolean {
    let isInstance = true;
...
export function AssetReportUploadedInputFromJSON(json: any): AssetReportUploadedInput {
    return AssetReportUploadedInputFromJSONTyped(json, false);
}

export function AssetReportUploadedInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetReportUploadedInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'asset': AssetReportUploadedInputInnerFromJSON(json['asset']),
    };
}

export function AssetReportUploadedInputToJSON(value?: AssetReportUploadedInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'asset': AssetReportUploadedInputInnerToJSON(value.asset),
    };
}
