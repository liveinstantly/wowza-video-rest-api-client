 ...
 * 
 * @export
 * @interface DirectPlaybackUrl
 */
export interface DirectPlaybackUrl {
    /**
     * The name of the playback URL: **source**, **default**, or the output rendition's resolution.
     * @type {string}
     * @memberof DirectPlaybackUrl
     */
    name?: string;
    /**
    ...
    url?: string;
    /**
     * (WebRTC only) The application name for the WebRTC output.
     * @type {string}
     * @memberof DirectPlaybackUrl
     */
    applicationName?: string;
    /**
     * (WebRTC only) The stream name for the WebRTC output rendition.
     * @type {string}
     * @memberof DirectPlaybackUrl
     */
    streamName?: string;
...
/**
 * Check if a given object implements the DirectPlaybackUrl interface.
 */
export function instanceOfDirectPlaybackUrl(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DirectPlaybackUrlFromJSON(json: any): DirectPlaybackUrl {
    return DirectPlaybackUrlFromJSONTyped(json, false);
}

export function DirectPlaybackUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): DirectPlaybackUrl {
...
export function DirectPlaybackUrlToJSON(value?: DirectPlaybackUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
