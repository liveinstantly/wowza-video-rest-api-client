...
/**
 * Check if a given object implements the StreamTargetCustom interface.
 */
export function instanceOfStreamTargetCustom(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StreamTargetCustomFromJSON(json: any): StreamTargetCustom {
    return StreamTargetCustomFromJSONTyped(json, false);
}

export function StreamTargetCustomFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTargetCustom {
...
export function StreamTargetCustomToJSON(value?: StreamTargetCustom | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
