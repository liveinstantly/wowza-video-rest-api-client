...
import type { TranscoderUpdateInputInner } from './TranscoderUpdateInputInner';
import {
    TranscoderUpdateInputInnerFromJSON,
    TranscoderUpdateInputInnerFromJSONTyped,
    TranscoderUpdateInputInnerToJSON,
} from './TranscoderUpdateInputInner';

/**
 * 
 * @export
 * @interface TranscoderUpdateInput
 */
export interface TranscoderUpdateInput {
    /**
     * 
     * @type {TranscoderUpdateInputInner}
     * @memberof TranscoderUpdateInput
     */
    transcoder: TranscoderUpdateInputInner;
}

/**
 * Check if a given object implements the TranscoderUpdateInput interface.
 */
export function instanceOfTranscoderUpdateInput(value: object): boolean {
    let isInstance = true;
...
export function TranscoderUpdateInputFromJSON(json: any): TranscoderUpdateInput {
    return TranscoderUpdateInputFromJSONTyped(json, false);
}

export function TranscoderUpdateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscoderUpdateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'transcoder': TranscoderUpdateInputInnerFromJSON(json['transcoder']),
    };
}

export function TranscoderUpdateInputToJSON(value?: TranscoderUpdateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transcoder': TranscoderUpdateInputInnerToJSON(value.transcoder),
    };
}
