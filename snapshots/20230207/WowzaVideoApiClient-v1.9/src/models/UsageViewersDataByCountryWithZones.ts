...
import type { UsageViewersZone1 } from './UsageViewersZone1';
import {
    UsageViewersZone1FromJSON,
    UsageViewersZone1FromJSONTyped,
    UsageViewersZone1ToJSON,
} from './UsageViewersZone1';

/**
 * 
 * @export
 * @interface UsageViewersDataByCountryWithZones
 */
export interface UsageViewersDataByCountryWithZones {
    /**
     * A country code where the stream was requested.
     * @type {string}
     * @memberof UsageViewersDataByCountryWithZones
     */
    code?: string;
    /**
     * The name of a country where the stream was requested.
     * @type {string}
     * @memberof UsageViewersDataByCountryWithZones
     */
    name?: string;
     ...
     * @type {Array<UsageViewersZone1>}
     * @memberof UsageViewersDataByCountryWithZones
     */
    zones?: Array<UsageViewersZone1>;
}

/**
 * Check if a given object implements the UsageViewersDataByCountryWithZones interface.
 */
export function instanceOfUsageViewersDataByCountryWithZones(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersDataByCountryWithZonesFromJSON(json: any): UsageViewersDataByCountryWithZones {
    return UsageViewersDataByCountryWithZonesFromJSONTyped(json, false);
}

export function UsageViewersDataByCountryWithZonesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersDataByCountryWithZones {
    ...
    return {
        ...
        'zones': !exists(json, 'zones') ? undefined : ((json['zones'] as Array<any>).map(UsageViewersZone1FromJSON)),
    };
}

export function UsageViewersDataByCountryWithZonesToJSON(value?: UsageViewersDataByCountryWithZones | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'zones': value.zones === undefined ? undefined : ((value.zones as Array<any>).map(UsageViewersZone1ToJSON)),
    };
}
