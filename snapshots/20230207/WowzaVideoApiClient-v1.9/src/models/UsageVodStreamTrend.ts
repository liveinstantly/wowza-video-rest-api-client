 ...
 * 
 * @export
 * @interface UsageVodStreamTrend
 */
export interface UsageVodStreamTrend {
    /**
     * An array of trend data
     * @type {Array<UsageViewersTrendsDetails>}
     * @memberof UsageVodStreamTrend
     */
...
/**
 * Check if a given object implements the UsageVodStreamTrend interface.
 */
export function instanceOfUsageVodStreamTrend(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageVodStreamTrendFromJSON(json: any): UsageVodStreamTrend {
    return UsageVodStreamTrendFromJSONTyped(json, false);
}

export function UsageVodStreamTrendFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageVodStreamTrend {
...
export function UsageVodStreamTrendToJSON(value?: UsageVodStreamTrend | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
