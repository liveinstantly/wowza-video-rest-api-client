...
/**
 * Check if a given object implements the AssetTags interface.
 */
export function instanceOfAssetTags(value: object): boolean {
    let isInstance = true;
...
export function AssetTagsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetTags {
    ...
    return {
        ...
        'assetTags': !exists(json, 'asset_tags') ? undefined : json['asset_tags'],
    };
}
