 ...
 * 
 * @export
 * @interface IndexRealTimeStream
 */
export interface IndexRealTimeStream {
    /**
     * The date and time that the real-time stream was created.
     * @type {Date}
     * @memberof IndexRealTimeStream
     */
    createdAt?: Date;
    /**
...
**Example:** <code>"region": emea</code>
     ...
     * @memberof IndexRealTimeStream
     */
    region?: IndexRealTimeStreamRegionEnum;
    /**
 ...
 * @export
 */
export const IndexRealTimeStreamRegionEnum = {
    Americas: 'americas',
    Emea: 'emea'
} as const;
export type IndexRealTimeStreamRegionEnum = typeof IndexRealTimeStreamRegionEnum[keyof typeof IndexRealTimeStreamRegionEnum];


/**
 * Check if a given object implements the IndexRealTimeStream interface.
 */
export function instanceOfIndexRealTimeStream(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IndexRealTimeStreamFromJSON(json: any): IndexRealTimeStream {
    return IndexRealTimeStreamFromJSONTyped(json, false);
}

export function IndexRealTimeStreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexRealTimeStream {
...
export function IndexRealTimeStreamToJSON(value?: IndexRealTimeStream | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
