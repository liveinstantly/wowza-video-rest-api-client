...
import type { AssetReportUploadedOutput } from './AssetReportUploadedOutput';
import {
    AssetReportUploadedOutputFromJSON,
    AssetReportUploadedOutputFromJSONTyped,
    AssetReportUploadedOutputToJSON,
} from './AssetReportUploadedOutput';

/**
 * 
 * @export
 * @interface AssetReportUploadedResponse
 */
export interface AssetReportUploadedResponse {
    /**
     * 
     * @type {AssetReportUploadedOutput}
     * @memberof AssetReportUploadedResponse
     */
    asset: AssetReportUploadedOutput;
}

/**
 * Check if a given object implements the AssetReportUploadedResponse interface.
 */
export function instanceOfAssetReportUploadedResponse(value: object): boolean {
    let isInstance = true;
...
export function AssetReportUploadedResponseFromJSON(json: any): AssetReportUploadedResponse {
    return AssetReportUploadedResponseFromJSONTyped(json, false);
}

export function AssetReportUploadedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetReportUploadedResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'asset': AssetReportUploadedOutputFromJSON(json['asset']),
    };
}

export function AssetReportUploadedResponseToJSON(value?: AssetReportUploadedResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'asset': AssetReportUploadedOutputToJSON(value.asset),
    };
}
