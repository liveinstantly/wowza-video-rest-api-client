...
import type { RealTimeStreamCreateInputInner } from './RealTimeStreamCreateInputInner';
import {
    RealTimeStreamCreateInputInnerFromJSON,
    RealTimeStreamCreateInputInnerFromJSONTyped,
    RealTimeStreamCreateInputInnerToJSON,
} from './RealTimeStreamCreateInputInner';

/**
 * 
 * @export
 * @interface RealTimeStreamCreateInput
 */
export interface RealTimeStreamCreateInput {
    /**
     * 
     * @type {RealTimeStreamCreateInputInner}
     * @memberof RealTimeStreamCreateInput
     */
    realTimeStream?: RealTimeStreamCreateInputInner;
}

/**
 * Check if a given object implements the RealTimeStreamCreateInput interface.
 */
export function instanceOfRealTimeStreamCreateInput(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RealTimeStreamCreateInputFromJSON(json: any): RealTimeStreamCreateInput {
    return RealTimeStreamCreateInputFromJSONTyped(json, false);
}

export function RealTimeStreamCreateInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): RealTimeStreamCreateInput {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'realTimeStream': !exists(json, 'real_time_stream') ? undefined : RealTimeStreamCreateInputInnerFromJSON(json['real_time_stream']),
    };
}

export function RealTimeStreamCreateInputToJSON(value?: RealTimeStreamCreateInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'real_time_stream': RealTimeStreamCreateInputInnerToJSON(value.realTimeStream),
    };
}
