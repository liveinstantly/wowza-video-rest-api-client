 ...
 * 
 * @export
 * @interface UsageViewersTrends
 */
export interface UsageViewersTrends {
    /**
     * The date and time the trend data was sampled.
     * @type {Date}
     * @memberof UsageViewersTrends
     */
    sampledAt?: Date;
    /**
...
/**
 * Check if a given object implements the UsageViewersTrends interface.
 */
export function instanceOfUsageViewersTrends(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsageViewersTrendsFromJSON(json: any): UsageViewersTrends {
    return UsageViewersTrendsFromJSONTyped(json, false);
}

export function UsageViewersTrendsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageViewersTrends {
...
export function UsageViewersTrendsToJSON(value?: UsageViewersTrends | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
