 ...
 * 
 * @export
 * @interface BitsInRateMetric
 */
export interface BitsInRateMetric {
    /**
...
/**
 * Check if a given object implements the BitsInRateMetric interface.
 */
export function instanceOfBitsInRateMetric(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BitsInRateMetricFromJSON(json: any): BitsInRateMetric {
    return BitsInRateMetricFromJSONTyped(json, false);
}

export function BitsInRateMetricFromJSONTyped(json: any, ignoreDiscriminator: boolean): BitsInRateMetric {
...
export function BitsInRateMetricToJSON(value?: BitsInRateMetric | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
