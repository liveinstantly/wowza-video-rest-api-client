 ...
 * 
 * @export
 * @interface OutputStreamTargetControlState
 */
export interface OutputStreamTargetControlState {
    /**
     * The state of the output stream target.
     * @type {string}
     * @memberof OutputStreamTargetControlState
     */
    state?: OutputStreamTargetControlStateStateEnum;
}
 ...
 * @export
 */
export const OutputStreamTargetControlStateStateEnum = {
    Enabled: 'enabled',
    Disabled: 'disabled',
    Restarted: 'restarted'
} as const;
export type OutputStreamTargetControlStateStateEnum = typeof OutputStreamTargetControlStateStateEnum[keyof typeof OutputStreamTargetControlStateStateEnum];


/**
 * Check if a given object implements the OutputStreamTargetControlState interface.
 */
export function instanceOfOutputStreamTargetControlState(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OutputStreamTargetControlStateFromJSON(json: any): OutputStreamTargetControlState {
    return OutputStreamTargetControlStateFromJSONTyped(json, false);
}

export function OutputStreamTargetControlStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutputStreamTargetControlState {
...
export function OutputStreamTargetControlStateToJSON(value?: OutputStreamTargetControlState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
